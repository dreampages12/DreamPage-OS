...
def _draw_title_cover_text(img, text):
    ...
    font_small = ImageFont.truetype(COVER_FONT, max(1, int(85 * cover_scale)))
    font_large = ImageFont.truetype(COVER_FONT, max(1, int(96 * cover_scale)))
...
_DREAMPAGE_TRANSLATIONS = {
  "{name} og\nDet forsvunne dinosauregget": "{name} och\nDet försvunna dinosaurieägget",
  "Takk for at du kjøpte denne personlige historien!\nI denne boken drar {name} tilbake til dinosaurdalen for å lete etter et egg som har forsvunnet. {name} lærer at det å hjelpe andre går aller best når man gjør det sammen.\nVi håper historien bringer glede, spenning og fantasifulle øyeblikk.": "Tack för att du köpte den här personliga berättelsen!\nI den här boken återvänder {name} till dinosauriedalen för att leta efter ett ägg som har försvunnit. {name} lär sig att det går allra bäst att hjälpa andra när man gör det tillsammans.\nVi hoppas att berättelsen ger glädje, spänning och fantasifulla stunder.",
  "Det hadde gått en stund siden {name} sist var i dinosaurdalen.\nEn helt vanlig dag på skogsstien skjedde det noe.\nGylne lys begynte å danse mellom trærne.\nPortalen var tilbake. Og den ventet på {name}.": "Det hade gått ett tag sedan {name} senast var i dinosauriedalen.\nEn helt vanlig dag på skogsstigen hände det något.\nGyllene ljus började dansa mellan träden.\nPortalen var tillbaka. Och den väntade på {name}.",
  "{name} tok et steg gjennom det gylne lyset.\nPå den andre siden sto Lumi og ventet.\nMen denne gangen var Lumi urolig. Han trippet frem og tilbake.\n«Kom fort,» sa han. «Jeg må vise deg noe.»": "{name} tog ett steg genom det gyllene ljuset.\nPå andra sidan stod Lumi och väntade.\nMen den här gången var Lumi orolig. Han trippade fram och tillbaka.\n«Kom fort,» sa han. «Jag måste visa dig något.»",
  "Lumi løp foran, og {name} fulgte etter helt til de kom til et stort rede.\nInni lå flere egg trygt sammen. Men det var en tom plass i midten.\nEn stor dinosaurmor gikk urolig rundt redet.\nEtt av eggene hennes var borte.": "Lumi sprang före, och {name} följde efter ända tills de kom till ett stort bo.\nInuti låg flera ägg tryggt tillsammans. Men det fanns en tom plats i mitten.\nEn stor dinosauriemamma gick oroligt runt boet.\nEtt av hennes ägg var borta.",
  "{name} satte seg på huk og så nøye på bakken.\nI den myke jorda lå det ferske fotavtrykk.\nVed siden av dem gikk et bredt slepespor.\n«Egget er ikke borte,» sa {name}. «Det har blitt flyttet.»": "{name} satte sig på huk och tittade noga på marken.\nI den mjuka jorden fanns färska fotavtryck.\nBredvid dem gick ett brett släpspår.\n«Ägget är inte borta,» sa {name}. «Det har flyttats.»",
  "Sporene førte inn i en mørkere del av dalen.\nHer var trærne tettere, og lyden av elven var langt unna.\nPlutselig raslet det i buskene foran dem.\n{name} og Lumi stoppet helt stille.": "Spåren ledde in i en mörkare del av dalen.\nHär stod träden tätare, och ljudet från floden var långt borta.\nPlötsligt prasslade det i buskarna framför dem.\n{name} och Lumi stannade helt stilla.",
  "En rask dinosaur med fjær hoppet frem mellom bladene.\nDen så på {name} et lite øyeblikk. Så snudde den og løp.\n«Etter den!» ropte Lumi.\nOg så bar det av gårde gjennom jungelen.": "En snabb dinosaurie med fjädrar hoppade fram mellan bladen.\nDen tittade på {name} ett litet ögonblick. Sedan vände den och sprang.\n«Efter den!» ropade Lumi.\nOch så bar det av genom djungeln.",
  "Jakten gikk over falne trær og langs den brusende elven.\nDen fremmede dinosauren så seg tilbake igjen og igjen.\nNesten som om den ville at de skulle følge etter.\n{name} begynte å lure. Kanskje den ikke rømte i det hele tatt?": "Jakten gick över fallna träd och längs den brusande floden.\nDen främmande dinosaurien tittade sig tillbaka gång på gång.\nNästan som om den ville att de skulle följa efter.\n{name} började undra. Kanske flydde den inte alls?",
  "Nede ved elvebredden fant de det. Det savnede egget.\nDet hadde ikke blitt stjålet i det hele tatt.\nEgget hadde trillet ned fra redet og satt fast mellom steinene.\nOg den fremmede dinosauren hadde passet på det hele tiden.": "Nere vid flodstranden hittade de det. Det saknade ägget.\nDet hade aldrig blivit stulet.\nÄgget hade rullat ner från boet och satt fast mellan stenarna.\nOch den främmande dinosaurien hade vaktat det hela tiden.",
  "Et dypt drønn rullet ned fra fjellene.\nElven begynte å stige, og vannet ble stridt og kaldt.\nEgget vippet der det sto.\nDe måtte få det opp med en gang.": "Ett djupt dån rullade ner från bergen.\nFloden började stiga, och vattnet blev strömt och kallt.\nÄgget vippade där det stod.\nDe måste få upp det med en gång.",
  "{name} tok av seg ryggsekken og tenkte fort.\nGreiner, mose og et flatt stykke bark ble til en liten slede.\n«Dere drar, så løfter jeg,» sa {name}.\nLumi og den fremmede dinosauren stilte seg klare.": "{name} tog av sig ryggsäcken och tänkte snabbt.\nGrenar, mossa och en platt bit bark blev till en liten släde.\n«Ni drar, så lyfter jag,» sa {name}.\nLumi och den främmande dinosaurien ställde sig redo.",
  "En stor bølge kom brusende nedover elven.\nEgget begynte å rulle mot vannet.\nI siste liten strakte {name} seg frem og fikk tak.\nLumi og den fremmede dro til, og egget var trygt.": "En stor våg kom brusande nerför floden.\nÄgget började rulla mot vattnet.\nI sista sekunden sträckte {name} sig fram och fick tag.\nLumi och den främmande drog till, och ägget var i trygghet.",
  "Sammen dro de egget forsiktig oppover stien.\nDen fremmede dinosauren gikk foran og viste vei.\nLangt der fremme sto dinosaurmoren og speidet.\nDa hun fikk øye på egget, løftet hun hodet og ropte av glede.": "Tillsammans drog de försiktigt ägget uppför stigen.\nDen främmande dinosaurien gick före och visade vägen.\nLångt där framme stod dinosauriemamman och spanade.\nNär hon fick syn på ägget lyfte hon huvudet och ropade av glädje.",
  "Egget ble lagt forsiktig tilbake i redet.\nDa begynte skallet å sprekke, helt av seg selv.\nEn liten baby-triceratops tittet ut og så rett på {name}.\nAlle sto helt stille. Dette var det fineste {name} hadde sett.": "Ägget lades försiktigt tillbaka i boet.\nDå började skalet spricka, alldeles av sig självt.\nEn liten bebis-triceratops tittade ut och såg rakt på {name}.\nAlla stod helt stilla. Det här var det finaste {name} hade sett.",
  "Solen gikk ned i gult og rosa da Lumi fulgte {name} tilbake til portalen.\n«Takk for at du kom,» sa Lumi. «Du kom akkurat i tide.»\n{name} vinket farvel og tok steget hjem.\nMen langt borte sendte en gammel vulkan en tynn stripe røyk opp mot himmelen.": "Solen gick ner i gult och rosa när Lumi följde {name} tillbaka till portalen.\n«Tack för att du kom,» sa Lumi. «Du kom precis i tid.»\n{name} vinkade adjö och tog steget hem.\nMen långt borta skickade en gammal vulkan en tunn strimma rök upp mot himlen.",
  "Denne boken handler om å hjelpe. Om å stoppe opp, se ordentlig etter og forstå at ting ikke alltid er slik de ser ut ved første blikk.\nNår et dinosauregg forsvinner fra redet, drar {name} og vennen Lumi ut i dalen for å finne det. Jakten fører dem til en fremmed dinosaur – og til en sannhet ingen hadde ventet.\nEn varm og spennende historie om vennskap, samarbeid og om å tørre å stole på noen man ikke kjenner.\nEn bok som gir mot, glede – og minner barnet på at de kan utgjøre en forskjell.": "Den här boken handlar om att hjälpa. Om att stanna upp, titta ordentligt och förstå att saker inte alltid är som de ser ut vid första anblicken.\nNär ett dinosaurieägg försvinner från boet ger sig {name} och vännen Lumi ut i dalen för att hitta det. Jakten leder dem till en främmande dinosaurie – och till en sanning ingen hade väntat sig.\nEn varm och spännande berättelse om vänskap, samarbete och om att våga lita på någon man inte känner.\nEn bok som ger mod, glädje – och påminner barnet om att de kan göra skillnad.",
}
