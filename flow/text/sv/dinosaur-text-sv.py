...
DINOSAUR_DREAMPAGE_FIRST = os.path.join(
    os.path.dirname(SCRIPT_ROOT_DIR), "books", "dinosaurenes-dal", "dreampage-first-dinosaur.png"
)
...
FRONT_COVER_LINE1_SIZE = 85 / 1024
...
def build_pages(child_name: str) -> List[Dict[str, Any]]:
    ...
    pages: List[Dict[str, Any]] = [
...

        {
           ...
           "blocks": [{
                "text": p(
                    # En setning per linje: da far den jevne linjedelingen
                    # (even_wrap) dele hver setning i to omtrent like brede
                    # linjer, i stedet for tre nesten fulle linjer med brudd
                    # midt i setningsleddene.
        ...
        # Side 1
        {
            ...
            "blocks": [{
                ...
                "font_size": 34,
                "color": "#FFFFFF",
                "highlights": [child_name, "annerledes", "lys"],
            }],
        },
        ...
        # Side 2
        {
            ...
            "blocks": [{
                ...
                "font_size": 34,
                "color": "#FFFFFF",
                "highlights": [child_name, "stille", "hemmelig"],
            }],
        },
        ...
        # Side 3
        {
            ...
            "blocks": [{
                ...
                "font_size": 34,
                "color": "#FFFFFF",
                "highlights": [child_name, "lysende", "portal"],
            }],
        },
        ...
        # Side 4
        {
            ...
            "blocks": [{
                ...
                "font_size": 34,
                "color": "#FFFFFF",
                "highlights": [child_name, "motet", "portalen"],
            }],
        },
        ...
        # Side 5
        {
            ...
            "blocks": [{
                ...
                "font_size": 34,
                "color": "#FFFFFF",
                "highlights": [child_name, "dal", "Langhalser"],
            }],
        },
        ...
        # Side 6
        {
            ...
            "blocks": [{
                ...
                "font_size": 34,
                "color": "#FFFFFF",
                "highlights": [child_name, "Lumi", "dinosaur"],
            }],
        },
        ...
        # Side 7
        {
            ...
            "blocks": [{
                ...
                "font_size": 34,
                "color": "#FFFFFF",
                "highlights": [child_name, "Lumi", "Sammen"],
            }],
        },
        ...
        # Side 8
        {
            ...
            "blocks": [{
                ...
                "font_size": 34,
                "color": "#FFFFFF",
                "highlights": [child_name, "fotspor", "Lumi"],
            }],
        },
        ...
        # Side 9
        {
            ...
            "blocks": [{
                ...
                "font_size": 34,
                "color": "#FFFFFF",
                "highlights": [child_name, "dinosaurunge", "hjelpe"],
            }],
        },
        ...
        # Side 10
        {
            ...
            "blocks": [{
                ...
                "font_size": 34,
                "color": "#FFFFFF",
                "highlights": [child_name, "brøl", "T-rex"],
            }],
        },
        ...
        # Side 11
        {
            ...
            "blocks": [{
                ...
                "font_size": 34,
                "color": "#FFFFFF",
                "highlights": [child_name, "redd", "bekymrede"],
            }],
        },
        ...
        # Side 12
        {
            ...
            "blocks": [{
                ...
                "font_size": 34,
                "color": "#FFFFFF",
                "highlights": [child_name, "hjelpe", "Lumi"],
            }],
        },
        ...
        # Side 13
        {
            ...
            "blocks": [{
                ...
                "font_size": 34,
                "color": "#FFFFFF",
                "highlights": [child_name, "modig", "brølet"],
            }],
        },
        ...
        # Side 14
        {
            ...
            "blocks": [{
                ...
                "font_size": 34,
                "color": "#FFFFFF",
                "highlights": [child_name, "Lumi", "eventyret"],
            }],
        },
        ...
        {
            "filename": "Lastpage(dinosaur).png",
            "type": "inner",
            "side": "right",
            "blank_only": True
        },
        ...
        # Bakside
        {
            ...
            "blocks": [{
                ...
                "font_size": 46,
                "color": "#FFFFFF",
                "highlights": [child_name, "mot", "Dinosaurenes dal", "vennskap", "modig", "helt"],
...
RYGGRAD_BOOK_SLUG = "dinosaurenes-dal"
...
def render_page(page: Dict[str, Any], base_dir: str, out_dir: str) -> List[str]:
    ...
    if page.get("type") == "blank":
        ...
        for block in page.get("blocks", []):
            ...
            # Boksen maa slutte over taglinen paa 0.785, ellers renner teksten
            # inn i "Trykket med omtanke for kvalitet".
            box_bottom = int(block.get("box_bottom", INNER_HEIGHT * 0.72) * scale_y)

            box = (
                # Litt smalere spalte enn 0.18-0.82: da blir linjene i hver
                # setning jevnere, og teksten leser som en sentrert blokk.
                int(img_w * 0.20),
                box_top,
                int(img_w * 0.80),
                box_bottom,
            )
            # Skaler linjeavstanden med sidestoerrelsen, ellers blir teksten
            # sammenpresset paa 4096 px-sidene. Samme verdi som bokmaal.
            line_spacing = max(6, int(14 * scale_y))
        ...
        _dpf_ty = int(img_h * 0.785) - _dpf_tag_total // 2
...
def process_book(base_dir: str, out_dir: str, child_name: str, cover_type: str, gelato_api_key: str):
    ...
    need = ["bakside(dinosaur).png", "ryggrad.png", "forside(dinosaur).png"]
    ...
    back_path  = cover_rendered["bakside(dinosaur).png"]
    spine_path = cover_rendered["ryggrad.png"]
    front_path = cover_rendered["forside(dinosaur).png"]
...
_DREAMPAGE_TRANSLATIONS = {
  "{name} og\nDinosaurenes dal": "{name} och\nDinosauriernas Dal",
  "Takk for at du kjøpte denne personlige historien!\nI denne boken følger vi {name} på et eventyr i en magisk dal. {name} lærer seg og si ifra når noe ikke er greit.\nVi håper historien bringer glede, trygghet og fantasifulle øyeblikk.": "Tack för att du köpte den här personliga berättelsen!\nI den här boken följer vi {name} på ett äventyr i en magisk dal. {name} lär sig att säga ifrån när något inte känns rätt.\nVi hoppas att berättelsen ger glädje, trygghet och fantasifulla stunder.",
  "Det var en stille og fin dag. {name} sto ute og så seg rundt.\nLuften var frisk, og naturen lå åpen foran ham.\nAlt føltes rolig og trygt.\n{name} visste det ikke ennå, men denne dagen skulle bli helt annerledes enn alle andre.": "Det var en stilla och fin dag. {name} stod ute och såg sig omkring.\nLuften var frisk, och naturen låg öppen framför honom.\nAllt kändes lugnt och tryggt.\n{name} visste det inte än, men den här dagen skulle bli helt annorlunda än alla andra.",
  "{name} gikk videre innover stien. Da fikk han øye på noe uvanlig.\nMidt blant steiner og blader lå et egg som glødet svakt.\nLyset blinket i grønne og gylne farger.\n{name} satte seg forsiktig ned. Hva kunne dette være?": "{name} gick vidare in längs stigen. Då fick han syn på något ovanligt.\nMitt bland stenar och löv låg ett ägg som glödde svagt.\nLjuset blinkade i gröna och gyllene färger.\n{name} satte sig försiktigt ner. Vad kunde det här vara?",
  "{name} så nærmere på egget.\nLyset ble sterkere, og bakken rundt begynte å gløde svakt.\nSteinene foran ham lyste opp i en rund form.\n{name} trakk pusten dypt.\nDet var ikke bare et egg.\nDet var noe mer.": "{name} tittade närmare på ägget.\nLjuset blev starkare, och marken runt omkring började glöda svagt.\nStenarna framför honom lyste upp i en rund form.\n{name} drog ett djupt andetag.\nDet var inte bara ett ägg.\nDet var något mer.",
  "{name} reiste seg sakte.\nHan tok noen forsiktige steg frem.\nDen lysende sirkelen var stille, men levende.\nLuften rundt kjentes varm og myk.\n{name} løftet hånden.\nHva ville skje hvis han rørte den?": "{name} reste sig långsamt.\nHan tog några försiktiga steg fram.\nDen lysande cirkeln var tyst, men levande.\nLuften runt den kändes varm och mjuk.\n{name} lyfte handen.\nVad skulle hända om han rörde vid den?",
  "Da {name} rørte den lysende sirkelen, skjedde det noe.\nLyset begynte å bevege seg sakte.\nSmå gnister danset rundt hånden hans.\nLuften summet lavt, som om portalen våknet.\n{name} trakk pusten dypt. Dette var begynnelsen på noe nytt.": "När {name} rörde vid den lysande cirkeln hände något.\nLjuset började röra sig långsamt.\nSmå gnistor dansade runt hans hand.\nLuften surrade lågt, som om portalen vaknade.\n{name} tog ett djupt andetag. Det här var början på något nytt.",
  "{name} tok et forsiktig steg frem. Foran ham lå Dinosaurdalen.\nHøye fjell og fosser strakte seg rundt ham. Store skygger beveget seg i det fjerne.\nDette var et helt nytt sted. Og eventyret hadde så vidt begynt.": "{name} tog ett försiktigt steg fram. Framför honom låg Dinosauriernas dal.\nHöga berg och vattenfall sträckte sig runt honom. Stora skuggor rörde sig i fjärran.\nDet här var en helt ny plats. Och äventyret hade bara börjat.",
  "Dinosauren kom rolig nærmere. Den var stor, men så snill ut.\n«Jeg heter Lumi,» sa den lavt. «Jeg trenger hjelp.»\n{name} nølte litt – så tok han et steg frem.": "Dinosaurien kom lugnt närmare. Den var stor, men såg snäll ut.\n\"Jag heter Lumi\", sa den lågt. \"Jag behöver hjälp.\"\n{name} tvekade lite, men tog sedan ett steg fram.",
  "Plutselig begynte Lumi å løpe. Han snudde seg og så på {name}.\n«Kom!» sa han vennlig. «Jeg trenger hjelpen din.»\n{name} nølte litt. Så begynte han å løpe etter.": "Plötsligt började Lumi springa. Han vände sig om och såg på {name}.\n\"Kom!\" sa han vänligt. \"Jag behöver din hjälp.\"\n{name} tvekade lite. Sedan började han springa efter.",
  "{name} gikk ved siden av Lumi. Stien var smal og stille.\n«Hva trenger du hjelp med?» spurte {name}. Lumi ristet på hodet.\n«Jeg kan ikke si det,» sa han lavt. «Jeg må vise deg.»\nDe gikk videre sammen.": "{name} gick bredvid Lumi. Stigen var smal och tyst.\n\"Vad behöver du hjälp med?\" frågade {name}. Lumi skakade på huvudet.\n\"Jag kan inte säga det\", sa han lågt. \"Jag måste visa dig.\"\nDe gick vidare tillsammans.",
  "Plutselig stoppet Lumi. Øynene ble store.\n«Å nei… der er han,» hvisket han. «Det er den jeg snakket om.»\nLumi pekte mot den store dinosauren. «Han har vært slem mot de andre.»\nSå så han på {name}. «Det er han jeg trenger hjelp med.»": "Plötsligt stannade Lumi. Ögonen blev stora.\n\"Åh nej... där är han\", viskade han. \"Det är den jag pratade om.\"\nLumi pekade mot den stora dinosaurien. \"Han har varit elak mot de andra.\"\nSedan såg han på {name}. \"Det är honom jag behöver hjälp med.\"",
  "{name} tok et steg frem. Hjertet banket fort, men han sto støtt.\n«Du må slutte,» sa han rolig. «Det er ikke greit å være slem.»\nT-rexen stoppet opp. Ingen hadde sagt det til ham før.": "{name} tog ett steg fram. Hjärtat slog fort, men han stod stadigt.\n\"Du måste sluta\", sa han lugnt. \"Det är inte okej att vara elak.\"\nT-rexen stannade upp. Ingen hade sagt det till honom förut.",
  "T-rexen senket hodet. «Jeg forsto ikke at jeg gjorde vondt,» sa han lavt.\nHan snudde seg sakte. Denne gangen uten brøl.\nOg med tunge steg gikk han rolig sin vei.": "T-rexen sänkte huvudet. \"Jag förstod inte att jag gjorde andra illa\", sa han lågt.\nHan vände sig långsamt om. Den här gången utan rytande.\nOch med tunga steg gick han lugnt sin väg.",
  "{name} og Lumi sto stille sammen. De så utover dalen der de andre dinosaurene levde i fred.\nLumi smilte forsiktig. Og {name} kjente seg varm og stolt inni seg.\nDe hadde gjort noe viktig – sammen.": "{name} och Lumi stod stilla tillsammans. De såg ut över dalen där de andra dinosaurierna levde i fred.\nLumi log försiktigt. Och {name} kände sig varm och stolt inombords.\nDe hade gjort något viktigt, tillsammans.",
  "Solen var i ferd med å gå ned. {name} visste at det var på tide å dra hjem.\nLumi så på ham og nikket stille. «Du vil alltid være en venn,» sa han.\n{name} vinket farvel. Og med et smil tok han steget tilbake til sin egen verden.": "Solen höll på att gå ner. {name} visste att det var dags att gå hem.\nLumi såg på honom och nickade stilla. \"Du kommer alltid att vara en vän\", sa han.\n{name} vinkade farväl. Och med ett leende tog han steget tillbaka till sin egen värld.",
  "Denne boken handler om mot. Om å tørre å si ifra når noe er urettferdig – selv når det føles litt skummelt.\nGjennom et magisk møte i Dinosaurdalen lærer {name} at ekte styrke ikke handler om å være størst eller sterkest, men om å være snill, modig og å bry seg om andre.\nEn varm og personlig historie som viser barn at én stemme kan gjøre en stor forskjell. Og at vennskap kan oppstå på de mest uventede steder.\nEn bok som gir trygghet, selvtillit – og minner barnet på at også de kan være en helt.": "Den här boken handlar om mod. Om att våga säga ifrån när något är orättvist, även när det känns lite läskigt.\nGenom ett magiskt möte i Dinosauriernas dal lär sig {name} att riktig styrka inte handlar om att vara störst eller starkast, utan om att vara snäll, modig och bry sig om andra.\nEn varm och personlig berättelse som visar barn att en enda röst kan göra stor skillnad. Och att vänskap kan uppstå på de mest oväntade platser.\nEn bok som ger trygghet, självförtroende och påminner barnet om att också de kan vara en hjälte."
}
...
def _dp_layout_offsets(filename: str):
    ...
    if number == 7:
        ...
        bottom_y = 410
    if number == 9:
        # Den fangede dinosaurungen har hodet midt i den nedre kanten av
        # den oeverste blokken - loeft den saa teksten ikke ligger i fjeset.
        top_y = -70
