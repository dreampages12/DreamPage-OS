...
HAVFRUEN_DREAMPAGE_FIRST = os.path.join(
    DP_ROOT, "books", "havfruen", "dreampage-first-havfruen.png"
)
...
def draw_centered_title_cover(img, text, base_dir: str | None = None):
    ...
    font_size_line1 = max(50, int(base * (77 / 1024)))
    ...
    SHADOW_COL   = (40, 20, 0)
    TOP_MARGIN   = 0.04
    LINE_SPACING = 0.040          # mer luft mellom linje 1 og logo
    LOGO_SCALE   = 0.60
    LOGO_X_OFFSET = 0
    ...
    pages: List[Dict[str, Any]] = [
        ...
        # Side 1 – det mystiske skjellet → tekst VENSTRE
        {
            ...
            "blocks": [{
                ...
                "font_size": 30,
                "color": "#FFFFFF",
                "highlights": [child_name, "snäcka", "glittrade"],
                "x_offset": 0,
                "y_offset": -10,
            }],
        },
        ...
        # Side 2 – stemmen fra havet → tekst HØYRE
        {
            ...
            "blocks": [{
                ...
                "font_size": 29,
                "color": "#FFFFFF",
                "highlights": [child_name, "röst", "sjöjungfru"],
                "x_offset": 10,
                "y_offset": -10,
                "width_offset": -10,
            }],
        ...
        # Side 3 – den skjulte lagunen → tekst VENSTRE
        {
            ...
            "blocks": [{
                ...
                "font_size": 29,
                "color": "#FFFFFF",
                "highlights": [child_name, "lagun", "hemlig"],
                "x_offset": 0,
                "y_offset": -10,
            }],
        },
        ...
        # Side 4 – den magiske perlen → tekst HØYRE
        {
            ...
            "blocks": [{
                "text": p(
                    ...
                    "\n"
                    "(Navn) sträckte försiktigt fram handen. När fingertopparna nuddade pärlan började hela lagunen glittra."
                ),
                "font_size": 29,
                "color": "#FFFFFF",
                "highlights": [child_name, "pärla", "Magin"],
                "x_offset": 10,
                "y_offset": -10,
                "width_offset": -10,
            }],
        ...
        # Side 5 – (Navn) blir havfrue → tekst VENSTRE
        {
            ...
            "blocks": [{
                ...
                "font_size": 30,
                "color": "#FFFFFF",
                "highlights": [child_name, "sjöjungfrusvans", "sjöjungfru"],
                "x_offset": 0,
                "y_offset": -10,
            }],
        },

        # Side 6 – den forste svommeturen → tekst VENSTRE
        {
        ...
        # Side 7 – havfruenes rike → tekst VENSTRE
        {
            ...
            "blocks": [{
                "text": p(
                    ...
                    "\n"
                    "Torn av koraller sträckte sig upp från havsbottnen, och små hus av snäckor glittrade bland lysande växter.\n"
                    "\n"
                    "(Navn) hann nästan inte titta på allt samtidigt. Det var det vackraste hon visste."
                ),
                "font_size": 29,
                "color": "#FFFFFF",
                "highlights": [child_name, "sjöjungfrurike", "vackraste"],
                "x_offset": 0,
                "y_offset": -10,
            }],
        },
        ...
        # Side 8 – noe er galt → tekst HØYRE
        {
            ...
            "blocks": [{
                "text": p(
                    ...
                    "\n"
                    "«Havets magi håller på att försvinna,» sa sjöjungfrun. «Hittar vi inte orsaken blir hela riket mörkt.»"
                ),
                "font_size": 29,
                "color": "#FFFFFF",
                "highlights": [child_name, "magi", "mörkt"],
                "x_offset": 10,
                "y_offset": -10,
                "width_offset": -10,
            }],
        ...
        # Side 9 – den morke passasjen → tekst VENSTRE
        {
            ...
            "blocks": [{
                ...
                "font_size": 29,
                "color": "#FFFFFF",
                "highlights": [child_name, "tunnel", "hjälp"],
                "x_offset": 0,
                "y_offset": -10,
            }],
        },

        # Side 10 – havskilpadden → tekst VENSTRE
        {
            ...
            "blocks": [{
                "text": p(
                    ...
                    "\n"
                    "Tillsammans knuffade de undan stenarna. Sköldpaddan simmade ett tacksamt varv runt (Navn) och nickade med huvudet. Hon ville att de skulle följa med."
                ),
                "font_size": 29,
                "color": "#FFFFFF",
                "highlights": [child_name, "havssköldpadda", "hjälpa"],
                "x_offset": 0,
                "y_offset": -10,
            }],
        },
        ...
        # Side 11 – den hemmelige hulen → tekst VENSTRE
        {
            ...
            "blocks": [{
                ...
                "font_size": 29,
                "color": "#FFFFFF",
                "highlights": [child_name, "symbolerna", "grotta"],
                "x_offset": 0,
                "y_offset": -10,
            }],
        },

        # Side 12 – havets hjerte → tekst VENSTRE
        {
            ...
            "blocks": [{
                "text": p(
                    ...
                    "\n"
                    "Då började snäckan i (Navn)s hand glöda. Hon höll den närmare, och de två ljusen svarade varandra."
                ),
                "font_size": 30,
                "color": "#FFFFFF",
                "highlights": [child_name, "kristall", "hjärta"],
                "x_offset": 0,
                "y_offset": 200,
            }],
        },
        ...
        # Side 13 – lyset vender tilbake → tekst VENSTRE
        {
            ...
            "blocks": [{
                "text": p(
                    ...
                    "\n"
                    "Korallerna fick tillbaka sina färger, gatorna började lysa och fiskarna kom fram igen. Sjöjungfrur jublade i hela riket. (Navn) hade räddat dem alla."
                ),
                "font_size": 30,
                "color": "#FFFFFF",
                "highlights": [child_name, "ljus", "räddat"],
                "x_offset": 0,
                "y_offset": -10,
            }],
        },
        ...
        # Side 14 – en ny hemmelighet → tekst HØYRE
        {
            ...
            "blocks": [{
                "text": p(
                    ...
                    "\n"
                    "Just då blinkade Havets hjärta igen. En ljusstråle sköt ut i det mörka havet, och långt borta tändes ljus i ett gammalt palats.\n"
                    "\n"
                ...
                "font_size": 28,
                "color": "#FFFFFF",
                "highlights": [child_name, "palats", "Äventyret"],
                "x_offset": 10,
                "y_offset": -10,
                "width_offset": -10,
            }],
        ...
        # Bakside
        {
            ...
            "blocks": [{
                "text": p(
                    ...
                    "\n"
                    "När (Navn) hittar en snäcka som lyser i blått och lila öppnas dörren till sjöjungfrurnas hemliga värld. Men magin i riket håller på att slockna, och bara någon med ett äkta hjärta för havet kan väcka den igen.\n"
                    "\n"
                    "Tillsammans med en sjöjungfru och en havssköldpadda letar (Navn) efter Havets hjärta — djupt inne i en grotta som ingen har besökt på mycket länge.\n"
                    "\n"
                    "En personlig berättelse om mod, vänskap och magin i att hjälpa andra."
                ),
                "font_size": 38,
                "color": "#FFFFFF",
                "highlights": [child_name, "sjöjungfrurnas", "Havets", "mod", "vänskap", "magin"],
            }],
        },
...
def render_dreampage_first(child_name: str, out_dir: str) -> str:
    ...
    """
    src = _dp_first(HAVFRUEN_DREAMPAGE_FIRST)
    ...
    title_line = f"Till {child_name}"
    body_lines = [
        "Den här boken är gjord speciellt för dig.",
        f"Du är {child_name} — hjälten i berättelsen.",
        "",
        "Det är dina drömmar, ditt mod",
        "och din fantasi som fyller dessa sidor.",
        "",
        "Tro alltid på dig själv,",
        "precis som du gör i den här berättelsen.",
    ]
...
def process_book(base_dir: str, out_dir: str, child_name: str, cover_type: str, gelato_api_key: str):
    ...
    dreampage_first = _dp_first(HAVFRUEN_DREAMPAGE_FIRST)
...
_DREAMPAGE_TRANSLATIONS = {
  "{name} blir": "{name} blir en",
  "{name} sto barbeint på stranden en varm sommerdag og så utover de blanke bølgene.\nHavet glitret som tusen små stjerner, og langt der ute sang måkene over vannet.\n\nHun hadde alltid lurt på hva som fantes under bølgene. Den dagen lengtet hjertet hennes ekstra sterkt etter et eventyr.": "{name} stod barfota på stranden en varm sommardag och såg ut över de blanka vågorna.\nHavet glittrade som tusen små stjärnor, och långt där ute sjöng måsarna över vattnet.\n\nHon hade alltid undrat vad som fanns under vågorna. Den dagen längtade hennes hjärta extra starkt efter ett äventyr.",
  "I sanden glitret noe vakkert.\n{name} bøyde seg ned og fant et skjell som lyste i regnbuens farger.\n\nDa hun løftet det opp mot øret, hørte hun en mild sang.\n\nDet var som om havet selv hvisket til henne.": "I sanden glittrade något vackert.\n{name} böjde sig ner och hittade ett snäckskal som lyste i regnbågens färger.\n\nNär hon lyfte det mot örat hörde hon en mild sång.\n\nDet var som om havet själv viskade till henne.",
  "Plutselig dukket en vennlig havfrue opp i vannkanten.\nHun smilte varmt og rakte hendene mot {name}, som om de allerede kjente hverandre.\n\n«Skjellet du holder er magisk,» sa havfruen mykt. «Det kan gjøre deg til havfrue for én eneste dag, hvis du virkelig ønsker det.»": "Plötsligt dök en vänlig sjöjungfru upp vid vattenbrynet.\nHon log varmt och räckte händerna mot {name}, som om de redan kände varandra.\n\n\"Snäckskalet du håller i är magiskt\", sa sjöjungfrun mjukt. \"Det kan göra dig till sjöjungfru för en enda dag, om du verkligen önskar det.\"",
  "{name} holdt skjellet tett inntil hjertet sitt og lukket øynene.\nEt varmt lys begynte å svøpe seg rundt henne, først som sol på huden og så som glitrende bobler.\n\nDa hun åpnet øynene igjen, hadde bena hennes blitt til en skinnende havfruehale i akkurat hennes favorittfarge.": "{name} höll snäckskalet tätt intill hjärtat och slöt ögonen.\nEtt varmt ljus började svepa sig runt henne, först som sol mot huden och sedan som glittrande bubblor.\n\nNär hon öppnade ögonen igen hade hennes ben blivit till en skimrande sjöjungfrustjärt i just hennes favoritfärg.",
  "{name} dykket ned i havet for aller første gang, og alt ble stille og mykt rundt henne.\nForan henne åpnet et stort korallrev seg som en hemmelig by av farger.\n\nFisk i rødt, gull og blått danset mellom korallene. Det var den vakreste verdenen hun noen gang hadde sett.": "{name} dök ner i havet för allra första gången, och allt blev stilla och mjukt omkring henne.\nFramför henne öppnade sig ett stort korallrev som en hemlig stad av färger.\n\nFiskar i rött, guld och blått dansade mellan korallerna. Det var den vackraste värld hon någonsin hade sett.",
  "Brått svømte en lekende delfin bort til {name}.\nDen blunket vennlig, laget en liten spiral i vannet og lo med en lys klikkelyd.\n\n«Bli min nye venn,» sa delfinen, «så viser jeg deg hele havets rike.» {name} nikket glad og fulgte etter.": "Plötsligt simmade en lekfull delfin fram till {name}.\nDen blinkade vänligt, gjorde en liten spiral i vattnet och skrattade med ett ljust klickande ljud.\n\n\"Bli min nya vän\", sa delfinen, \"så visar jag dig hela havets rike.\" {name} nickade glatt och följde efter.",
  "Sammen svømte de inn i en hemmelig hage under havet.\nBlomstene lyste i blått, rosa og fiolett, og små bobler steg opp som perler fra sanden.\n\nPlantene danset stille i strømmen, som om de hilste henne velkommen. {name} lo høyt av bare glede.": "Tillsammans simmade de in i en hemlig trädgård under havet.\nBlommorna lyste i blått, rosa och violett, och små bubblor steg upp som pärlor från sanden.\n\nVäxterna dansade tyst i strömmen, som om de hälsade henne välkommen. {name} skrattade högt av ren glädje.",
  "Litt lenger borte glitret et stort slott av perlemor.\nTårnene var bygget av skjell, koraller og små steiner som lyste i vannet.\n\nAndre havfruer kom svømmende mot {name} og smilte varmt. «Velkommen til havfrueslottet!» ropte de i kor.": "Lite längre bort glittrade ett stort slott av pärlemor.\nTornen var byggda av snäckor, koraller och små stenar som lyste i vattnet.\n\nAndra sjöjungfrur kom simmande mot {name} och log varmt. \"Välkommen till sjöjungfruslottet!\" ropade de i kör.",
  "Plutselig oppdaget havfruene en bekymret liten babyskilpadde.\nDen hadde gått seg vill og fant ikke mammaen sin.\n\n{name} bøyde seg ned og strøk den forsiktig over skallet.\n\n«Vi skal hjelpe deg hjem,» sa hun bestemt.": "Plötsligt upptäckte sjöjungfrurna en orolig liten sköldpaddsunge.\nDen hade kommit vilse och hittade inte sin mamma.\n\n{name} böjde sig ner och strök den försiktigt över skalet.\n\n\"Vi ska hjälpa dig hem\", sa hon bestämt.",
  "{name} og delfinen svømte gjennom mørke huler der lyset fra perlen blinket på steinveggene.\nStore, rolige hvaler sang dype toner i bakgrunnen, som om de viste vei.\n\nVannet var kjølig, men hjertet hennes var modig. Et sted der ute ventet en mamma på babyen sin.": "{name} och delfinen simmade genom mörka grottor där ljuset från pärlan blinkade på stenväggarna.\nStora, lugna valar sjöng djupa toner i bakgrunden, som om de visade vägen.\n\nVattnet var svalt, men hennes hjärta var modigt. Någonstans där ute väntade en mamma på sin unge.",
  "Endelig fant de mammaskilpadden, som lette fortvilet mellom tang og steiner.\nDen lille babyen svømte glad rett til henne, og de to skilpaddene la hodene mykt mot hverandre.\n\nFisk, seler og koraller jublet for {name}. Hele havet feiret henne som en ekte helt.": "Äntligen hittade de sköldpaddsmamman, som letade förtvivlat bland tång och stenar.\nDen lilla ungen simmade glatt rakt till henne, och de två sköldpaddorna lade mjukt huvudena mot varandra.\n\nFiskar, sälar och koraller jublade för {name}. Hela havet firade henne som en riktig hjälte.",
  "Som takk førte havfruene {name} til en gammel skattekiste skjult mellom korallene.\nDa lokket åpnet seg sakte, lyste en glitrende, perfekt rund perle mildt opp i vannet.\n\n«Denne har havet gjemt til deg, lille modige venn,» hvisket de. «Den vil alltid minne deg på havets eventyr og på hjertet ditt.»": "Som tack förde sjöjungfrurna {name} till en gammal skattkista gömd mellan korallerna.\nNär locket långsamt öppnades lyste en glittrande, perfekt rund pärla mjukt upp i vattnet.\n\n\"Den här har havet gömt åt dig, lilla modiga vän\", viskade de. \"Den kommer alltid att påminna dig om havets äventyr och om ditt hjärta.\"",
  "Solen begynte å gå ned over havet, og vannet ble gyllent rundt slottet.\n{name} vinket farvel til delfinen, havfruene og alle vennene sine.\n\n«Jeg kommer til å savne dere,» hvisket hun. «Men jeg lover å aldri glemme dere.»": "Solen började gå ner över havet, och vattnet blev gyllene runt slottet.\n{name} vinkade farväl till delfinen, sjöjungfrurna och alla sina vänner.\n\n\"Jag kommer att sakna er\", viskade hon. \"Men jag lovar att aldrig glömma er.\"",
  "Tilbake på stranden hadde {name} bena sine igjen, men eventyret kjentes fortsatt ekte.\nI hånden holdt hun den vakre perlen, varm og blank som et lite lys fra dypet.\n\nHun smilte mot bølgene som sakte rullet inn. Havet skulle alltid være hennes hemmelige eventyr.": "Tillbaka på stranden hade {name} sina ben igen, men äventyret kändes fortfarande verkligt.\nI handen höll hon den vackra pärlan, varm och blank som ett litet ljus från djupet.\n\nHon log mot vågorna som sakta rullade in. Havet skulle alltid vara hennes hemliga äventyr.",
  "En liten drømmer. Et magisk skjell. Et helt nytt rike under bølgene.\n\nNår {name} finner et glitrende skjell på stranden, åpner det døren til et eventyr ingen kan glemme. Sammen med en lekende delfin og en flokk vennlige havfruer reiser hun gjennom korallrev, hemmelige hager og perlemor-slott.\n\nUnderveis lærer {name} hvor sterk hun er — og at ekte vennskap kan oppstå selv i dypeste hav.\n\nEn personlig fortelling om mot, fantasi og havets uendelige eventyr.": "En liten drömmare. Ett magiskt snäckskal. Ett helt nytt rike under vågorna.\n\nNär {name} hittar ett glittrande snäckskal på stranden öppnar det dörren till ett äventyr ingen kan glömma. Tillsammans med en lekfull delfin och en flock vänliga sjöjungfrur reser hon genom korallrev, hemliga trädgårdar och pärlemorslott.\n\nUnder resan lär sig {name} hur stark hon är, och att riktig vänskap kan uppstå även i havets djup.\n\nEn personlig berättelse om mod, fantasi och havets oändliga äventyr."
}
...
_DP_PAGE_OFFSETS = {
    3:  (40, 365),
    6:  (370, 555),    # begge blokkene under henne - over hodet er inni beskjaeringa
    7:  (115, 410),
