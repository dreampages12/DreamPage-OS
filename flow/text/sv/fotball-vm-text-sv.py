...
_DREAMPAGE_TRANSLATIONS = {
  ...
  'Etter den store kampen får {name} en helt spesiell beskjed.\nEn speider har sett ham spille, og nå er han invitert til landslagssamling.': 'Efter den stora matchen får {name} ett alldeles särskilt besked.\nEn scout har sett honom spela, och nu är han kallad till landslagssamling.',
  'På samlingen trener {name} sammen med mange andre flinke barn.\nHan gir alt han har og håper at treneren legger merke til ham.': 'På samlingen tränar {name} tillsammans med många andra duktiga barn.\nHan ger allt han har och hoppas att tränaren ska lägga märke till honom.',
  'Til slutt leser treneren opp navnene på spillerne som skal til VM.\nSå hører {name} sitt eget navn.\nHan skal spille for Norge!': 'Till slut läser tränaren upp namnen på spelarna som ska till VM.\nSå hör {name} sitt eget namn.\nHan ska spela för Norge!',
  'VM starter mot Tyskland, men kampen blir tøff.\nDa dommeren blåser av, står det 2–0 til Tyskland.\nDet var ikke starten Norge hadde håpet på.': 'VM börjar mot Tyskland, men matchen blir tuff.\nNär domaren blåser av står det 2–0 till Tyskland.\nDet var inte starten Norge hade hoppats på.',
  '{name} sitter stille i garderoben etter tapet.\nFor første gang begynner han å lure på om VM-eventyret kan være over\nfør det egentlig har begynt.': '{name} sitter tyst i omklädningsrummet efter förlusten.\nFör första gången börjar han undra om VM-äventyret kan vara över\ninnan det egentligen har börjat.',
  'Treneren samler laget.\n«Én kamp bestemmer ikke hvem vi er.»\n{name} ser på lagkameratene. De er ikke ferdige ennå.': 'Tränaren samlar laget.\n«En match avgör inte vilka vi är.»\n{name} ser på lagkamraterna. De är inte färdiga än.',
  'Norge kjemper seg videre, og neste store utfordring er Brasil.\n{name} løper ut på banen klar for en av de største kampene i livet sitt.': 'Norge kämpar sig vidare, och nästa stora utmaning är Brasilien.\n{name} springer ut på planen redo för en av de största matcherna i sitt liv.',
  'Brasil presser hardt, men {name} nekter å gi seg.\nHan dribler mellom motstanderne og leter etter åpningen som Norge trenger.': 'Brasilien pressar hårt, men {name} vägrar att ge sig.\nHan dribblar mellan motståndarna och letar efter öppningen som Norge behöver.',
  'Da sluttsignalet går, bryter jubelen løs.\nNorge har slått Brasil!\nNå er de bare én kamp unna VM-finalen.': 'När slutsignalen går bryter jublet loss.\nNorge har slagit Brasilien!\nNu är de bara en match från VM-finalen.',
  'I semifinalen mot Argentina står det 2–2 mot slutten.\nSå får {name} sjansen.\nHan scorer — og sender Norge til VM-finalen.': 'I semifinalen mot Argentina står det 2–2 mot slutet.\nSå får {name} chansen.\nHan gör mål — och skickar Norge till VM-finalen.',
  '{name} står i spillertunnelen og ser ut mot stadion.\nPå den andre siden venter Spania.\nBare én kamp står mellom Norge og VM-pokalen.': '{name} står i spelartunneln och ser ut mot arenan.\nPå andra sidan väntar Spanien.\nBara en match står mellan Norge och VM-pokalen.',
  'Finalen blir jevn og nervepirrende.\nBegge lag får sjanser, men ingen klarer å avgjøre.\nMot slutten står det fortsatt 1–1.': 'Finalen blir jämn och nervkittlande.\nBåda lagen får chanser, men ingen lyckas avgöra.\nMot slutet står det fortfarande 1–1.',
  'Så får {name} ballen.\nHan ser åpningen, skyter —\nMÅL!\nNorge leder 2–1.': 'Så får {name} bollen.\nHan ser öppningen, skjuter —\nMÅL!\nNorge leder 2–1.',
  'Sluttsignalet går.\nNorge har slått Spania 2–1 og vunnet Fotball-VM!\n{name} jubler med laget. Han er verdensmester.': 'Slutsignalen går.\nNorge har slagit Spanien 2–1 och vunnit Fotbolls-VM!\n{name} jublar med laget. Han är världsmästare.',
  'Denne boken handler om å reise seg igjen. Om lagånd, om nerver før en stor kamp, og om å tro på seg selv mens hele verden ser på.\nEtter den store kampen hjemme får {name} beskjeden han knapt tør å tro på: landslaget vil ha ham med til VM.\nEn varm og spennende fortelling om vennskap, mot og drømmer som blir større enn man tør å håpe på.\nFor den største forskjellen mellom en drøm og et eventyr er at noen tør å fortsette når det blir vanskelig.': 'Den här boken handlar om att resa sig igen. Om laganda, om nerver före en stor match, och om att tro på sig själv medan hela världen tittar på.\nEfter den stora matchen hemma får {name} beskedet han knappt vågar tro på: landslaget vill ha honom med till VM.\nEn varm och spännande berättelse om vänskap, mod och drömmar som blir större än man vågar hoppas på.\nFör den största skillnaden mellan en dröm och ett äventyr är att någon vågar fortsätta när det blir svårt.',
}
