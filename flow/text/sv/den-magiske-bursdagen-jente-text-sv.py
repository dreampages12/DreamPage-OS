...
MOTET_DREAMPAGE_FIRST = os.path.join(
    os.path.dirname(SCRIPT_ROOT_DIR), "books", "den-magiske-bursdagen-jente", "dreampage-first-rosa.png"
)
...
def _draw_title_cover_text(img, text):
    ...
    font_small = ImageFont.truetype(_dp_line1_font(), int(min(img.size) * 0.070))
    font_large = ImageFont.truetype(COVER_FONT, int(min(img.size) * 0.117))


    # prinsesse (BRUKES I PRINSESSE BOKEN)
    gold   = ((210, 120, 150), (255, 245, 235))
    shadow = (40, 30, 60)
...
# ---------------------------------------------------------------------------
FRONT_COVER_LOGO_SCALE = 0.85
FRONT_COVER_LOGO_X_OFFSET = 0
FRONT_COVER_TOP_MARGIN = 0.03
FRONT_COVER_LINE_SPACING = 0.05
...
def resolve_front_cover_logo():
    ...
    """
    name = {
        "nb": "magiske-bursdag-logo-nb.png",
        "nn": "magiske-bursdag-logo-nb.png",
        "en-US": "magiske-bursdag-logo-en.png",
        "en-GB": "magiske-bursdag-logo-en.png",
        "sv": "magiske-bursdag-logo-sv.png",
    }.get(SCRIPT_LOCALE, "magiske-bursdag-logo-nb.png")
...
def draw_centered_title_cover(img, text, base_dir=None):
    ...
    line1 = text.split("\n")[0] if text else ""
    font_small = ImageFont.truetype(_dp_line1_font(), int(base * FRONT_COVER_LINE1_SIZE))
...
def build_pages(child_name: str) -> List[Dict[str, Any]]:
    ...
    pages: List[Dict[str, Any]] = [
        {
            "filename": "forside(magiske-bursdag-jente).png",
            "type": "cover",
            "text": p("(Navn) sin\nDen Magiske Bursdagen"),
        },
        {
        ...
        # Side 1
        {
            "filename": "01(magiske-bursdag-jente).png",
            "type": "inner",
            "side": "left",
            "blocks": [{
                "text": p(
        ...
        # Side 2
        {
            "filename": "02(magiske-bursdag-jente).png",
            "type": "inner",
            "side": "right",
            "blocks": [{
                "text": p(
        ...
        # Side 3
        {
            "filename": "03(magiske-bursdag-jente).png",
            "type": "inner",
            "side": "left",
            "blocks": [{
                "text": p(
        ...
        # Side 4
        {
            "filename": "04(magiske-bursdag-jente).png",
            "type": "inner",
            "side": "right",
            "blocks": [{
                "text": p(
        ...
        # Side 5
        {
            "filename": "05(magiske-bursdag-jente).png",
            "type": "inner",
            "side": "left",
            "blocks": [{
                "text": p(
        ...
        # Side 6
        {
            "filename": "06(magiske-bursdag-jente).png",
            "type": "inner",
            "side": "right",
            "blocks": [{
                "text": p(
        ...
        # Side 7
        {
            "filename": "07(magiske-bursdag-jente).png",
            "type": "inner",
            "side": "left",
            "blocks": [{
                "text": p(
        ...
        # Side 8
        {
            "filename": "08(magiske-bursdag-jente).png",
            "type": "inner",
            "side": "right",
            "blocks": [{
                "text": p(
        ...
        # Side 9
        {
            "filename": "09(magiske-bursdag-jente).png",
            "type": "inner",
            "side": "left",
            "blocks": [{
                "text": p(
        ...
        # Side 10
        {
            "filename": "10(magiske-bursdag-jente).png",
            "type": "inner",
            "side": "right",
            "blocks": [{
                "text": p(
        ...
        # Side 11
        {
            "filename": "11(magiske-bursdag-jente).png",
            "type": "inner",
            "side": "left",
            "blocks": [{
                "text": p(
        ...
        # Side 12
        {
            "filename": "12(magiske-bursdag-jente).png",
            "type": "inner",
            "side": "right",
            "blocks": [{
                "text": p(
        ...
        # Side 13
        {
            "filename": "13(magiske-bursdag-jente).png",
            "type": "inner",
            "side": "left",
            "blocks": [{
                "text": p(
        ...
        # Side 14
        {
            "filename": "14(magiske-bursdag-jente).png",
            "type": "inner",
            "side": "right",
            "blocks": [{
                "text": p(
        ...
        # Bakside
        {
            "filename": "bakside(magiske-bursdag-jente).png",
            "type": "cover",
            "side": "left",
            "blocks": [{
                "text": p(
...
def render_dreampage_first(child_name: str, out_dir: str) -> str:
    ...
    """
    src = MOTET_DREAMPAGE_FIRST if os.path.exists(MOTET_DREAMPAGE_FIRST) else os.path.join(SCRIPT_DIR, "dreampage-first.png")
    ...
    body_lines = [
        ...
        f"Du är {child_name} — den modiga i den här berättelsen.",
        "",
        "Det är dina drömmar, ditt mod",
        "och dina mål som fyller dessa sidor.",
        "",
...
def process_book(base_dir: str, out_dir: str, child_name: str, cover_type: str, gelato_api_key: str):
    ...
    dreampage_first = MOTET_DREAMPAGE_FIRST if os.path.exists(MOTET_DREAMPAGE_FIRST) else os.path.join(SCRIPT_DIR, "dreampage-first.png")
    ...
    last_page = resolve_lastpage_path("Lastpage(bursdag).png")
    ...
    if last_page:
        ...
        print(f"ADVARSEL: Fant ikke Lastpage(bursdag).png i {LASTPAGE_DIR} - hopper over")
    ...
    need = ["bakside(magiske-bursdag-jente).png", "ryggrad.png", "forside(magiske-bursdag-jente).png"]
    ...
    back_path  = cover_rendered["bakside(magiske-bursdag-jente).png"]
    spine_path = cover_rendered["ryggrad.png"]
    front_path = cover_rendered["forside(magiske-bursdag-jente).png"]
...
_DREAMPAGE_TRANSLATIONS = {
  "{name} sin\nDen Magiske Bursdagen": "{name_genitive}\nDen Magiska Födelsedagen",
  "Det var bursdagen til {name}, og noe glitret under puten hennes.\nDet var en gyllen sløyfe – og den beveget seg helt av seg selv.\n{name} trakk forsiktig i den, og den rosa festkjolen svevde ut av skapet.\nSløyfen ville tydeligvis vise henne noe.": "Det var {name_genitive} födelsedag, och något glittrade under hennes kudde.\nDet var en gyllene rosett – och den rörde sig alldeles av sig själv.\n{name} drog försiktigt i den, och den rosa festklänningen svävade ut ur garderoben.\nRosetten ville tydligen visa henne något.",
  "{name} tok på seg kjolen, og sløyfen snodde seg bort til døren.\nHun trakk i den én gang til, og døren gled sakte opp.\nUtenfor lå en hage full av blomster, lys og sommerfugler.\nSløyfen fortsatte ut i hagen, som om den ville at hun skulle følge etter.": "{name} tog på sig klänningen, och rosetten slingrade sig bort till dörren.\nHon drog i den en gång till, och dörren gled sakta upp.\nUtanför låg en trädgård full av blommor, ljus och fjärilar.\nRosetten fortsatte ut i trädgården, som om den ville att hon skulle följa efter.",
  "Sløyfen la seg som en lysende sti gjennom hagen.\nLangt borte skimtet {name} en paviljong som glitret i solnedgangen.\nDa skjønte hun hvor sløyfen ville: den skulle føre henne dit.\nSå løp {name} av sted, midt i det gylne lyset.": "Rosetten lade sig som en lysande stig genom trädgården.\nLångt borta skymtade {name} en paviljong som glittrade i solnedgången.\nDå förstod hon vart rosetten ville: den skulle leda henne dit.\nSå sprang {name} i väg, mitt i det gyllene ljuset.",
  "Ved en stor blomsterport stoppet stien opp.\n{name} tok tak i sløyfen og trakk så hardt hun kunne.\nPorten svingte opp, ballonger steg mot himmelen og små lys ble tent.\nPå den andre siden lå gaver på rekke og rad, hele veien mot paviljongen.": "Vid en stor blomsterport tog stigen slut.\n{name} tog tag i rosetten och drog så hårt hon kunde.\nPorten svängde upp, ballonger steg mot himlen och små ljus tändes.\nPå andra sidan låg presenter på rad, hela vägen fram mot paviljongen.",
  "Plutselig kom det noen løpende bak henne.\nTo kaniner og et lite rådyr fulgte den samme gylne sløyfen.\nDe sprang forbi {name} og snudde seg, som om de ville si: bli med!\nSammen skyndte de seg videre mot bursdagsfesten.": "Plötsligt kom det några springande bakom henne.\nTvå kaniner och ett litet rådjur följde samma gyllene rosett.\nDe sprang förbi {name} och vände sig om, som om de ville säga: följ med!\nTillsammans skyndade de vidare mot födelsedagsfesten.",
  "Men da {name} kom frem, var ikke festen ferdig ennå.\nBordet stod tomt, og gavene lå strødd utover.\n{name} tok tak i sløyfen, og kaninene tok tak bak henne.\nSammen dro de – og blomster, ballonger og gaver begynte å finne plassen sin.": "Men när {name} kom fram var festen inte klar ännu.\nBordet stod tomt, och presenterna låg utspridda.\n{name} tog tag i rosetten, och kaninerna tog tag bakom henne.\nTillsammans drog de – och blommor, ballonger och presenter började hitta sina platser.",
  "{name} tok i så hardt hun kunne, én siste gang.\nForhengene gled til side, og hele festen kom til syne.\nDer stod en stor kake, tusen små lys og ballonger helt opp til himmelen.\nDette var hennes helt egen magiske bursdagsfest.": "{name} tog i så hårt hon kunde, en sista gång.\nDraperierna gled åt sidan, och hela festen kom fram.\nDär stod en stor tårta, tusen små ljus och ballonger ända upp mot himlen.\nDet här var hennes alldeles egen magiska födelsedagsfest.",
  "Det var fortsatt litt igjen å gjøre.\n{name} dyttet den siste store gaven på plass ved bordet.\nKaninene ordnet sløyfene, og rådyret holdt den gylne tråden.\nNå var alt klart til å feire.": "Det var fortfarande lite kvar att göra.\n{name} sköt den sista stora presenten på plats vid bordet.\nKaninerna ordnade rosetterna, och rådjuret höll i den gyllene tråden.\nNu var allt klart för att fira.",
  "{name} lukket øynene og ønsket seg noe.\nSå blåste hun ut alle lysene på kaken.\nGnistene virvlet opp og ble til en ny, glødende del av sløyfen.\nBursdagsønsket hennes fløy av sted, videre ut i hagen.": "{name} slöt ögonen och önskade sig något.\nSedan blåste hon ut alla ljusen på tårtan.\nGnistorna virvlade upp och blev en ny, glödande del av rosetten.\nHennes födelsedagsönskan flög i väg, vidare ut i trädgården.",
  "Overalt der ønsket fløy, våknet hagen til liv.\nBlomster åpnet seg, og girlandere hengte seg selv opp mellom trærne.\nKaninene kom med tallerkener, og rådyret bar en kurv full av roser.\n{name} satte den siste lysende blomsterstjernen øverst på kaken.": "Överallt där önskan flög vaknade trädgården till liv.\nBlommor slog ut, och girlanger hängde upp sig själva mellan träden.\nKaninerna kom med tallrikar, och rådjuret bar en korg full av rosor.\n{name} satte den sista lysande blomsterstjärnan högst upp på tårtan.",
  "Men ønskelyset stoppet ikke ved kaken.\nEn av kaninene oppdaget at det fortsatte bortover stien.\nKaninen satte av sted, og {name} løp tett bak.\nUnder en benk full av roser lå det en gave som ingen hadde sett før.": "Men önskeljuset stannade inte vid tårtan.\nEn av kaninerna upptäckte att det fortsatte bort längs stigen.\nKaninen sprang i väg, och {name} följde tätt efter.\nUnder en bänk full av rosor låg en present som ingen hade sett förut.",
  "{name} satte seg ned foran den skjulte gaven.\nHun tok tak i den lange sløyfen og trakk sakte.\nLokket spratt opp, og varmt, gyllent lys strømmet ut.\nKaninene og rådyret kom nærmere for å se hva som var inni.": "{name} satte sig ner framför den gömda presenten.\nHon tog tag i den långa rosetten och drog långsamt.\nLocket for upp, och varmt, gyllene ljus strömmade ut.\nKaninerna och rådjuret kom närmare för att se vad som fanns inuti.",
  "Inni gaven lå et lite lys formet som en blomst.\n{name} løftet det forsiktig opp, og det festet seg til den gylne sløyfen.\nMed ett samlet ballonger, blomster og lys seg rundt paviljongen.\nNå var bursdagsfesten endelig helt ferdig.": "Inuti presenten låg ett litet ljus format som en blomma.\n{name} lyfte försiktigt upp det, och det fäste sig vid den gyllene rosetten.\nMed ens samlades ballonger, blommor och ljus runt paviljongen.\nNu var födelsedagsfesten äntligen helt färdig.",
  "Da solen gikk ned, satte {name} seg til bords med vennene sine.\nHun skar det første stykket kake og delte det ut til kaninene og rådyret.\nDen gylne sløyfen la seg som en varm ring rundt hele selskapet.\n{name} hadde ikke bare funnet bursdagsfesten sin – hun hadde vært med på å lage den.": "När solen gick ner satte sig {name} till bords med sina vänner.\nHon skar den första tårtbiten och delade ut den till kaninerna och rådjuret.\nDen gyllene rosetten lade sig som en varm ring runt hela sällskapet.\n{name} hade inte bara hittat sin födelsedagsfest – hon hade varit med och skapat den.",
  "Denne boken handler om glede.\nOm å våkne opp til noe magisk, og selv være med på å skape det.\nDen viser at den fineste festen ikke er den man bare blir invitert til, men den man hjelper til med å gjøre ferdig.\nDerfor er det {name} som får hele feiringen til å våkne. En bursdagsgjest som blir vertinne i sitt eget eventyr.\nEn personlig fortelling som gir barn glede, mestringsfølelse og troen på at den aller fineste bursdagsmagien er den vi lager sammen.": "Den här boken handlar om glädje.\nOm att vakna upp till något magiskt, och själv vara med och skapa det.\nDen visar att den finaste festen inte är den man bara blir bjuden till, utan den man hjälper till att göra färdig.\nDärför är det {name} som får hela firandet att vakna. En födelsedagsgäst som blir värdinna i sitt eget äventyr.\nEn personlig berättelse som ger barn glädje, självförtroende och tron på att den allra finaste födelsedagsmagin är den vi skapar tillsammans."
}
