...
def resolve_front_cover_logo(base_dir: str | None = None) -> str | None:
    ...
    candidates = [
        os.path.join(LOGO_DIR, "magiska-resa-logo-sv.png"),
        os.path.join(LOGO_DIR, "magiska-resa-logo.png"),
...
def draw_centered_title_cover(img, text, base_dir: str | None = None):
    ...
    font_size_line1 = max(50, int(base * (79 / 1024)))
...
RYGGRAD_BOOK_SLUG = "den-magiske-reisen-jente"
...
def build_pages_verden_template(child_name: str) -> List[Dict[str, Any]]:
    ...
    return [
        ...
        },
        {
            ...
            "blocks": [{
                "text": p(
                    "Etter en helt vanlig dag gikk [NAVN] langs stien hun kjente så godt.\n"
                    "Da hørte hun en dyp, brusende lyd mellom trærne.\n"
                    "Den lød som en foss langt borte.\n"
                    "Likevel visste hun at det ikke fantes noen foss her."
                ),
                "font_size": 35,
                "color": "#FFF8F0",
                "highlights": ["lyd", "foss"],
        ...
        },
        {
            ...
            "blocks": [{
                "text": p(
                    ...
                    "Mellom mose og gamle steiner fant hun en smal åpning i skogen.\n"
                    "Stien så gammel ut, men ikke skummel.\n"
                    "Det føltes nesten som om den hadde ventet på henne."
                ),
                "font_size": 35,
                "color": "#FFF8F0",
        ...
        },
        {
            ...
            "blocks": [{
                "text": p(
                    ...
                    "Foran henne falt en mektig foss mellom mørke fjell.\n"
        ...
        },
        {
            ...
            "blocks": [{
                "text": p(
                    ...
                    "Bak det fallende vannet skimtet hun en åpning.\n"
                    "Hun visste at hun kanskje burde snu.\n"
        ...
        },
        {
            ...
            "blocks": [{
                "text": p(
                    "Da [NAVN] rørte ved vannet, ble hun stående helt stille.\n"
                    "Det føltes ikke kaldt og vått, men varmt som lys.\n"
                    "Hun tok et dypt pust og gikk ett skritt frem.\n"
        ...
        },
        {
            ...
            "blocks": [{
                "text": p(
                    ...
                    "[NAVN] skjønte at hun hadde funnet en skjult verden."
                ),
                "font_size": 35,
                "color": "#FFF8F0",
        ...
        },
        {
            ...
            "blocks": [{
                "text": p(
                    "En liten bro førte henne over elven til en gammel hytte.\n"
        ...
        },
        {
            ...
            "blocks": [{
                "text": p(
                    ...
                    "Da forsto hun at stedet ikke bare var vakkert. Det trengte hjelp."
                ),
                "font_size": 34,
                "color": "#FFF8F0",
        ...
        },
        {
            ...
            "blocks": [{
                "text": p(
                    ...
                    "Hun så opp mot høyden og visste hvor hun måtte gå."
                ),
                "font_size": 34,
                "color": "#FFF8F0",
        ...
        },
        {
            ...
            "blocks": [{
                "text": p(
                    ...
                    "Hun gikk gjennom høyt gress, over glatte steiner og forbi gamle trær.\n"
                    "Jo nærmere hun kom, desto mørkere ble himmelen.\n"
        ...
        },
        {
            ...
            "blocks": [{
                "text": p(
                    "Ved foten av treet fant hun solmerket, halvveis skjult i jord og røtter.\n"
        ...
        },
        {
            ...
            "blocks": [{
                "text": p(
                    ...
                    "Hun gravde med hendene, skjøv steiner unna og dro alt hun kunne.\n"
                    "Til slutt løsnet solmerket og fylte hendene hennes med varme.\n"
                    "Hun løftet det opp og plasserte det forsiktig mellom røttene."
                ),
                "font_size": 34,
                "color": "#FFF8F0",
        ...
        },
        {
            ...
            "blocks": [{
                "text": p(
                    ...
                    "Da [NAVN] kom ut i skogen igjen, lå et lite gyllent blad i hånden hennes.\n"
                    "Hun smilte for seg selv. En dag skulle hun finne veien tilbake."
                ),
                "font_size": 34,
                "color": "#FFF8F0",
        ...
        },
        {
            ...
            "blocks": [{
                "text": p(
                    ...
                    "Men når lyset i fossen begynner å svinne, må hun følge motet sitt og redde hemmeligheten før den forsvinner.\n"
...
def build_pages(child_name: str) -> List[Dict[str, Any]]:
    ...
    return [
        {
            "filename": "forside(den-magiske-reisen-jente).png",
            "type": "cover",
            "text": p("[NAVN] sin"),
        },
        {
        ...
        {
            "filename": "01(den-magiske-reisen-jente).png",
            "type": "inner",
            "side": "left",
            "blocks": [{
                "text": p(
                    "[NAVN] hadde nesten gjort seg klar for kvelden da hun oppdaget noe merkelig.\n"
                    "Mellom bøkene på rommet lå et kart hun aldri hadde sett før.\n"
                    "Det så gammelt og støvete ut, men da hun løftet det opp, begynte kantene å gløde svakt i gull."
                ),
                "font_size": 34,
                "color": "#FFF8EA",
                "highlights": [child_name, "kart", "gløde"],
                "x_offset": 15,
                "y_offset": -25,
                "width_offset": -20,
            }],
        ...
        {
            "filename": "02(den-magiske-reisen-jente).png",
            "type": "inner",
            "side": "right",
            "blocks": [{
                "text": p(
                    "Kartet ble varmt i hendene hennes.\n"
                ...
                "font_size": 35,
                "color": "#FFF8EA",
                "highlights": [child_name, "stjerner", "kart"],
                "x_offset": 10,
                "y_offset": -20,
                "width_offset": -30,
            }],
        ...
        {
            "filename": "03(den-magiske-reisen-jente).png",
            "type": "inner",
            "side": "left",
            "blocks": [{
                "text": p(
                ...
                "font_size": 34,
                "color": "#FFF8EA",
                "highlights": [child_name, "portal", "skog"],
                "x_offset": 55,
                "y_offset": -20,
            }],
        },
        {
            "filename": "04(den-magiske-reisen-jente).png",
            "type": "inner",
            "side": "right",
            "blocks": [{
                "text": p(
                    "[NAVN] tok et forsiktig skritt nærmere.\n"
                    "Portalen summet mykt, som om den ventet på henne.\n"
                    "Hun var spent, men kartet lyste varmt i hånden hennes.\n"
                    "Så rettet hun ryggen og hvisket: Jeg tør."
                ),
                "font_size": 34,
                "color": "#FFF8EA",
                "highlights": [child_name, "Jeg", "tør"],
                "x_offset": 20,
                "y_offset": -10,
                "width_offset": -20,
            }],
        ...
        {
            "filename": "05(den-magiske-reisen-jente).png",
            "type": "inner",
            "side": "left",
            "blocks": [{
                "text": p(
                    ...
                    "Bak henne blinket portalen stille mellom greinene.\n"
                    "Reisen hadde virkelig begynt."
                ),
                "font_size": 34,
                "color": "#FFF8EA",
                "highlights": [child_name, "fortryllede", "begynt"],
                "x_offset": 20,
                "y_offset": -20,
                "width_offset": -25,
            }],
        ...
        {
            "filename": "06(den-magiske-reisen-jente).png",
            "type": "inner",
            "side": "right",
            "blocks": [{
                "text": p(
                    "På stien foran henne dukket en liten gyllen rev opp.\n"
                ...
                "font_size": 32,
                "color": "#FFF8EA",
                "highlights": [child_name, "reven", "tørre"],
                "x_offset": 10,
                "y_offset": -15,
                "width_offset": -30,
            }],
        ...
        {
            "filename": "08(den-magiske-reisen-jente).png",
            "type": "inner",
            "side": "right",
            "blocks": [{
                "text": p(
                ...
                "font_size": 32,
                "color": "#FFF8EA",
                "highlights": [child_name, "portal", "klar"],
                "x_offset": 55,
                "y_offset": -25,
            }],
        },
        {
            "filename": "09(den-magiske-reisen-jente).png",
            "type": "inner",
            "side": "left",
            "blocks": [{
                "text": p(
                    ...
                    "[NAVN] løsnet plantene én etter én, og dragen dyttet snuten takknemlig mot hånden hennes."
                ),
                "font_size": 32,
                "color": "#FFF8EA",
                "highlights": [child_name, "drageunge", "takknemlig"],
                "x_offset": 55,
                "y_offset": -20,
            }],
        },
        {
            "filename": "10(den-magiske-reisen-jente).png",
            "type": "inner",
            "side": "right",
            "blocks": [{
                "text": p(
                ...
                "font_size": 32,
                "color": "#FFF8EA",
                "highlights": [child_name, "stjernemerke", "havet"],
                "x_offset": 55,
                "y_offset": -20,
            }],
        },
        {
            "filename": "11(den-magiske-reisen-jente).png",
            "type": "inner",
            "side": "left",
            "blocks": [{
                "text": p(
                    "Da [NAVN] gikk gjennom portalen, lukket en glødende luftboble seg rundt henne.\n"
                    "Utenfor danset vannet stille, og hele undervannsbyen lyste.\n"
                    "Midt i byen blinket et nytt stjernemerke på kartet.\n"
                    "Da hun rørte ved merket, fløy lyset rett inn i papiret."
                ),
                "font_size": 30,
                "color": "#FFF8EA",
                "highlights": [child_name, "luftboble", "stjernemerke"],
                "x_offset": 55,
                "y_offset": -20,
            }],
        },
        {
            "filename": "12(den-magiske-reisen-jente).png",
            "type": "inner",
            "side": "right",
            "blocks": [{
                "text": p(
                    ...
                    "Fjellene ruvet rundt henne som blå krystaller.\n"
                    "Drageungen sto ved siden av henne, klar til å følge henne videre."
                ),
                "font_size": 33,
                "color": "#FFF8EA",
                "highlights": [child_name, "nordlys", "videre"],
                "x_offset": 15,
                "y_offset": -20,
                "width_offset": -25,
            }],
        ...
        {
            "filename": "13(den-magiske-reisen-jente).png",
            "type": "inner",
            "side": "left",
            "blocks": [{
                "text": p(
                ...
                "font_size": 31,
                "color": "#FFF8EA",
                "highlights": [child_name, "Stjernebiblioteket", "vei"],
                "x_offset": 55,
                "y_offset": -25,
                "width_offset": 15,
            }],
        ...
        {
            "filename": "14(den-magiske-reisen-jente).png",
            "type": "inner",
            "side": "right",
            "blocks": [{
                "text": p(
                    ...
                    "Da forsto hun det viktigste: Kartet hadde vist veien, men magien hadde vært i henne."
                ),
                "font_size": 29,
                "color": "#FFF8EA",
                "highlights": [child_name, "magien", "henne"],
                "x_offset": 15,
                "y_offset": -40,
                "width_offset": -25,
            }],
        ...
        },
        {
            ...
            "blocks": [{
                "text": p(
                    "En kveld finner [NAVN] et gammelt kart som begynner å gløde i hendene hennes.\n"
                    ...
                    "Den finnes i motet hennes, i godheten hennes og i troen på at hun kan gå videre."
                ),
                "font_size": 43,
                "color": "#FFFFFF",
...
def process_book(base_dir: str, out_dir: str, child_name: str, cover_type: str, gelato_api_key: str):
    ...
    need = ["bakside(kartet).png", "ryggrad.png", "forside(den-magiske-reisen-jente).png"]
    ...
    front_path = cover_rendered["forside(den-magiske-reisen-jente).png"]
...
_DREAMPAGE_TRANSLATIONS = {
  "{name} sin": "{name_genitive}",
  "{name} og\nDet Magiske Kartet": "{name} och\nDen Magiska Resan",
  "Denne boken er laget spesielt for deg, {name}.\nNoen kart viser veien til steder.\nDette kartet viser veien til motet, godheten og magien inni deg.": "Den här boken är skapad särskilt för dig, {name}.\nVissa kartor visar vägen till platser.\nDen här kartan visar vägen till modet, godheten och magin inom dig.",
  "{name} hadde nesten gjort seg klar for kvelden da hun oppdaget noe merkelig.\nMellom bøkene på rommet lå et kart hun aldri hadde sett før.\nDet så gammelt og støvete ut, men da hun løftet det opp, begynte kantene å gløde svakt i gull.": "{name} hade nästan gjort sig redo för kvällen när hon upptäckte något märkligt.\nMellan böckerna på rummet låg en karta hon aldrig hade sett förut.\nDen såg gammal och dammig ut, men när hon lyfte upp den började kanterna glöda svagt i guld.",
  "Kartet ble varmt i hendene hennes.\nSmå tegn av gyllent lys steg opp fra papiret og danset rundt i rommet som hemmelige stjerner.\n{name} holdt pusten.\nDette var ikke et vanlig kart.": "Kartan blev varm i hennes händer.\nSmå tecken av gyllene ljus steg upp från papperet och dansade runt i rummet som hemliga stjärnor.\n{name} höll andan.\nDet här var ingen vanlig karta.",
  "Lyset fra kartet samlet seg ved vinduet.\nFørst var det lite som en gnist, men så vokste det til en rund, gyllen portal.\nInne i lyset skimtet {name} en skog med glødende planter og blinkende blågrønne lys.": "Ljuset från kartan samlades vid fönstret.\nFörst var det litet som en gnista, men sedan växte det till en rund, gyllene portal.\nInne i ljuset skymtade {name} en skog med glödande växter och blinkande blågröna ljus.",
  "{name} tok et forsiktig skritt nærmere.\nPortalen summet mykt, som om den ventet på henne.\nHun var spent, men kartet lyste varmt i hånden hennes.\nSå rettet hun ryggen og hvisket: Jeg tør.": "{name} tog ett försiktigt steg närmare.\nPortalen surrade mjukt, som om den väntade på henne.\nHon var förväntansfull, men kartan lyste varmt i hennes hand.\nSå sträckte hon på sig och viskade: Jag vågar.",
  "I neste øyeblikk sto {name} midt i den fortryllede skogen.\nTrærne var høyere enn hus, og blomstene glødet svakt langs stien.\nBak henne blinket portalen stille mellom greinene.\nReisen hadde virkelig begynt.": "I nästa ögonblick stod {name} mitt i den förtrollade skogen.\nTräden var högre än hus, och blommorna glödde svagt längs stigen.\nBakom henne blinkade portalen tyst mellan grenarna.\nResan hade verkligen börjat.",
  "På stien foran henne dukket en liten gyllen rev opp.\nDen hadde kloke øyne og en hale som glitret som sollys.\n\"Kartet viser veien,\" sa reven mykt.\n\"Men du må selv tørre å følge den.\"": "På stigen framför henne dök en liten gyllene räv upp.\nDen hade kloka ögon och en svans som glittrade som solljus.\n\"Kartan visar vägen\", sa räven mjukt.\n\"Men du måste själv våga följa den.\"",
  "Reven ledet {name} til et gammelt tre med et stjerneformet merke i barken.\nDa hun holdt kartet nærmere, begynte både treet og papiret å skinne.\nStjernemerket løsnet forsiktig og svevde inn i kartet.\n\"Én del av veien er funnet,\" sa reven.": "Räven ledde {name} till ett gammalt träd med ett stjärnformat märke i barken.\nNär hon höll kartan närmare började både trädet och papperet att lysa.\nStjärnmärket lossnade försiktigt och svävade in i kartan.\n\"En del av vägen är funnen\", sa räven.",
  "Da stjernemerket landet på kartet, begynte linjene å flytte på seg.\nLyset samlet seg mellom trærne, og en ny portal åpnet seg.\nPå den andre siden svevde øyer høyt over skyene, med fossefall som falt rett ned i luften.\n\"Kartet tror du er klar,\" sa reven.": "När stjärnmärket landade på kartan började linjerna flytta på sig.\nLjuset samlades mellan träden, och en ny portal öppnade sig.\nPå andra sidan svävade öar högt ovanför molnen, med vattenfall som föll rakt ner genom luften.\n\"Kartan tror att du är redo\", sa räven.",
  "På en av de flyvende øyene hørte {name} en svak lyd.\nBak glødende slyngplanter satt en liten drageunge fast med vingen sin.\nDen så redd ut, men ikke farlig.\n{name} løsnet plantene én etter én, og dragen dyttet snuten takknemlig mot hånden hennes.": "På en av de flygande öarna hörde {name} ett svagt ljud.\nBakom glödande slingerväxter satt en liten drakunge fast med sin vinge.\nDen såg rädd ut, men inte farlig.\n{name} lossade växterna en efter en, och draken puffade tacksamt nosen mot hennes hand.",
  "Drageungen ristet på vingene og pekte med snuten mot kartet.\nEt nytt stjernemerke våknet på papiret.\nBlått og gull blandet seg i luften foran dem, og en portal åpnet seg.\nInne i lyset lå en by under havet, full av koraller og små svevende måner.": "Drakungen skakade på vingarna och pekade med nosen mot kartan.\nEtt nytt stjärnmärke vaknade på papperet.\nBlått och guld blandades i luften framför dem, och en portal öppnade sig.\nInne i ljuset låg en stad under havet, full av koraller och små svävande månar.",
  "Da {name} gikk gjennom portalen, lukket en glødende luftboble seg rundt henne.\nUtenfor danset vannet stille, og hele undervannsbyen lyste.\nMidt i byen blinket et nytt stjernemerke på kartet.\nDa hun rørte ved merket, fløy lyset rett inn i papiret.": "När {name} gick genom portalen slöt sig en glödande luftbubbla runt henne.\nUtanför dansade vattnet tyst, och hela undervattensstaden lyste.\nMitt i staden blinkade ett nytt stjärnmärke på kartan.\nNär hon rörde vid märket flög ljuset rakt in i papperet.",
  "Det nye stjernemerket fikk kartet til å lyse kaldt og klart.\nEn portal åpnet seg, og {name} steg ut i en verden av is og nordlys.\nFjellene ruvet rundt henne som blå krystaller.\nDrageungen sto ved siden av henne, klar til å følge henne videre.": "Det nya stjärnmärket fick kartan att lysa kallt och klart.\nEn portal öppnade sig, och {name} steg ut i en värld av is och norrsken.\nFjällen reste sig runt henne som blå kristaller.\nDrakungen stod bredvid henne, redo att följa henne vidare.",
  "Da det siste lyset fra nordlyset traff kartet, åpnet det seg en dør av stjerner.\nBak den lå Stjernebiblioteket, større og vakrere enn noe {name} hadde sett før.\nBøker svevde mellom hyllene, og i midten sto en himmelglobus full av gyllent lys.\nAlle stjernemerkene samlet seg til én strålende vei.": "När det sista ljuset från norrskenet träffade kartan öppnades en dörr av stjärnor.\nBakom den låg Stjärnbiblioteket, större och vackrare än något {name} någonsin hade sett.\nBöcker svävade mellan hyllorna, och i mitten stod en himmelsglob fylld av gyllene ljus.\nAlla stjärnmärken samlades till en enda strålande väg.",
  "Et øyeblikk senere sto {name} tilbake på rommet sitt.\nAlt så nesten vanlig ut igjen: sengen, bøkene og teleskopet ved vinduet.\nMen kartet glødet fortsatt mykt, fullt av stjernemerker fra reisen.\nDa forsto hun det viktigste: Kartet hadde vist veien, men magien hadde vært i henne.": "Ett ögonblick senare stod {name} tillbaka i sitt rum.\nAllt såg nästan vanligt ut igen: sängen, böckerna och teleskopet vid fönstret.\nMen kartan glödde fortfarande mjukt, full av stjärnmärken från resan.\nDå förstod hon det viktigaste: Kartan hade visat vägen, men magin hade funnits inom henne.",
  "En kveld finner {name} et gammelt kart som begynner å gløde i hendene hennes.\nKartet åpner portaler til fortryllede skoger, flyvende øyer, en undervannsby, en isverden og et bibliotek av stjerner.\nPå reisen hjelper {name} nye venner, samler stjernemerker og oppdager at ekte magi ikke bare finnes på kartet.\nDen finnes i motet hennes, i godheten hennes og i troen på at hun kan gå videre.": "En kväll hittar {name} en gammal karta som börjar glöda i hennes händer.\nKartan öppnar portaler till förtrollade skogar, flygande öar, en stad under havet, en isvärld och ett bibliotek av stjärnor.\nPå resan hjälper {name} nya vänner, samlar stjärnmärken och upptäcker att riktig magi inte bara finns på kartan.\nDen finns i hennes mod, i hennes godhet och i tron på att hon kan fortsätta framåt."
}
