...
DREAMPAGE_FIRST_TAGLINE = "Trykket med omtanke\nfor kvalitet"
    ...
    story: List[Dict[str, Any]] = [
        {
            ...
            "side": "left",
            "block": story_block(
                "En helt vanlig ettermiddag gikk (navn) i skogen.\n"
                "Midt i den myke jorden lå noe merkelig.\n"
                "Små hovspor, tett etter hverandre.\n"
                "Og hvert eneste spor glitret svakt som sølv."
                ,
                child_name,
                ["hovspor", "glitret", "sølv", "merkelig"],
                side="left",
            ),
        },
        {
            ...
            "side": "right",
            "block": story_block(
                "(navn) fulgte sporene dypere inn i skogen.\n"
                "Små lys svevde mellom trærne, og ukjente blomster åpnet seg.\n"
                "Til slutt stoppet hovsporene foran en høy foss.\n"
                "Bak vannet lyste noe svakt og gyllent."
                ,
                child_name,
                ["sporene", "lys", "blomster", "foss", "gyllent"],
                side="right",
            ),
        },
        # Side 3 - venstre kvadrat (statisk handbilde, baerer teksten)
        {
            ...
            "block": story_block(
                "(navn) strakte hånden forsiktig inn i fossen.\n"
                "Vannet var lunkent, og det glitret rundt fingrene.\n"
                "Bak fossen lå en smal tunnel i fjellet.\n"
                "(navn) gikk gjennom, og hele dalen åpnet seg."
                ,
                child_name,
                ["hånden", "fossen", "glitret", "tunnel", "dalen"],
                side="left",
            ),
        },
        ...
        },
        {
            ...
            "side": "right",
            "block": story_block(
                "En liten enhjørning kom løpende mellom blomstene.\n"
                "Den stoppet rett foran (navn) og så på henne.\n"
                "Men hornet lyste bare svakt.\n"
                "Så ristet bakken, og et dypt drønn kom fra fjellene."
                ,
                child_name,
                ["enhjørning", "hornet", "svakt", "drønn"],
                side="right",
            ),
        },
        {
            ...
            "side": "left",
            "block": story_block(
                "Enhjørningen løp mot en stor, klar innsjø.\n"
                "Over vannet svevde tre lysende stjernesteiner.\n"
                "En blå, en grønn og en lilla.\n"
                "Men plassen der den fjerde skulle vært, var mørk."
                ,
                child_name,
                ["innsjø", "stjernesteiner", "blå", "grønn", "lilla", "mørk"],
                side="left",
            ),
        },
        {
            ...
            "side": "right",
            "block": story_block(
                "Den eldste enhjørningen kom fram til vannkanten.\n"
                "Hornet skinte, og et bilde dukket opp i innsjøen.\n"
                "(navn) så en mørk skikkelse snike seg mellom trærne.\n"
                "Den fjerde stjernesteinen var stjålet."
                ,
                child_name,
                ["eldste", "hornet", "bilde", "skikkelse", "stjålet"],
                side="right",
            ),
        },
        {
            ...
            "side": "left",
            "block": story_block(
                "Uten steinen ville magien i dalen forsvinne.\n"
                "Den lille enhjørningen stampet bestemt i bakken.\n"
                "Sammen fulgte de et spor av svarte, glitrende merker.\n"
                "Sporet førte dem langt bort fra innsjøen."
                ,
                child_name,
                ["magien", "bestemt", "spor", "merker"],
                side="left",
            ),
        },
        {
            ...
            "side": "right",
            "block": story_block(
                "Stien førte dem inn i Krystallskogen.\n"
                "Enorme gjennomsiktige trær kastet regnbuer over bakken.\n"
                "Plutselig begynte grenene å bevege seg.\n"
                "Stien bak dem forsvant, og de var fanget."
                ,
                child_name,
                ["Krystallskogen", "regnbuer", "grenene", "fanget"],
                side="right",
            ),
        },
        {
            ...
            "side": "left",
            "block": story_block(
                "(navn) fant de mørke sporene igjen på bakken.\n"
                "De fulgte dem helt ut på den andre siden.\n"
                "Foran dem lå en dyp kløft.\n"
                "På kanten sto et lite hus som lyste i mørket."
                ,
                child_name,
                ["sporene", "kløft", "lite hus", "lyste"],
                side="left",
            ),
        },
        {
            ...
            "side": "right",
            "block": story_block(
                "En gammel steinbro strakte seg over kløften.\n"
                "De gikk forsiktig ut på de gamle steinene.\n"
                "Midt på broen kom et nytt drønn, og steinene sprakk.\n"
                "(navn) klarte akkurat å komme seg over."
                ,
                child_name,
                ["steinbro", "kløften", "drønn", "sprakk"],
                side="right",
            ),
        },
        {
            ...
            "side": "left",
            "block": story_block(
                "Inne i huset lå stjernesteinen på en søyle.\n"
                "(navn) løftet den forsiktig opp.\n"
                "Med ett lyste hele rommet.\n"
                "På veggen kom et stort symbol til syne: en svart halvmåne."
                ,
                child_name,
        ...
        },
        {
            ...
            "side": "right",
            "block": story_block(
                "De skyndte seg tilbake til innsjøen.\n"
                "Da steinen kom på plass, skjøt fire lysstråler mot himmelen.\n"
                "Magien strømmet tilbake gjennom hele dalen.\n"
                "Blomstene våknet, og elvene glitret igjen."
                ,
                child_name,
                ["lysstråler", "Magien", "våknet", "glitret"],
                side="right",
            ),
        },
        {
            ...
            "side": "left",
            "block": story_block(
                "Hele flokken samlet seg rundt (navn).\n"
                "Den eldste enhjørningen bøyde hodet mot henne.\n"
                "Et lite sølvmerke begynte å gløde på hånden hennes.\n"
                "(navn) var blitt en venn av Enhjørningsdalen."
                ,
                child_name,
                ["flokken", "eldste", "sølvmerke", "venn"],
                side="left",
            ),
        },
        {
            ...
            "side": "right",
            "block": story_block(
                "Om kvelden var (navn) hjemme igjen.\n"
                "Men utenfor huset lå et svart, glitrende spor.\n"
                "Ved siden av lå en stein med en svart halvmåne.\n"
                "Og langt borte lyste noe lilla mellom fjellene."
                ,
                child_name,
                ["hjemme", "spor", "halvmåne", "lilla"],
                side="right",
            ),
        },
    ]
        ...
        [
            ...
            },
            {
                ...
                "blocks": [
                    {
                        "text": pformat(
                            "Da (navn) fant glitrende hovspor i skogen, førte de til en dal ingen kjente til.\n"
                            "I Enhjørningsdalen er en av de fire stjernesteinene stjålet, og magien holder på å slokne.\n"
                            "Sammen med en liten enhjørning følger (navn) et mørkt spor gjennom Krystallskogen, over en sprukken steinbro og inn i et lite hus i fjellet.\n"
                            "En personlig fortelling om mot, vennskap og om å tørre å følge sporet man ser.\n"
                            "Noen eventyr er ekte likevel.",
                            child_name,
                        ),
                        "font_size": 82,
                        "color": "#FFFFFF",
