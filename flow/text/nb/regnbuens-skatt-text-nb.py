...
# Lastpage(regnbuens-skatt).png ligger etter blank-back, så total innersider = 31.
...
def build_pages(child_name: str) -> List[Dict[str, Any]]:
    ...
    def block(text: str, highlights: List[str], side: str, y_offset: int = -45) -> Dict[str, Any]:
        return {
            "text": p(text),
            "font_size": 42,
            "color": "#FFFFFF",
            "highlights": highlights,
            "x_offset": 60 if side == "left" else 20,
            "y_offset": y_offset,
            "paragraph_gap": 0.4,
            "line_height": 1.35,
            "width_offset": 0 if side == "left" else -40,
        }

    pages: List[Dict[str, Any]] = [
        {
            "filename": "forside(regnbuens-skatt).png",
            "type": "cover",
            "text": p("[NAVN] og\nRegnbuens Skatt"),
        },
        {
        ...
        {
            "filename": "01(regnbuens-skatt).png",
            "type": "inner",
            "side": "left",
            "blocks": [block(
                "Regnet hadde stoppet.\n"
                "(Navn) gikk ut i blomsterengen og så en svak regnbue.\n"
                "Den hadde nesten mistet alle fargene sine.",
                ["regnbue", "fargene"],
                "left",
                0,
            )],
        ...
        {
            "filename": "02(regnbuens-skatt).png",
            "type": "inner",
            "side": "right",
            "blocks": [block(
                "(Navn) gikk nærmere.\n"
                "Små glitrende lys viste en sti gjennom engen.\n"
                "«Jeg skal finne fargene,» sa (Navn).",
                ["glitrende", "fargene"],
                "right",
            )],
        },
        {
            "filename": "03(regnbuens-skatt).png",
            "type": "inner",
            "side": "left",
            "blocks": [block(
                "Ved stien lå et stort, rødt jordbær.\n"
                "Da (Navn) rørte ved det, fløy et rødt lys opp.\n"
                "Den første stripen fikk farge.",
                ["rødt", "farge"],
                "left",
            )],
        },
        {
            "filename": "04(regnbuens-skatt).png",
            "type": "inner",
            "side": "right",
            "blocks": [block(
                "En oransje sommerfugl danset rundt (Navn).\n"
                "Den landet forsiktig på hånden.\n"
                "Så svevde et oransje lys opp til regnbuen.",
                ["oransje", "regnbuen"],
                "right",
            )],
        },
        {
            "filename": "05(regnbuens-skatt).png",
            "type": "inner",
            "side": "left",
            "blocks": [block(
                "(Navn) kom til store, gule solsikker.\n"
                "Én solsikke glitret ekstra sterkt.\n"
                "Den gule fargen fløy opp til himmelen.",
                ["gule", "himmelen"],
                "left",
            )],
        },
        {
            "filename": "06(regnbuens-skatt).png",
            "type": "inner",
            "side": "right",
            "blocks": [block(
                "I gresset hoppet en liten, grønn frosk frem.\n"
                "Hopp, hopp, hopp!\n"
                "Et grønt lys spratt opp til regnbuen.",
                ["grønn", "Hopp"],
                "right",
            )],
        },
        {
            "filename": "07(regnbuens-skatt).png",
            "type": "inner",
            "side": "left",
            "blocks": [block(
                "Stien førte til en klar, blå dam.\n"
                "Vannet glitret stille.\n"
                "En blå lysdråpe steg opp mot regnbuen.",
                ["blå", "regnbuen"],
                "left",
            )],
        },
        {
            "filename": "08(regnbuens-skatt).png",
            "type": "inner",
            "side": "right",
            "blocks": [block(
                "På den andre siden vokste lilla blomster.\n"
                "(Navn) plukket én myk blomst.\n"
                "Den lilla fargen fløy opp til regnbuen.",
                ["lilla", "regnbuen"],
                "right",
                40,
            )],
        ...
        {
            "filename": "09(regnbuens-skatt).png",
            "type": "inner",
            "side": "left",
            "blocks": [block(
                "Alle fargene danset i luften.\n"
                "De snurret rundt (Navn) som små stjerner.\n"
                "Så fløy de høyt opp på himmelen.",
                ["fargene", "stjerner"],
                "left",
                40,
            )],
        ...
        {
            "filename": "10(regnbuens-skatt).png",
            "type": "inner",
            "side": "right",
            "blocks": [block(
                "Regnbuen ble stor og klar.\n"
                "Rød, oransje, gul, grønn, blå og lilla lyste over dalen.\n"
                "(Navn) ble så glad.",
                ["Regnbuen", "glad"],
                "right",
            )],
        ...
        {
            "filename": "11(regnbuens-skatt).png",
            "type": "inner",
            "side": "left",
            "blocks": [block(
                "Da begynte enden av regnbuen å gløde.\n"
                "En gyllen sti viste seg i blomsterengen.\n"
                "Den blinket: kom denne veien!",
                ["gyllen", "veien"],
                "left",
            )],
        },
        {
            "filename": "12(regnbuens-skatt).png",
            "type": "inner",
            "side": "right",
            "blocks": [block(
                "(Navn) fulgte den gylne stien over en liten bakke.\n"
                "Bak bakken skinte noe stort.\n"
                "Hva kunne det være?",
                ["gylne", "skinte"],
                "right",
                40,
        ...
        {
            "filename": "13(regnbuens-skatt).png",
            "type": "inner",
            "side": "left",
            "blocks": [block(
                "Ved regnbuens ende sto en svart gryte.\n"
                "Den var full av glødende gullmynter.\n"
                "(Navn) hadde funnet regnbuens skatt!",
                ["gullmynter", "skatt"],
                "left",
            )],
        },
        {
            "filename": "14(regnbuens-skatt).png",
            "type": "inner",
            "side": "right",
            "blocks": [block(
                "(Navn) satt stolt ved skatten.\n"
                "Bak lyste regnbuen med alle fargene sine.\n"
                "Hele dalen glitret.",
                ["stolt", "glitret"],
                "right",
                40,
        ...
        {
            "filename": "bakside(regnbuens-skatt).png",
            "type": "cover",
            "side": "left",
            "blocks": [{
                "text": p(
                    "Denne boken handler om farger, nysgjerrighet og små steg.\n"
                    "(Navn) hjelper en blek regnbue med å finne tilbake de sterke fargene sine.\n"
                    "Langs stien venter jordbær, sommerfugl, solsikker, frosk, dam og lilla blomster.\n"
                    "Til slutt lyser regnbuen igjen, og (Navn) finner den glitrende skatten ved regnbuens ende.\n"
                    "En enkel og fargerik historie om å hjelpe, oppdage og glede seg over verden."
                ),
                "font_size": 44,
                "color": "#FFFFFF",
                "highlights": ["farger", "regnbue", "(Navn)", "skatten", "hjelpe", "glede"],
            }],
        },
    ]
...
RYGGRAD_BOOK_SLUG = "regnbuens-skatt"
...
def render_dreampage_first(child_name: str, out_dir: str) -> str:
    ...
    """
    src = os.path.join(SCRIPT_DIR, "dreampage-first.png")
...
def process_book(base_dir: str, out_dir: str, child_name: str, cover_type: str, gelato_api_key: str):
    ...
    # Legg til dreampage-first.png først, blank-back.png deretter, og per-bok Lastpage(regnbuens-skatt).png aller sist.
    # Disse er enkelt-sider (4096x4096) som ikke skal splittes - bare inkluderes direkte.
    dreampage_first = os.path.join(SCRIPT_DIR, "dreampage-first.png")
    ...
    last_page = resolve_lastpage_path("Lastpage(regnbuens-skatt).png")
    ...
    if last_page:
        ...
        print(f"ADVARSEL: Fant ikke Lastpage(regnbuens-skatt).png i {LASTPAGE_DIR} - hopper over")
    ...
    need = ["bakside(regnbuens-skatt).png", "ryggrad.png", "forside(regnbuens-skatt).png"]
    ...
    back_path  = cover_rendered["bakside(regnbuens-skatt).png"]
    spine_path = cover_rendered["ryggrad.png"]
    front_path = cover_rendered["forside(regnbuens-skatt).png"]
