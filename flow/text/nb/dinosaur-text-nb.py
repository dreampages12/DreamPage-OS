...
def build_pages(child_name: str) -> List[Dict[str, Any]]:
    ...
    pages: List[Dict[str, Any]] = [
        ...
        # EKSTRA BLANK SISTE INNERSIDE (siste synlige innerside)
        {
        ...
        # Lastpage er fjernet — den hadde ingen plass i et 30-siders produkt og
        # endte før som en usynlig endpaper. build_gelato_pdf.py legger nå til
        # ekte blanke endpapers i stedet.
