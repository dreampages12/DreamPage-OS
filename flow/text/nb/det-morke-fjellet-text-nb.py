...
BOOK_DREAMPAGE_FIRST = os.path.join(
    DP_ROOT, "books", "det-morke-fjellet", "dreampage-first-fjellet.png"
)
...
def resolve_front_cover_logo():
    ...
    """
    name = {
        "nb": "fjellet-logo-nb.png",
        "nn": "fjellet-logo-nb.png",
        "en-US": "fjellet-logo-en.png",
        "en-GB": "fjellet-logo-en.png",
        "sv": "fjellet-logo-sv.png",
    }.get(SCRIPT_LOCALE, "fjellet-logo-nb.png")
...
def build_pages(child_name: str) -> List[Dict[str, Any]]:
    ...
    pages: List[Dict[str, Any]] = [
        ...
        # Side 1 - barnet staar til hoeyre, teksten paa den tomme venstre halvdelen
        {
            "filename": "01(fjellet).png",
            "type": "inner",
            "side": "left",
            "blocks": [{
                "text": p(
                    "Hjemme hos (Navn) lå den lille krystallbiten fra Den skjulte verden på bordet.\n"
                    "Plutselig begynte den å lyse.\n"
                    "(Navn) tok den opp og kjente at den ble varm i hånden.\n"
                    "Noe prøvde å fortelle ham noe."
                ),
                "font_size": 30,
                "color": "#FFFFFF",
                "highlights": [child_name, "krystallbiten", "lyse", "varm"],
            }],
        },

        # Side 2 - barnet staar til venstre, teksten paa den tomme hoeyre halvdelen
        {
            "filename": "02(fjellet).png",
            "type": "inner",
            "side": "right",
            "blocks": [{
                "text": p(
                    "Lyset fra krystallen pekte mot skogen.\n"
                    "(Navn) visste med en gang hvor han måtte gå.\n"
                    "Han fulgte stien mellom trærne mens krystallen lyste sterkere og sterkere.\n"
                    "Den skjulte verden kalte på ham igjen."
                ),
                "font_size": 30,
                "color": "#FFFFFF",
                "highlights": [child_name, "skogen", "stien", "kalte"],
            }],
        },

        # Side 3 - barnet staar til hoeyre, teksten paa den tomme venstre halvdelen
        {
            "filename": "03(fjellet).png",
            "type": "inner",
            "side": "left",
            "blocks": [{
                "text": p(
                    "Til slutt sto (Navn) foran fossen.\n"
                    "Denne gangen lyste vannet mye sterkere enn før.\n"
                    "Krystallen i hånden hans glødet i samme farge.\n"
                    "Han hadde funnet veien tilbake."
                ),
                "font_size": 30,
                "color": "#FFFFFF",
                "highlights": [child_name, "fossen", "glødet", "tilbake"],
            }],
        },

        # Side 4 - barnet staar til venstre, teksten paa den tomme hoeyre halvdelen
        {
            "filename": "04(fjellet).png",
            "type": "inner",
            "side": "right",
            "blocks": [{
                "text": p(
                    "(Navn) gikk gjennom fossen.\n"
                    "På den andre siden lå Den skjulte verden akkurat slik han husket den.\n"
                    "Svevende øyer, store fjell og glødende elver strakte seg foran ham.\n"
                    "Men noe føltes annerledes."
                ),
                "font_size": 30,
                "color": "#FFFFFF",
                "highlights": [child_name, "fossen", "øyer", "annerledes"],
            }],
        },

        # Side 5 - barnet staar til hoeyre, teksten paa den tomme venstre halvdelen
        {
            "filename": "05(fjellet).png",
            "type": "inner",
            "side": "left",
            "blocks": [{
                "text": p(
                    "Plutselig hørte (Navn) raske skritt.\n"
                    "Den unge blågrønne dragen kom løpende mot ham.\n"
                    "(Navn) ble glad da han så den igjen.\n"
                    "Dragen hadde tydelig ventet på ham."
                ),
                "font_size": 30,
                "color": "#FFFFFF",
                "highlights": [child_name, "skritt", "dragen", "ventet"],
            }],
        },

        # Side 6 - barnet staar til venstre, teksten paa den tomme hoeyre halvdelen
        {
            "filename": "06(fjellet).png",
            "type": "inner",
            "side": "right",
            "blocks": [{
                "text": p(
                    "Men dragen virket urolig og snudde seg mot horisonten.\n"
                    "Langt borte lå et stort, mørkt fjell.\n"
                    "På toppen lyste et svakt rødt lys.\n"
                    "(Navn) kjente igjen fjellet. Noe hadde våknet der."
                ),
                "font_size": 30,
                "color": "#FFFFFF",
                "highlights": [child_name, "urolig", "fjell", "våknet"],
            }],
        },

        # Side 7 - barnet staar til hoeyre, teksten paa den tomme venstre halvdelen
        {
            "filename": "07(fjellet).png",
            "type": "inner",
            "side": "left",
            "blocks": [{
                "text": p(
                    "Dragen begynte å gå, og (Navn) fulgte etter.\n"
                    "De beveget seg gjennom nye deler av Den skjulte verden.\n"
                    "Forbi gamle ruiner og høye klipper gikk de.\n"
                    "Jo nærmere de kom fjellet, desto mørkere ble himmelen."
                ),
                "font_size": 30,
                "color": "#FFFFFF",
                "highlights": [child_name, "Dragen", "ruiner", "mørkere"],
            }],
        },

        # Side 8 - barnet staar til venstre, teksten paa den tomme hoeyre halvdelen
        {
            "filename": "08(fjellet).png",
            "type": "inner",
            "side": "right",
            "blocks": [{
                "text": p(
                    "Foran dem lå et enormt juv.\n"
                    "Den gamle broen over var nesten ødelagt.\n"
                    "(Navn) tok ett forsiktig skritt av gangen mens dragen holdt seg tett inntil ham.\n"
                    "Til slutt kom de trygt over."
                ),
                "font_size": 30,
                "color": "#FFFFFF",
                "highlights": [child_name, "juv", "broen", "trygt"],
            }],
        },

        # Side 9 - barnet staar til hoeyre, teksten paa den tomme venstre halvdelen
        {
            "filename": "09(fjellet).png",
            "type": "inner",
            "side": "left",
            "blocks": [{
                "text": p(
                    "På den andre siden fant de et gammelt steinkammer.\n"
                    "Midt på veggen var det et stort kart over Den skjulte verden.\n"
                    "(Navn) så på kartet og oppdaget noe merkelig.\n"
                    "Det mørke fjellet var markert med et stort, gammelt symbol."
                ),
                "font_size": 30,
                "color": "#FFFFFF",
                "highlights": [child_name, "steinkammer", "kart", "symbol"],
            }],
        },

        # Side 10 - barnet staar til venstre, teksten paa den tomme hoeyre halvdelen
        {
            "filename": "10(fjellet).png",
            "type": "inner",
            "side": "right",
            "blocks": [{
                "text": p(
                    "Plutselig begynte mørk tåke å bevege seg mellom ruinene.\n"
                    "Skygger gled frem mellom steinene.\n"
                    "Dragen stilte seg tett inntil (Navn).\n"
                    "Krystallen i hånden hans begynte å lyse sterkere."
                ),
                "font_size": 30,
                "color": "#FFFFFF",
                "highlights": [child_name, "tåke", "Skygger", "Krystallen"],
            }],
        },

        # Side 11 - barnet staar til hoeyre, teksten paa den tomme venstre halvdelen
        {
            "filename": "11(fjellet).png",
            "type": "inner",
            "side": "left",
            "blocks": [{
                "text": p(
                    "(Navn) løftet krystallen.\n"
                    "Et kraftig blågyllent lys fylte området, og de mørke skyggene trakk seg unna.\n"
                    "Dragen så på (Navn).\n"
                    "Nå visste de at krystallen kunne beskytte dem."
                ),
                "font_size": 30,
                "color": "#FFFFFF",
                "highlights": [child_name, "krystallen", "skyggene", "beskytte"],
            }],
        },

        # Side 12 - barnet staar til venstre, teksten paa den tomme hoeyre halvdelen
        {
            "filename": "12(fjellet).png",
            "type": "inner",
            "side": "right",
            "blocks": [{
                "text": p(
                    "Til slutt nådde de foten av det mørke fjellet.\n"
                    "Der fant de en enorm steinport.\n"
                    "Den var så stor at (Navn) følte seg bitte liten foran den.\n"
                    "Bak porten kunne han høre en dyp lyd. Noe var der inne."
                ),
                "font_size": 30,
                "color": "#FFFFFF",
                "highlights": [child_name, "fjellet", "steinport", "lyd"],
            }],
        },

        # Side 13 - barnet staar til hoeyre, teksten paa den tomme venstre halvdelen
        {
            "filename": "13(fjellet).png",
            "type": "inner",
            "side": "left",
            "blocks": [{
                "text": p(
                    "Plutselig begynte bakken å riste.\n"
                    "Den enorme porten beveget seg sakte.\n"
                    "Stein skrapte mot stein mens en mørk åpning kom til syne.\n"
                    "Langt inne i fjellet kunne (Navn) se to store lysende øyne."
                ),
                "font_size": 30,
                "color": "#FFFFFF",
                "highlights": [child_name, "riste", "porten", "øyne"],
            }],
        },

        # Side 14 - barnet staar til venstre, teksten paa den tomme hoeyre halvdelen
        {
            "filename": "14(fjellet).png",
            "type": "inner",
            "side": "right",
            "blocks": [{
                "text": p(
                    "(Navn) og dragen sto helt stille.\n"
                    "Krystallen i hånden hans lyste sterkere enn noen gang.\n"
                    "De store øynene inne i fjellet beveget seg nærmere.\n"
                    "Men eventyret var langt fra over."
                ),
                "font_size": 30,
                "color": "#FFFFFF",
                "highlights": [child_name, "stille", "øynene", "eventyret"],
            }],
        },

        # Bakside
        {
            "filename": "bakside(fjellet).png",
            "type": "cover",
            "side": "left",
            "blocks": [{
                "text": p(
                    "Denne boken handler om å tørre å gå tilbake til det ukjente, og om å ta med seg en venn inn i mørket.\n"
                    "Når (Navn) følger krystallen gjennom fossen igjen, står dragen og venter - og sammen går de mot det mørke fjellet.\n"
                    "En spennende og varm fortelling om mot, vennskap og om å holde sammen når det blir skummelt.\n"
                    "En bok som minner barnet på at lyset man bærer med seg, er sterkere enn mørket foran seg."
                ),
                "font_size": 46,
                "color": "#FFFFFF",
                "highlights": [child_name, "mørket", "dragen", "mot", "vennskap", "barnet", "lyset"],
            }],
        },
    ]
...
RYGGRAD_BOOK_SLUG = "det-morke-fjellet"
...
def render_dreampage_first(child_name: str, out_dir: str) -> str:
    ...
    body_lines = [
        ...
        f"Du er {child_name} — den modige i denne historien.",
        "",
        "Det er dine drømmer, ditt mot",
        "og dine mål som fyller disse sidene.",
        "",
...
def process_book(base_dir: str, out_dir: str, child_name: str, cover_type: str, gelato_api_key: str):
    ...
    # Denne boka har ingen egen Lastpage. Sidetallet (30) er regnet uten
    # den. Legges en til senere, maa expectedInnerPages opp til 31.
    ...
    need = ["bakside(fjellet).png", "ryggrad.png", "forside(fjellet).png"]
    ...
    back_path  = cover_rendered["bakside(fjellet).png"]
    spine_path = cover_rendered["ryggrad.png"]
    front_path = cover_rendered["forside(fjellet).png"]
...
def _dp_widen_narrow_blocks(page: dict) -> None:
    ...
    """
    if page.get("type") != "inner" or page.get("square"):
        return
    side = page.get("side", "right")
