...
BOOK_DREAMPAGE_FIRST = os.path.join(
    DP_ROOT, "books", "den-tapte-superbyen", "dreampage-first-superbyen.png"
)
...
def resolve_front_cover_logo():
    ...
    """
    name = {
        "nb": "superbyen-logo-nb.png",
        "nn": "superbyen-logo-nb.png",
        "en-US": "superbyen-logo-en.png",
        "en-GB": "superbyen-logo-en.png",
        "sv": "superbyen-logo-sv.png",
    }.get(SCRIPT_LOCALE, "superbyen-logo-nb.png")
...
def build_pages(child_name: str) -> List[Dict[str, Any]]:
    ...
    pages: List[Dict[str, Any]] = [
        {
            "filename": "forside(superbyen).png",
            "type": "cover",
            "text": p("(Navn) og\nDen Tapte Superbyen"),
        },
        {
        ...
        # Side 1 - barnet staar til venstre, teksten paa den tomme hoeyre halvdelen
        {
            "filename": "01(superbyen).png",
            "type": "inner",
            "side": "right",
            "blocks": [{
                "text": p(
                    "Det hadde gått noen dager siden (Navn) reddet byen.\n"
                    "Nå trente han på kreftene sine når ingen så ham.\n"
                    "Men denne kvelden begynte symbolet på drakten hans plutselig å lyse."
                ),
                "font_size": 30,
                "color": "#FFFFFF",
                "highlights": [child_name, "reddet", "kreftene", "symbolet", "lyse"],
            }],
        },

        # Side 2 - barnet staar til hoeyre, teksten paa den tomme venstre halvdelen
        {
            "filename": "02(superbyen).png",
            "type": "inner",
            "side": "left",
            "blocks": [{
                "text": p(
                    "Et blåhvitt lys pekte mot fjellene utenfor byen.\n"
                    "Det føltes nesten som om noen kalte på ham.\n"
                    "(Navn) måtte finne ut hvem."
                ),
                "font_size": 30,
                "color": "#FFFFFF",
                "highlights": [child_name, "blåhvitt", "fjellene", "kalte", "hvem"],
            }],
        },

        # Side 3 - barnet staar til venstre, teksten paa den tomme hoeyre halvdelen
        {
            "filename": "03(superbyen).png",
            "type": "inner",
            "side": "right",
            "blocks": [{
                "text": p(
                    "Signalet stoppet foran en massiv fjellvegg.\n"
                    "Da (Navn) la hånden mot steinen, begynte bakken å riste.\n"
                    "En enorm skjult port åpnet seg."
                ),
                "font_size": 30,
                "color": "#FFFFFF",
                "highlights": [child_name, "Signalet", "fjellvegg", "riste", "port"],
            }],
        },

        # Side 4 - barnet staar til hoeyre, teksten paa den tomme venstre halvdelen
        {
            "filename": "04(superbyen).png",
            "type": "inner",
            "side": "left",
            "blocks": [{
                "text": p(
                    "Bak porten strakte en bro seg gjennom skyene.\n"
                    "Da skyene delte seg, mistet (Navn) nesten pusten.\n"
                    "Foran ham lå en hel by høyt over verden."
                ),
                "font_size": 30,
                "color": "#FFFFFF",
                "highlights": [child_name, "bro", "skyene", "pusten", "by"],
            }],
        },

        # Side 5 - barnet staar til venstre, teksten paa den tomme hoeyre halvdelen
        {
            "filename": "05(superbyen).png",
            "type": "inner",
            "side": "right",
            "blocks": [{
                "text": p(
                    "Superbyen var utrolig.\n"
                    "Men den var også helt tom.\n"
                    "På en stor plass fant (Navn) statuer av gamle helter - og én av dem bar det samme symbolet som ham."
                ),
                "font_size": 30,
                "color": "#FFFFFF",
                "highlights": [child_name, "Superbyen", "tom", "statuer", "symbolet"],
            }],
        },

        # Side 6 - barnet staar til hoeyre, teksten paa den tomme venstre halvdelen
        {
            "filename": "06(superbyen).png",
            "type": "inner",
            "side": "left",
            "blocks": [{
                "text": p(
                    "Plutselig blinket hele byen rødt.\n"
                    "«INNTRENGER OPPDAGET!»\n"
                    "Sikkerhetsdroner fløy ut fra veggene, og (Navn) satte av gårde."
                ),
                "font_size": 30,
                "color": "#FFFFFF",
                "highlights": [child_name, "rødt", "INNTRENGER", "Sikkerhetsdroner"],
            }],
        },

        # Side 7 - barnet staar til venstre, teksten paa den tomme hoeyre halvdelen
        {
            "filename": "07(superbyen).png",
            "type": "inner",
            "side": "right",
            "blocks": [{
                "text": p(
                    "(Navn) sprang over broer og hoppet mellom plattformene.\n"
                    "Et energinett suste forbi ham.\n"
                    "Han veltet en metallplate bak seg og stoppet dronene akkurat i tide."
                ),
                "font_size": 30,
                "color": "#FFFFFF",
                "highlights": [child_name, "sprang", "energinett", "metallplate", "dronene"],
            }],
        },

        # Side 8 - barnet staar til hoeyre, teksten paa den tomme venstre halvdelen
        {
            "filename": "08(superbyen).png",
            "type": "inner",
            "side": "left",
            "blocks": [{
                "text": p(
                    "(Navn) gjemte seg i et mørkt rom.\n"
                    "Der fant han en liten robot på gulvet.\n"
                    "To blå øyne lyste opp.\n"
                    "«Endelig! En ny beskytter!»"
                ),
                "font_size": 30,
                "color": "#FFFFFF",
                "highlights": [child_name, "mørkt", "robot", "øyne", "beskytter"],
            }],
        },

        # Side 9 - barnet staar til venstre, teksten paa den tomme hoeyre halvdelen
        {
            "filename": "09(superbyen).png",
            "type": "inner",
            "side": "right",
            "blocks": [{
                "text": p(
                    "Roboten het Kiro.\n"
                    "Han viste (Navn) Heltekjernen - energien som holdt Superbyen i luften.\n"
                    "Men lyset var i ferd med å slukne."
                ),
                "font_size": 30,
                "color": "#FFFFFF",
                "highlights": [child_name, "Kiro", "Heltekjernen", "Superbyen", "slukne"],
            }],
        },

        # Side 10 - barnet staar til hoeyre, teksten paa den tomme venstre halvdelen
        {
            "filename": "10(superbyen).png",
            "type": "inner",
            "side": "left",
            "blocks": [{
                "text": p(
                    "Veien til kjernen gikk gjennom en gammel treningshall.\n"
                    "Plutselig forsvant tyngdekraften.\n"
                    "(Navn) svevde mellom plattformene og brukte kreftene sine på en helt ny måte."
                ),
                "font_size": 30,
                "color": "#FFFFFF",
                "highlights": [child_name, "treningshall", "tyngdekraften", "svevde", "kreftene"],
            }],
        },

        # Side 11 - barnet staar til venstre, teksten paa den tomme hoeyre halvdelen
        {
            "filename": "11(superbyen).png",
            "type": "inner",
            "side": "right",
            "blocks": [{
                "text": p(
                    "Foran Heltekjernen ventet en enorm vokterrobot.\n"
                    "(Navn) oppdaget symbolet på brystet dens og la hånden mot det.\n"
                    "Robotens røde øyne ble blå."
                ),
                "font_size": 30,
                "color": "#FFFFFF",
                "highlights": [child_name, "Heltekjernen", "vokterrobot", "symbolet", "blå"],
            }],
        },

        # Side 12 - barnet staar til hoeyre, teksten paa den tomme venstre halvdelen
        {
            "filename": "12(superbyen).png",
            "type": "inner",
            "side": "left",
            "blocks": [{
                "text": p(
                    "(Navn) la hendene mot Heltekjernen.\n"
                    "Et kraftig blått lys fylte rommet.\n"
                    "Én etter én våknet Superbyens tårn, veier og maskiner til liv igjen."
                ),
                "font_size": 30,
                "color": "#FFFFFF",
                "highlights": [child_name, "Heltekjernen", "lys", "våknet", "Superbyens"],
            }],
        },

        # Side 13 - barnet staar til venstre, teksten paa den tomme hoeyre halvdelen
        {
            "filename": "13(superbyen).png",
            "type": "inner",
            "side": "right",
            "blocks": [{
                "text": p(
                    "Et hologram av en gammel superhelt dukket opp.\n"
                    "«Kraften du bærer begynte her. Grunnen til at den valgte deg, er—»\n"
                    "Så forsvant meldingen."
                ),
                "font_size": 30,
                "color": "#FFFFFF",
                "highlights": [child_name, "hologram", "superhelt", "Kraften", "forsvant"],
            }],
        },

        # Side 14 - barnet staar til hoeyre, teksten paa den tomme venstre halvdelen
        {
            "filename": "14(superbyen).png",
            "type": "inner",
            "side": "left",
            "blocks": [{
                "text": p(
                    "(Navn) så utover den gjenopplivede Superbyen.\n"
                    "Nå hadde han en ny venn, en hemmelig base - og mange spørsmål igjen.\n"
                    "Langt borte begynte et gammelt signal å blinke.\n"
                    "Eventyret var langt fra over."
                ),
                "font_size": 30,
                "color": "#FFFFFF",
                "highlights": [child_name, "Superbyen", "venn", "base", "signal", "Eventyret"],
            }],
        },

        # Bakside
        {
            "filename": "bakside(superbyen).png",
            "type": "cover",
            "side": "left",
            "blocks": [{
                "text": p(
                    "Denne boken handler om å oppdage at kreftene man har fått, kommer fra noe som er større enn en selv.\n"
                    "Når (Navn) følger lyset opp i fjellene, finner han en glemt by høyt over skyene - og en liten venn som har ventet lenge på en beskytter.\n"
                    "En spennende fortelling om mot, nysgjerrighet og om å velge å hjelpe når ingen andre kan.\n"
                    "En bok som minner barnet på at ekte styrke handler om hva man bruker den til."
                ),
                "font_size": 46,
                "color": "#FFFFFF",
                "highlights": [child_name, "kreftene", "by", "venn", "beskytter", "mot", "barnet", "styrke"],
            }],
        },
    ]
...
RYGGRAD_BOOK_SLUG = "den-tapte-superbyen"
...
def process_book(base_dir: str, out_dir: str, child_name: str, cover_type: str, gelato_api_key: str):
    ...
    need = ["bakside(superbyen).png", "ryggrad.png", "forside(superbyen).png"]
    ...
    back_path  = cover_rendered["bakside(superbyen).png"]
    spine_path = cover_rendered["ryggrad.png"]
    front_path = cover_rendered["forside(superbyen).png"]
