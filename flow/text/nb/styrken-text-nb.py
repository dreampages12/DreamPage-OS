...
def build_pages(child_name: str) -> List[Dict[str, Any]]:
    ...
    pages: List[Dict[str, Any]] = [
        ...
        # Side 1
        {
            ...
            "blocks": [{
                "text": p(
                    "Det var en helt vanlig morgen, der sola kilte i øynene og lufta luktet ny dag. (Navn) gikk den samme veien til skolen som alltid, men i dag føltes alt ekstra spennende.\n"
                    "Det kriblet i magen av forventning. For i dag skulle hele klassen på tur – noe (Navn) hadde gledet seg til i ukevis."
                ),
                "font_size": 38,
                "color": "#FFFFFF",
        ...
        # Side 2
        {
            ...
            "blocks": [{
                "text": p(
                    "Plutselig stoppet (Navn) midt i steget. En merkelig lyd kom fra et smalt smug ved siden av gata, som en svak summing med et fjernt ekko.\n"
                    "Han gikk forsiktig nærmere og kikket inn i mørket. Der, midt i lufta, glødet noe varmt og oransje. Hva i all verden kunne det være?"
                ),
                "font_size": 38,
                "color": "#FFFFFF",
        ...
        # Side 4
        {
            ...
            "blocks": [{
                "text": p(
                    ...
                    "«Jeg er ikke klar for dette,» hvisket (Navn). «Jeg er jo bare en helt vanlig gutt.» Hvorfor måtte akkurat han være den utvalgte?"
                ),
                "font_size": 30,
                "color": "#FFFFFF",
        ...
        # Side 6
        {
            ...
            "blocks": [{
                "text": p(
                    "Akkurat da kom superheltdrakten flyvende ut av det blå. Den snurret rundt (Navn) – én gang, to ganger – og vips, så hadde han den på seg.\n"
                    "Med et høyt Swoooosh fløy han mot sentrum og landet midt i gata. (Navn) hadde blitt en superhelt."
                ),
                "font_size": 30,
                "color": "#FFFFFF",
        ...
        # Side 7
        {
            ...
            "blocks": [{
                "text": p(
                    "Hjertet banket fortsatt av redsel, men nå kunne (Navn) ikke snu. Han tenkte på alle menneskene som trengte hjelp.\n"
                    "Langt der nede sendte skyggene en søyle av oransje lys mot himmelen. Det var dit han måtte."
                ),
                "font_size": 30,
                "color": "#FFFFFF",
        ...
        # Side 9
        {
            ...
            "blocks": [{
                "text": p(
                    "Mørket samlet seg foran (Navn) og vokste til en høy skygge midt i gata, som om den var laget av røyk og torden.\n"
                    "Redselen prikket i hendene, men (Navn) ble stående. Inni brystet våknet en varm styrke, og han visste at han måtte holde ut."
                ),
                "font_size": 30,
                "color": "#FFFFFF",
        ...
        # Bakside
        {
            ...
            "blocks": [{
                "text": p(
                    "Denne boken handler om mot – om å være redd og likevel våge å prøve. Den viser at helter ikke alltid er store og sterke, men vanlige barn som finner styrken i seg selv.\n"
                    "Derfor er det (Navn) som er helten. En fortelling som gir barn trygghet, selvtillit og troen på seg selv."
...
def render_dreampage_first(child_name: str, out_dir: str) -> str:
    ...
    body_lines = [
        ...
        "",
        "Inne i deg bor det en skjult styrke,",
        "varm og levende, sterkere enn du tror.",
        "",
