...
# Lastpage er fjernet: innmaten er opening + 28 story + blank-back = 30 sider.
# build_gelato_pdf.py legger til blank front- og bak-endpaper for å nå Gelatos
# 33-siders krav. De 30 innmatsidene fyller produktets 30 synlige sider.
...
def render_page(page: Dict[str, Any], base_dir: str, out_dir: str) -> List[str]:
    ...
    if page.get("filename", "").lower().startswith("bakside"):
        ...
        for block in page.get("blocks", []):
            ...
            # Baksiden er type "cover", så _dp_split_inner_story_blocks rører den
            # ikke — den la aldri på backdrop her. Teksten sto derfor rett på
            # illustrasjonen. Vi legger den på eksplisitt, i "strong" siden
