...
FRONT_COVER_LINE1_SIZE = 89 / 1024
...
_DREAMPAGE_TRANSLATIONS = {
  "{name} og\nDinosaurenes dal": "{name} and\nThe Dinosaur Valley",
  "Takk for at du kjøpte denne personlige historien!\nI denne boken følger vi {name} på et eventyr i en magisk dal. {name} lærer seg og si ifra når noe ikke er greit.\nVi håper historien bringer glede, trygghet og fantasifulle øyeblikk.": "Thank you for purchasing this personal story!\nIn this book, we follow {name} on an adventure in a magical valley. {name} learns to speak up when something is not right.\nWe hope the story brings joy, security and imaginative moments.",
  "Det var en stille og fin dag. {name} sto ute og så seg rundt.\nLuften var frisk, og naturen lå åpen foran ham.\nAlt føltes rolig og trygt.\n{name} visste det ikke ennå, men denne dagen skulle bli helt annerledes enn alle andre.": "It was a quiet and nice day. {name} stood outside and looked around.\nThe air was fresh, and nature lay open before him.\nEverything felt calm and safe.\n{name} didn't know it yet, but this day was going to be completely different from any other.",
  "{name} gikk videre innover stien. Da fikk han øye på noe uvanlig.\nMidt blant steiner og blader lå et egg som glødet svakt.\nLyset blinket i grønne og gylne farger.\n{name} satte seg forsiktig ned. Hva kunne dette være?": "{name} went further into the path. Then he noticed something unusual.\nAmidst the stones and leaves lay an egg that glowed faintly.\nThe light flashed in green and golden colors.\n{name} carefully sat down. What could this be?",
  "{name} så nærmere på egget.\nLyset ble sterkere, og bakken rundt begynte å gløde svakt.\nSteinene foran ham lyste opp i en rund form.\n{name} trakk pusten dypt.\nDet var ikke bare et egg.\nDet var noe mer.": "{name} took a closer look at the egg.\nThe light grew stronger, and the surrounding ground began to glow faintly.\nThe stones in front of him lit up in a round shape.\n{name} took a deep breath.\nIt wasn't just an egg.\nThere was something more.",
  "{name} reiste seg sakte.\nHan tok noen forsiktige steg frem.\nDen lysende sirkelen var stille, men levende.\nLuften rundt kjentes varm og myk.\n{name} løftet hånden.\nHva ville skje hvis han rørte den?": "{name} slowly stood up.\nHe took a few cautious steps forward.\nThe glowing circle was silent but alive.\nThe air around felt warm and soft.\n{name} raised his hand.\nWhat would happen if he touched it?",
  "Da {name} rørte den lysende sirkelen, skjedde det noe.\nLyset begynte å bevege seg sakte.\nSmå gnister danset rundt hånden hans.\nLuften summet lavt, som om portalen våknet.\n{name} trakk pusten dypt. Dette var begynnelsen på noe nytt.": "When the {name} touched the glowing circle, something happened.\nThe light began to move slowly.\nLittle sparks danced around his hand.\nThe air hummed softly, as if the portal was awakening.\n{name} took a deep breath. This was the beginning of something new.",
  "{name} tok et forsiktig steg frem. Foran ham lå Dinosaurdalen.\nHøye fjell og fosser strakte seg rundt ham. Store skygger beveget seg i det fjerne.\nDette var et helt nytt sted. Og eventyret hadde så vidt begynt.": "{name} took a cautious step forward. In front of him lay Dinosaur Valley.\nHigh mountains and waterfalls stretched around him. Large shadows moved in the distance.\nThis was a completely new place. And the adventure had just begun.",
  "Dinosauren kom rolig nærmere. Den var stor, men så snill ut.\n«Jeg heter Lumi,» sa den lavt. «Jeg trenger hjelp.»\n{name} nølte litt – så tok han et steg frem.": "The dinosaur slowly approached. It was big, but looked kind.\n\"My name is Lumi,\" it said softly. \"I need help.\"\n{name} hesitated a little - then took a step forward.",
  "Plutselig begynte Lumi å løpe. Han snudde seg og så på {name}.\n«Kom!» sa han vennlig. «Jeg trenger hjelpen din.»\n{name} nølte litt. Så begynte han å løpe etter.": "Suddenly Lumi started running. He turned and looked at {name}.\n\"Come!\" he said kindly. \"I need your help.\"\n{name} hesitated a bit. Then he started running after.",
  "{name} gikk ved siden av Lumi. Stien var smal og stille.\n«Hva trenger du hjelp med?» spurte {name}. Lumi ristet på hodet.\n«Jeg kan ikke si det,» sa han lavt. «Jeg må vise deg.»\nDe gikk videre sammen.": "{name} walked next to Lumi. The path was narrow and quiet.\n\"What do you need help with?\" {name} asked. Lumi shook his head.\n\"I can't say,\" it said softly. \"I have to show you.\"\nThey went on together.",
  "Plutselig stoppet Lumi. Øynene ble store.\n«Å nei… der er han,» hvisket han. «Det er den jeg snakket om.»\nLumi pekte mot den store dinosauren. «Han har vært slem mot de andre.»\nSå så han på {name}. «Det er han jeg trenger hjelp med.»": "Suddenly Lumi stopped. His eyes widened.\n\"Oh no… there he is,\" he whispered. \"That's the one I was talking about.\"\nLumi pointed towards the big dinosaur. \"He has been mean to the others.\"\nThen he looked at {name}. \"He's the one I need help with.\"",
  "{name} tok et steg frem. Hjertet banket fort, men han sto støtt.\n«Du må slutte,» sa han rolig. «Det er ikke greit å være slem.»\nT-rexen stoppet opp. Ingen hadde sagt det til ham før.": "{name} took a step forward. His heart was beating fast, but he stood firm.\n\"You have to stop,\" he said calmly. \"It's not okay to be mean.\"\nThe T-rex stopped. No one had told him that before.",
  "T-rexen senket hodet. «Jeg forsto ikke at jeg gjorde vondt,» sa han lavt.\nHan snudde seg sakte. Denne gangen uten brøl.\nOg med tunge steg gikk han rolig sin vei.": "The T-rex lowered its head. \"I didn't realize I was hurting,\" he said softly.\nHe turned slowly. This time without a roar.\nAnd with heavy steps he went calmly on his way.",
  "{name} og Lumi sto stille sammen. De så utover dalen der de andre dinosaurene levde i fred.\nLumi smilte forsiktig. Og {name} kjente seg varm og stolt inni seg.\nDe hadde gjort noe viktig – sammen.": "{name} and Lumi stood silently together. They looked out over the valley where the other dinosaurs lived in peace.\nLumi smiled gently. And {name} felt warm and proud inside.\nThey had done something important - together.",
  "Solen var i ferd med å gå ned. {name} visste at det var på tide å dra hjem.\nLumi så på ham og nikket stille. «Du vil alltid være en venn,» sa han.\n{name} vinket farvel. Og med et smil tok han steget tilbake til sin egen verden.": "The sun was about to set. {name} knew it was time to go home.\nLumi looked at him and nodded silently. \"You will always be a friend,\" he said.\n{name} waved goodbye. And with a smile he took the step back into his own world.",
  "Denne boken handler om mot. Om å tørre å si ifra når noe er urettferdig – selv når det føles litt skummelt.\nGjennom et magisk møte i Dinosaurdalen lærer {name} at ekte styrke ikke handler om å være størst eller sterkest, men om å være snill, modig og å bry seg om andre.\nEn varm og personlig historie som viser barn at én stemme kan gjøre en stor forskjell. Og at vennskap kan oppstå på de mest uventede steder.\nEn bok som gir trygghet, selvtillit – og minner barnet på at også de kan være en helt.": "This book is about courage. About daring to speak up when something is unfair - even when it feels a little scary.\nThrough a magical meeting in Dinosaur Valley, {name} learns that true strength is not about being the biggest or strongest, but about being kind, brave and caring about others.\nA warm and personal story that shows children that one voice can make a big difference. And that friendships can arise in the most unexpected places.\nA book that gives security, confidence - and reminds the child that they too can be a hero."
}
