...
BOOK_DREAMPAGE_FIRST = os.path.join(
    DP_ROOT, "books", "hestestjernen", "dreampage-first-hestestjernen.png"
)
...
FRONT_COVER_LINE_SPACING = 0.062          # holder logoen der den var, se kommentar over
FRONT_COVER_LINE1_SIZE = 70 / 1024          # andel av kortsiden (malen er 1024 px)
