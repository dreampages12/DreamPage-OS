...
def _draw_title_cover_text(img, text):
    ...
    font_small = ImageFont.truetype(COVER_FONT, int(min(img.size) * 0.092))
    font_large = ImageFont.truetype(COVER_FONT, int(min(img.size) * 0.112))
