...
def render_dreampage_first(child_name: str, out_dir: str) -> str:
    ...
    body_lines = [
        ...
        f"You are {child_name} — the brave one in this story.",
        "",
...
_DREAMPAGE_TRANSLATIONS = {
  "{name} sin\nDen Magiske Bursdagen": "{name}'s\nThe Magical Birthday",
  "Det var bursdagen til {name}, og noe glitret under puten hennes.\nDet var en gyllen sløyfe – og den beveget seg helt av seg selv.\n{name} trakk forsiktig i den, og den rosa festkjolen svevde ut av skapet.\nSløyfen ville tydeligvis vise henne noe.": "It was {name}'s birthday, and something was glittering under her pillow.\nIt was a golden ribbon – and it was moving all by itself.\n{name} gave it a gentle tug, and her pink party dress floated out of the wardrobe.\nThe ribbon clearly wanted to show her something.",
  "{name} tok på seg kjolen, og sløyfen snodde seg bort til døren.\nHun trakk i den én gang til, og døren gled sakte opp.\nUtenfor lå en hage full av blomster, lys og sommerfugler.\nSløyfen fortsatte ut i hagen, som om den ville at hun skulle følge etter.": "{name} put on the dress, and the ribbon wound its way over to the door.\nShe pulled it one more time, and the door slowly swung open.\nOutside lay a garden full of flowers, lanterns and butterflies.\nThe ribbon carried on into the garden, as if it wanted her to follow.",
  "Sløyfen la seg som en lysende sti gjennom hagen.\nLangt borte skimtet {name} en paviljong som glitret i solnedgangen.\nDa skjønte hun hvor sløyfen ville: den skulle føre henne dit.\nSå løp {name} av sted, midt i det gylne lyset.": "The ribbon laid itself out like a glowing path through the garden.\nFar away {name} could see a pavilion sparkling in the sunset.\nThen she understood where the ribbon was going: it was leading her there.\nSo {name} set off running, right through the golden light.",
  "Ved en stor blomsterport stoppet stien opp.\n{name} tok tak i sløyfen og trakk så hardt hun kunne.\nPorten svingte opp, ballonger steg mot himmelen og små lys ble tent.\nPå den andre siden lå gaver på rekke og rad, hele veien mot paviljongen.": "At a great flower gate the path came to a stop.\n{name} took hold of the ribbon and pulled as hard as she could.\nThe gate swung open, balloons rose into the sky and tiny lights lit up.\nOn the other side lay presents in long rows, all the way to the pavilion.",
  "Plutselig kom det noen løpende bak henne.\nTo kaniner og et lite rådyr fulgte den samme gylne sløyfen.\nDe sprang forbi {name} og snudde seg, som om de ville si: bli med!\nSammen skyndte de seg videre mot bursdagsfesten.": "Suddenly someone came running up behind her.\nTwo rabbits and a little fawn were following the very same golden ribbon.\nThey rushed past {name} and turned around, as if to say: come along!\nTogether they hurried on towards the birthday party.",
  "Men da {name} kom frem, var ikke festen ferdig ennå.\nBordet stod tomt, og gavene lå strødd utover.\n{name} tok tak i sløyfen, og kaninene tok tak bak henne.\nSammen dro de – og blomster, ballonger og gaver begynte å finne plassen sin.": "But when {name} arrived, the party was not ready yet.\nThe table stood empty, and the presents lay scattered about.\n{name} took hold of the ribbon, and the rabbits took hold behind her.\nTogether they pulled – and flowers, balloons and presents began to find their places.",
  "{name} tok i så hardt hun kunne, én siste gang.\nForhengene gled til side, og hele festen kom til syne.\nDer stod en stor kake, tusen små lys og ballonger helt opp til himmelen.\nDette var hennes helt egen magiske bursdagsfest.": "{name} pulled as hard as she could, one last time.\nThe curtains slid aside, and the whole party appeared.\nThere stood a great cake, a thousand tiny lights and balloons right up to the sky.\nThis was her very own magical birthday party.",
  "Det var fortsatt litt igjen å gjøre.\n{name} dyttet den siste store gaven på plass ved bordet.\nKaninene ordnet sløyfene, og rådyret holdt den gylne tråden.\nNå var alt klart til å feire.": "There was still a little left to do.\n{name} pushed the last big present into place beside the table.\nThe rabbits arranged the ribbons, and the fawn held the golden thread.\nNow everything was ready for the celebration.",
  "{name} lukket øynene og ønsket seg noe.\nSå blåste hun ut alle lysene på kaken.\nGnistene virvlet opp og ble til en ny, glødende del av sløyfen.\nBursdagsønsket hennes fløy av sted, videre ut i hagen.": "{name} closed her eyes and made a wish.\nThen she blew out every candle on the cake.\nThe sparks swirled up and became a new, glowing part of the ribbon.\nHer birthday wish flew off, out into the garden.",
  "Overalt der ønsket fløy, våknet hagen til liv.\nBlomster åpnet seg, og girlandere hengte seg selv opp mellom trærne.\nKaninene kom med tallerkener, og rådyret bar en kurv full av roser.\n{name} satte den siste lysende blomsterstjernen øverst på kaken.": "Everywhere the wish flew, the garden woke up.\nFlowers opened, and garlands hung themselves between the trees.\nThe rabbits brought plates, and the fawn carried a basket full of roses.\n{name} placed the last glowing flower star on top of the cake.",
  "Men ønskelyset stoppet ikke ved kaken.\nEn av kaninene oppdaget at det fortsatte bortover stien.\nKaninen satte av sted, og {name} løp tett bak.\nUnder en benk full av roser lå det en gave som ingen hadde sett før.": "But the wishing light did not stop at the cake.\nOne of the rabbits noticed that it carried on along the path.\nThe rabbit dashed off, and {name} ran close behind.\nUnder a bench covered in roses lay a present nobody had seen before.",
  "{name} satte seg ned foran den skjulte gaven.\nHun tok tak i den lange sløyfen og trakk sakte.\nLokket spratt opp, og varmt, gyllent lys strømmet ut.\nKaninene og rådyret kom nærmere for å se hva som var inni.": "{name} sat down in front of the hidden present.\nShe took hold of the long ribbon and pulled slowly.\nThe lid sprang open, and warm, golden light streamed out.\nThe rabbits and the fawn came closer to see what was inside.",
  "Inni gaven lå et lite lys formet som en blomst.\n{name} løftet det forsiktig opp, og det festet seg til den gylne sløyfen.\nMed ett samlet ballonger, blomster og lys seg rundt paviljongen.\nNå var bursdagsfesten endelig helt ferdig.": "Inside the present lay a small light shaped like a flower.\n{name} lifted it out carefully, and it fastened itself to the golden ribbon.\nAll at once balloons, flowers and lights gathered around the pavilion.\nNow the birthday party was finally complete.",
  "Da solen gikk ned, satte {name} seg til bords med vennene sine.\nHun skar det første stykket kake og delte det ut til kaninene og rådyret.\nDen gylne sløyfen la seg som en varm ring rundt hele selskapet.\n{name} hadde ikke bare funnet bursdagsfesten sin – hun hadde vært med på å lage den.": "As the sun went down, {name} sat down at the table with her friends.\nShe cut the first slice of cake and shared it with the rabbits and the fawn.\nThe golden ribbon settled like a warm circle around the whole party.\n{name} had not only found her birthday party – she had helped to create it.",
  "Denne boken handler om glede.\nOm å våkne opp til noe magisk, og selv være med på å skape det.\nDen viser at den fineste festen ikke er den man bare blir invitert til, men den man hjelper til med å gjøre ferdig.\nDerfor er det {name} som får hele feiringen til å våkne. En bursdagsgjest som blir vertinne i sitt eget eventyr.\nEn personlig fortelling som gir barn glede, mestringsfølelse og troen på at den aller fineste bursdagsmagien er den vi lager sammen.": "This book is about joy.\nAbout waking up to something magical, and helping to create it yourself.\nIt shows that the finest party is not the one you are simply invited to, but the one you help to finish.\nThat is why it is {name} who makes the whole celebration come alive. A birthday guest who becomes the host of her own adventure.\nA personal story that gives children joy, confidence and the belief that the very best birthday magic is the kind we make together."
}
