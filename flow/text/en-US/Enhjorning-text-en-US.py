...
def build_pages(child_name: str) -> List[Dict[str, Any]]:
    ...
    story: List[Dict[str, Any]] = [
        ...
        },
        {
            ...
            "side": "left",
            "block": story_block(
                "The unicorn ran toward a wide, clear lake.\n"
        ...
        },
        {
            ...
            "block": story_block(
                ...
                "The oldest unicorn bowed its head toward her.\n"
            ...
            "blocks": [
                {
                    "text": pformat(
                        ...
                        "You are the hero of an adventure full of color, courage and magic.\n"
