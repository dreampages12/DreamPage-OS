...
_DREAMPAGE_TRANSLATIONS = {
  "{name} sin": "{name}'s",
  "{name} og\nDet Magiske Kartet": "{name} and\nThe Magic Map",
  "Denne boken er laget spesielt for deg, {name}.\nNoen kart viser veien til steder.\nDette kartet viser veien til motet, godheten og magien inni deg.": "This book is made especially for you, {name}.\nSome maps show the way to places.\nThis map shows the way to the courage, goodness and magic within you.",
  "{name} hadde nesten gjort seg klar for kvelden da hun oppdaget noe merkelig.\nMellom bøkene på rommet lå et kart hun aldri hadde sett før.\nDet så gammelt og støvete ut, men da hun løftet det opp, begynte kantene å gløde svakt i gull.": "{name} had almost gotten ready for the evening when she noticed something strange.\nBetween the books in the room was a map she had never seen before.\nIt looked old and dusty, but when she lifted it up, the edges began to glow faintly gold.",
  "Kartet ble varmt i hendene hennes.\nSmå tegn av gyllent lys steg opp fra papiret og danset rundt i rommet som hemmelige stjerner.\n{name} holdt pusten.\nDette var ikke et vanlig kart.": "The map grew warm in her hands.\nLittle signs of golden light rose from the paper and danced around the room like secret stars.\n{name} held his breath.\nThis was no ordinary map.",
  "Lyset fra kartet samlet seg ved vinduet.\nFørst var det lite som en gnist, men så vokste det til en rund, gyllen portal.\nInne i lyset skimtet {name} en skog med glødende planter og blinkende blågrønne lys.": "The light from the map gathered at the window.\nAt first it was little like a spark, but then it grew into a round, golden portal.\nInside the light, {name} glimpsed a forest of glowing plants and flashing blue-green lights.",
  "{name} tok et forsiktig skritt nærmere.\nPortalen summet mykt, som om den ventet på henne.\nHun var spent, men kartet lyste varmt i hånden hennes.\nSå rettet hun ryggen og hvisket: Jeg tør.": "{name} took a cautious step closer.\nThe portal hummed softly, as if it was waiting for her.\nShe was excited, but the map glowed warmly in her hand.\nThen she straightened her back and whispered: I dare.",
  "I neste øyeblikk sto {name} midt i den fortryllede skogen.\nTrærne var høyere enn hus, og blomstene glødet svakt langs stien.\nBak henne blinket portalen stille mellom greinene.\nReisen hadde virkelig begynt.": "In the next moment, the {name} was standing in the middle of the enchanted forest.\nThe trees were taller than houses, and the flowers glowed faintly along the path.\nBehind her, the portal flashed quietly between the branches.\nThe journey had truly begun.",
  "På stien foran henne dukket en liten gyllen rev opp.\nDen hadde kloke øyne og en hale som glitret som sollys.\n\"Kartet viser veien,\" sa reven mykt.\n\"Men du må selv tørre å følge den.\"": "On the path in front of her, a small golden fox appeared.\nIt had wise eyes and a tail that glittered like sunlight.\n\"The map shows the way,\" said the fox softly.\n\"But you yourself must dare to follow it.\"",
  "Reven ledet {name} til et gammelt tre med et stjerneformet merke i barken.\nDa hun holdt kartet nærmere, begynte både treet og papiret å skinne.\nStjernemerket løsnet forsiktig og svevde inn i kartet.\n\"Én del av veien er funnet,\" sa reven.": "The fox led the {name} to an old tree with a star-shaped mark in the bark.\nAs she held the map closer, both the wood and the paper began to glow.\nThe asterisk gently detached and floated into the map.\n\"One part of the road is found,\" said the fox.",
  "Da stjernemerket landet på kartet, begynte linjene å flytte på seg.\nLyset samlet seg mellom trærne, og en ny portal åpnet seg.\nPå den andre siden svevde øyer høyt over skyene, med fossefall som falt rett ned i luften.\n\"Kartet tror du er klar,\" sa reven.": "When the asterisk landed on the map, the lines began to move.\nThe light gathered between the trees, and a new portal opened.\nOn the other side, islands floated high above the clouds, with waterfalls falling straight into the air.\n\"The map thinks you're ready,\" said the fox.",
  "På en av de flyvende øyene hørte {name} en svak lyd.\nBak glødende slyngplanter satt en liten drageunge fast med vingen sin.\nDen så redd ut, men ikke farlig.\n{name} løsnet plantene én etter én, og dragen dyttet snuten takknemlig mot hånden hennes.": "On one of the flying islands, {name} heard a faint sound.\nBehind glowing creepers, a small baby dragon was stuck with its wing.\nIt looked scared, but not dangerous.\n{name} dislodged the plants one by one, and the dragon nudged its snout gratefully against her hand.",
  "Drageungen ristet på vingene og pekte med snuten mot kartet.\nEt nytt stjernemerke våknet på papiret.\nBlått og gull blandet seg i luften foran dem, og en portal åpnet seg.\nInne i lyset lå en by under havet, full av koraller og små svevende måner.": "The baby dragon shook its wings and pointed its snout at the map.\nA new star mark awoke on the paper.\nBlue and gold mingled in the air before them, and a portal opened.\nInside the light lay a city under the sea, full of coral and small floating moons.",
  "Da {name} gikk gjennom portalen, lukket en glødende luftboble seg rundt henne.\nUtenfor danset vannet stille, og hele undervannsbyen lyste.\nMidt i byen blinket et nytt stjernemerke på kartet.\nDa hun rørte ved merket, fløy lyset rett inn i papiret.": "As the {name} walked through the portal, a glowing air bubble closed around her.\nOutside, the water danced quietly, and the entire underwater city glowed.\nIn the middle of the city, a new star mark flashed on the map.\nWhen she touched the mark, the light flew straight into the paper.",
  "Det nye stjernemerket fikk kartet til å lyse kaldt og klart.\nEn portal åpnet seg, og {name} steg ut i en verden av is og nordlys.\nFjellene ruvet rundt henne som blå krystaller.\nDrageungen sto ved siden av henne, klar til å følge henne videre.": "The new star mark made the map shine cold and clear.\nA portal opened, and the {name} stepped out into a world of ice and northern lights.\nThe mountains towered around her like blue crystals.\nThe baby dragon stood beside her, ready to follow her on.",
  "Da det siste lyset fra nordlyset traff kartet, åpnet det seg en dør av stjerner.\nBak den lå Stjernebiblioteket, større og vakrere enn noe {name} hadde sett før.\nBøker svevde mellom hyllene, og i midten sto en himmelglobus full av gyllent lys.\nAlle stjernemerkene samlet seg til én strålende vei.": "When the last light from the northern lights hit the map, a door of stars opened.\nBehind it lay the Star Library, bigger and more beautiful than anything {name} had seen before.\nBooks floated between the shelves, and in the middle stood a celestial globe full of golden light.\nAll the star signs gathered into one glorious path.",
  "Et øyeblikk senere sto {name} tilbake på rommet sitt.\nAlt så nesten vanlig ut igjen: sengen, bøkene og teleskopet ved vinduet.\nMen kartet glødet fortsatt mykt, fullt av stjernemerker fra reisen.\nDa forsto hun det viktigste: Kartet hadde vist veien, men magien hadde vært i henne.": "A moment later {name} was back in his room.\nEverything looked almost normal again: the bed, the books and the telescope by the window.\nBut the map still glowed softly, full of star marks from the journey.\nThen she understood the most important thing: the map had shown the way, but the magic had been in her.",
  "En kveld finner {name} et gammelt kart som begynner å gløde i hendene hennes.\nKartet åpner portaler til fortryllede skoger, flyvende øyer, en undervannsby, en isverden og et bibliotek av stjerner.\nPå reisen hjelper {name} nye venner, samler stjernemerker og oppdager at ekte magi ikke bare finnes på kartet.\nDen finnes i motet hennes, i godheten hennes og i troen på at hun kan gå videre.": "One evening {name} finds an old map that begins to glow in her hands.\nThe map opens portals to enchanted forests, flying islands, an underwater city, an ice world and a library of stars.\nOn the journey, {name} helps new friends, collects star tokens and discovers that real magic is not only found on the map.\nIt is found in her courage, in her kindness and in her belief that she can move on."
}
