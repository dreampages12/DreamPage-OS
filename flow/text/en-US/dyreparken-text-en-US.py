...
_DREAMPAGE_TRANSLATIONS = {
  "{name} i\nDyreparken": "{name} at\nThe Zoo",
  "Takk for at du kjøpte denne personlige historien!\nI denne boken følger vi {name} på et spennende eventyr i dyreparken.\nHer møter {name} dyr som trenger litt hjelp - og oppdager hvor langt vennlighet kan rekke.\nVi håper historien skaper varme, undring og fine lesestunder.": "Thank you for purchasing this personal story!\nIn this book, we follow {name} on an exciting adventure in the zoo.\nHere, {name} meets animals that need a little help - and discovers how far kindness can go.\nWe hope the story creates warmth, wonder and good reading times.",
  "\"Endelig er dagen her,\" sa {name} og smilte ved porten.\nBak inngangen ventet svingete stier, rare dyrelyder og lukten av varmt gress.\nAlt kjentes nesten magisk, som om parken hadde våknet akkurat for ham.\nSå hvisket vinden mellom trærne: Velkommen til dyreparken. Et eventyr venter.": "\"Finally the day is here,\" {name} said smiling at the gate.\nBehind the entrance awaited winding paths, strange animal sounds and the smell of warm grass.\nEverything felt almost magical, as if the park had woken up just for him.\nThen the wind whispered between the trees: Welcome to the zoo. An adventure awaits.",
  "{name} gikk videre og fikk øye på en høy giraff.\nDen bøyde den lange halsen ned og smilte vennlig.\n\"Hallo der nede,\" sa giraffen. \"Kan du hjelpe oss i dag?\"\n\"Ja!\" svarte {name} uten å nøle.": "{name} walked forward and spotted a tall giraffe.\nIt bent its long neck down and smiled kindly.\n\"Hello down there,\" said the giraffe. \"Can you help us today?\"\n\"Yes!\" answered {name} without hesitation.",
  "Giraffen kom helt nær og senket stemmen, som om den delte en viktig hemmelighet.\n\"Elefanten trenger hjelp først,\" sa den. \"Han prøver å nå de beste bladene, men de sitter for høyt.\"\n{name} kjente hjertet hoppe av spenning. \"Da går jeg med en gang,\" sa han, og satte fart langs stien.": "The giraffe came very close and lowered its voice, as if sharing an important secret.\n\"The elephant needs help first,\" it said. \"He's trying to reach the best leaves, but they're too high.\"\n{name} felt his heart skip a beat with excitement. \"Then I'll go at once,\" he said, and sped along the path.",
  "{name} skyndte seg langs stien mot elefantens område.\nSolen glitret i vannet, og bladene raslet over ham som små grønne flagg.\nHan fulgte de tunge fotsporene i sanden og ropte: \"Jeg kommer, elefant!\"\nNå var eventyret virkelig i gang.": "{name} hurried along the path towards the elephant's area.\nThe sun glistened in the water, and the leaves rustled above him like little green flags.\nHe followed the heavy footprints in the sand and called, \"I'm coming, elephant!\"\nNow the adventure really began.",
  "Ved gjerdet sto elefanten og løftet snabelen håpefullt mot de grønne greinene.\n{name} samlet friske blader, strakte seg så langt han kunne og rakte dem forsiktig frem.\nElefanten tok imot med snabelen og blunket takknemlig. \"Tusen takk,\" sa den. \"Du reddet dagen min.\"": "The elephant stood by the fence and lifted its trunk hopefully towards the green branches.\n{name} gathered fresh leaves, stretched as far as he could and carefully held them out.\nThe elephant accepted with its trunk and winked gratefully. \"Thank you very much,\" it said. \"You saved my day.\"",
  "Da elefanten var glad igjen, gikk {name} videre med lette steg.\nVed vannet ventet en zebra som stampet urolig med hoven og så nedover stien.\n\"Jeg finner ikke veien tilbake til flokken min,\" sa zebraen. \"Kan du hjelpe meg også?\"\n\"Selvfølgelig,\" sa {name}. \"Vi finner dem sammen.\"": "When the elephant was happy again, {name} moved on with light steps.\nA zebra was waiting by the water, stomping its hoof restlessly and looking down the path.\n\"I can't find my way back to my herd,\" said the zebra. \"Can you help me too?\"\n\"Of course,\" {name} said. \"We'll find them together.\"",
  "Zebraen satte fart, og {name} sprang ved siden av så godt han kunne.\nDe fulgte små spor i sanden, forbi busker og rundt en dam som glitret i solen.\nTil slutt fant zebraen flokken sin igjen. \"Nå går alt bra,\" sa den lykkelig. {name} lo. \"Vi er et godt team.\"": "The zebra sped off, and {name} leaped alongside as best he could.\nThey followed small tracks in the sand, past bushes and around a pond that glistened in the sun.\nFinally, the zebra found his herd again. \"Now everything is going well,\" it said happily. {name} laughed. \"We're a good team.\"",
  "Til slutt kom {name} til løven, som satt fast bak en tung gren.\n{name} tok tak og skjøv så godt han kunne.\n\"Du er modigere enn mange voksne,\" sa løven da veien ble fri.\n\"Jeg ville bare hjelpe,\" sa {name}.": "Finally, the {name} came to the lion, who was stuck behind a heavy branch.\n{name} grabbed hold and pushed as hard as he could.\n\"You are braver than many adults,\" said the lion when the way was clear.\n\"I just wanted to help,\" {name} said.",
  "Da oppdragene var ferdige, kom alle dyrene bort til {name}.\n\"Du hjalp oss alle,\" sa giraffen.\n\"Du er vår venn nå,\" sa elefanten, mens zebraen nikket og løven brummet mykt.\n{name} kjente seg varm av glede.": "When the missions were finished, all the animals came over to the {name}.\n\"You helped us all,\" said the giraffe.\n\"You are our friend now,\" said the elephant, as the zebra nodded and the lion hummed softly.\n{name} felt warm with joy.",
  "{name} løftet hånden og vinket til alle de nye vennene sine.\n\"Ha det!\" ropte han, selv om stemmen ble litt myk av savn.\n\"Kom tilbake en dag,\" ropte dyrene tilbake, én etter én.\nDet var trist å gå, men hjertet hans var fullt av lys og varme minner.": "{name} raised his hand and waved to all his new friends.\n\"Have it!\" he shouted, though his voice softened a little with longing.\n\"Come back one day,\" the animals called back, one by one.\nIt was sad to leave, but his heart was full of light and warm memories.",
  "Et stykke borte snudde {name} seg en siste gang.\nI sollyset så det nesten ut som om dyrene smilte til ham fra det fjerne.\nHan la hånden mot brystet og kjente hvor glad han var blitt i dem.\nDette var et farvel som ikke føltes helt som et farvel.": "Some distance away, the {name} turned one last time.\nIn the sunlight it almost looked as if the animals were smiling at him from afar.\nHe put his hand to his chest and felt how fond he had become of them.\nThis was a goodbye that didn't quite feel like a goodbye.",
  "Ved stien glitret noe lite i kveldssolen.\n{name} bøyde seg ned og fant en liten elefantfigur i grusen.\n\"Et minne fra oss,\" var det nesten som vinden hvisket.\n\"Da glemmer jeg dere aldri,\" sa {name} stille.": "By the path something small glistened in the evening sun.\n{name} bent down and found a small elephant figure in the gravel.\n\"A memory from us,\" it was almost like the wind whispered.\n\"Then I'll never forget you,\" {name} said quietly.",
  "Solen sank lavt mens {name} gikk hjemover.\nBak porten lå dyreparken stille, og foran ham ventet huset med varme lys.\nHan holdt elefantfiguren tett og visste det i hele hjertet sitt:\nEventyret var ikke helt over.": "The sun sank low as {name} walked home.\nBehind the gate the zoo was quiet, and in front of him the house waited with warm lights.\nHe held the elephant figure close and knew it in his heart:\nThe adventure was not quite over.",
  "Før {name} sovnet, så han bort på den lille elefanten ved lampen.\nRommet var stille, men han syntes nesten han kunne høre et mykt brøl og et vennlig tramp.\nKanskje, tenkte han, venter dyrevennene på meg igjen i morgen.\nOg med det sovnet han med et smil.": "Before {name} fell asleep, he looked over at the little elephant by the lamp.\nThe room was quiet, but he almost thought he could hear a soft roar and a friendly stomp.\nPerhaps, he thought, the animal friends will be waiting for me again tomorrow.\nAnd with that he fell asleep with a smile.",
  "Denne boken handler om små handlinger som betyr mye.\nNår {name} går inn i dyreparken, venter et varmt og spennende eventyr bak hver sving. En giraff ber om hjelp, en elefant blir lettet, en zebra finner smilet igjen, og en løve oppdager hva ekte vennskap er.\nGjennom møtene lærer {name} at omtanke, mot og vennlighet kan gjøre en stor forskjell.\nEn personlig historie fylt med dyreglede, nærhet og minner som varer lenge etter siste side.": "This book is about small actions that mean a lot.\nWhen {name} enters the zoo, a warm and exciting adventure awaits around every turn. A giraffe asks for help, an elephant is relieved, a zebra finds its smile again, and a lion discovers what true friendship is.\nThrough the meetings, {name} learns that consideration, courage and kindness can make a big difference.\nA personal story filled with animal joy, closeness and memories that last long after the last page."
}
