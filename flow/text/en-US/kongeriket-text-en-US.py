...
BOOK_DREAMPAGE_FIRST = os.path.join(
    os.path.dirname(SCRIPT_ROOT_DIR), "books", "kongerikets-hemmelighet", "dreampage-first-kongeriket.png"
)
...
def render_page(page: Dict[str, Any], base_dir: str, out_dir: str) -> List[str]:
    ...
    if page.get("type") == "blank":
        blank_path = BOOK_DREAMPAGE_FIRST if os.path.exists(BOOK_DREAMPAGE_FIRST) else os.path.join(SCRIPT_DIR, "dreampage-first.png")
...
_DREAMPAGE_TRANSLATIONS = {
  'Prinsesse {name} og\nKongerikets Hemmelighet': 'Princess {name} and\nThe Secret of the Kingdom',
