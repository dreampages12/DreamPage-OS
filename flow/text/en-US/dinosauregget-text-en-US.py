...
DINOSAUR_DREAMPAGE_FIRST = os.path.join(
    os.path.dirname(SCRIPT_ROOT_DIR), "books", "det-forsvunne-dinosauregget", "dreampage-first-dinosauregget.png"
)
...
def _draw_title_cover_text(img, text):
    ...
    cover_scale = min(img.size) / 1024
    font_small = ImageFont.truetype(COVER_FONT, max(1, int(89 * cover_scale)))
    font_large = ImageFont.truetype(COVER_FONT, max(1, int(97 * cover_scale)))
...
# ---------------------------------------------------------------------------
FRONT_COVER_LOGO_SCALE = 0.88
FRONT_COVER_LOGO_X_OFFSET = 0
FRONT_COVER_TOP_MARGIN = 0.035
FRONT_COVER_LINE_SPACING = 0.034
FRONT_COVER_LINE1_SIZE = 80 / 1024          # andel av kortsiden
FRONT_COVER_GOLD = ((255, 255, 255), (255, 255, 255))
FRONT_COVER_SHADOW = (45, 30, 18)

# Logoen inneholder bare "FORSVUNNE DINOSAUREGGET" - artikkelen "det" er ikke
# med i grafikken. Den maa derfor henge paa linje 1, ellers leser forsiden
# "Emma og / FORSVUNNE DINOSAUREGGET". Speiler line1_suffix "og det" i
# config/next_book_titles.json. Tomt for sprak som uansett faller til tekst.
FRONT_COVER_LINE1_EXTRA = {"nb": " det", "nn": " det"}.get(SCRIPT_LOCALE, "")
...
def resolve_front_cover_logo():
    ...
    """
    name = {
        "nb": "dinosauregget-logo-nb.png",
        "nn": "dinosauregget-logo-nb.png",
        "en-US": "dinosauregget-logo-en.png",
        "en-GB": "dinosauregget-logo-en.png",
        "sv": "dinosauregget-logo-sv.png",
    }.get(SCRIPT_LOCALE, "dinosauregget-logo-nb.png")
...
def build_pages(child_name: str) -> List[Dict[str, Any]]:
    ...
    pages: List[Dict[str, Any]] = [
        {
            "filename": "forside(dinosauregget).png",
            "type": "cover",
        ...
        },
        {
            ...
            "blocks": [{
                "text": p(
                    ...
                    "I denne boken drar (Navn) tilbake til dinosaurdalen for å lete etter et egg som har forsvunnet. (Navn) lærer at det å hjelpe andre går aller best når man gjør det sammen.\n"
        ...
        # Side 1
        {
            "filename": "01(dinosauregget).png",
            "type": "inner",
            "side": "right",
            "blocks": [{
                "text": p(
                    "Det hadde gått en stund siden (Navn) sist var i dinosaurdalen.\n"
                    "En helt vanlig dag på skogsstien skjedde det noe.\n"
                    "Gylne lys begynte å danse mellom trærne.\n"
                    "Portalen var tilbake. Og den ventet på (Navn)."
                ),
                "font_size": 34,
                "color": "#FFFFFF",
                "highlights": [child_name, "annerledes", "Portalen", "gylne"],
            }],
        },

        # Side 2
        {
            "filename": "02(dinosauregget).png",
            "type": "inner",
            "side": "right",
            "blocks": [{
                "text": p(
                    "(Navn) tok et steg gjennom det gylne lyset.\n"
                    "På den andre siden sto Lumi og ventet.\n"
                    "Men denne gangen var Lumi urolig. Han trippet frem og tilbake.\n"
                    "«Kom fort,» sa han. «Jeg må vise deg noe.»"
                ),
                "font_size": 34,
                "color": "#FFFFFF",
                "highlights": [child_name, "Lumi", "urolig"],
            }],
        },

        # Side 3
        {
            "filename": "03(dinosauregget).png",
            "type": "inner",
            "side": "right",
            "blocks": [{
                "text": p(
                    "Lumi løp foran, og (Navn) fulgte etter helt til de kom til et stort rede.\n"
                    "Inni lå flere egg trygt sammen. Men det var en tom plass i midten.\n"
                    "En stor dinosaurmor gikk urolig rundt redet.\n"
                    "Ett av eggene hennes var borte."
                ),
                "font_size": 34,
                "color": "#FFFFFF",
                "highlights": [child_name, "redet", "egg", "borte"],
            }],
        },

        # Side 4
        {
            "filename": "04(dinosauregget).png",
            "type": "inner",
            "side": "left",
            "blocks": [{
                "text": p(
                    "(Navn) satte seg på huk og så nøye på bakken.\n"
                    "I den myke jorda lå det ferske fotavtrykk.\n"
                    "Ved siden av dem gikk et bredt slepespor.\n"
                    "«Egget er ikke borte,» sa (Navn). «Det har blitt flyttet.»"
                ),
                "font_size": 34,
                "color": "#FFFFFF",
                "highlights": [child_name, "fotavtrykk", "slepespor", "flyttet"],
            }],
        },

        # Side 5
        {
            "filename": "05(dinosauregget).png",
            "type": "inner",
            "side": "right",
            "blocks": [{
                "text": p(
                    "Sporene førte inn i en mørkere del av dalen.\n"
                    "Her var trærne tettere, og lyden av elven var langt unna.\n"
                    "Plutselig raslet det i buskene foran dem.\n"
                    "(Navn) og Lumi stoppet helt stille."
                ),
                "font_size": 34,
                "color": "#FFFFFF",
                "highlights": [child_name, "mørkere", "stille"],
            }],
        },

        # Side 6
        {
            "filename": "06(dinosauregget).png",
            "type": "inner",
            "side": "left",
            "blocks": [{
                "text": p(
                    "En rask dinosaur med fjær hoppet frem mellom bladene.\n"
                    "Den så på (Navn) et lite øyeblikk. Så snudde den og løp.\n"
                    "«Etter den!» ropte Lumi.\n"
                    "Og så bar det av gårde gjennom jungelen."
                ),
                "font_size": 34,
                "color": "#FFFFFF",
                "highlights": [child_name, "fjaer", "Lumi", "jungelen"],
            }],
        },

        # Side 7 (kvadrat, venstre)
        {
            "filename": "07(dinosauregget-left).png",
            "type": "inner",
            "square": True,
            "blocks": [],
        },

        # Side 7 (kvadrat, hoyre)
        {
            "filename": "07(dinosauregget-right).png",
            "type": "inner",
            "square": True,
            "side": "left",
            "no_split": True,
            "box_frac": [0.07, 0.63, 0.60, 0.97],
            "blocks": [{
                "text": p(
                    "Jakten gikk over falne trær og langs den brusende elven.\n"
                    "Den fremmede dinosauren så seg tilbake igjen og igjen.\n"
                    "Nesten som om den ville at de skulle følge etter.\n"
                    "(Navn) begynte å lure. Kanskje den ikke rømte i det hele tatt?"
                ),
                "font_size": 30,
                "color": "#FFFFFF",
                "highlights": [child_name, "fremmede", "lure"],
            }],
        },

        # Side 8
        {
            "filename": "08(dinosauregget).png",
            "type": "inner",
            "side": "left",
            "blocks": [{
                "text": p(
                    "Nede ved elvebredden fant de det. Det savnede egget.\n"
                    "Det hadde ikke blitt stjålet i det hele tatt.\n"
                    "Egget hadde trillet ned fra redet og satt fast mellom steinene.\n"
                    "Og den fremmede dinosauren hadde passet på det hele tiden."
                ),
                "font_size": 34,
                "color": "#FFFFFF",
                "highlights": [child_name, "egget", "stjålet", "passet"],
            }],
        },

        # Side 9
        {
            "filename": "09(dinosauregget).png",
            "type": "inner",
            "side": "right",
            "blocks": [{
                "text": p(
                    "Et dypt drønn rullet ned fra fjellene.\n"
                    "Elven begynte å stige, og vannet ble stridt og kaldt.\n"
                    "Egget vippet der det sto.\n"
                    "De måtte få det opp med en gang."
                ),
                "font_size": 34,
                "color": "#FFFFFF",
                "highlights": [child_name, "drønn", "stige", "med en gang"],
            }],
        },

        # Side 10
        {
            "filename": "10(dinosauregget).png",
            "type": "inner",
            "side": "left",
            "blocks": [{
                "text": p(
                    "(Navn) tok av seg ryggsekken og tenkte fort.\n"
                    "Greiner, mose og et flatt stykke bark ble til en liten slede.\n"
                    "«Dere drar, så løfter jeg,» sa (Navn).\n"
                    "Lumi og den fremmede dinosauren stilte seg klare."
                ),
                "font_size": 34,
                "color": "#FFFFFF",
                "highlights": [child_name, "ryggsekken", "slede", "klare"],
            }],
        },

        # Side 11
        {
            "filename": "11(dinosauregget).png",
            "type": "inner",
            "side": "left",
            "blocks": [{
                "text": p(
                    "En stor bølge kom brusende nedover elven.\n"
                    "Egget begynte å rulle mot vannet.\n"
                    "I siste liten strakte (Navn) seg frem og fikk tak.\n"
                    "Lumi og den fremmede dro til, og egget var trygt."
                ),
                "font_size": 34,
                "color": "#FFFFFF",
                "highlights": [child_name, "bølge", "siste liten", "trygt"],
            }],
        },

        # Side 12
        {
            "filename": "12(dinosauregget).png",
            "type": "inner",
            "side": "left",
            "blocks": [{
                "text": p(
                    "Sammen dro de egget forsiktig oppover stien.\n"
                    "Den fremmede dinosauren gikk foran og viste vei.\n"
                    "Langt der fremme sto dinosaurmoren og speidet.\n"
                    "Da hun fikk øye på egget, løftet hun hodet og ropte av glede."
                ),
                "font_size": 34,
                "color": "#FFFFFF",
                "highlights": [child_name, "sammen", "dinosaurmoren", "glede"],
            }],
        },

        # Side 13
        {
            "filename": "13(dinosauregget).png",
            "type": "inner",
            "side": "right",
            "blocks": [{
                "text": p(
                    "Egget ble lagt forsiktig tilbake i redet.\n"
                    "Da begynte skallet å sprekke, helt av seg selv.\n"
                    "En liten baby-triceratops tittet ut og så rett på (Navn).\n"
                    "Alle sto helt stille. Dette var det fineste (Navn) hadde sett."
                ),
                "font_size": 34,
                "color": "#FFFFFF",
                "highlights": [child_name, "sprekke", "triceratops", "fineste"],
            }],
        },

        # Side 14
        {
            "filename": "14(dinosauregget).png",
            "type": "inner",
            "side": "left",
            "blocks": [{
                "text": p(
                    "Solen gikk ned i gult og rosa da Lumi fulgte (Navn) tilbake til portalen.\n"
                    "«Takk for at du kom,» sa Lumi. «Du kom akkurat i tide.»\n"
                    "(Navn) vinket farvel og tok steget hjem.\n"
                    "Men langt borte sendte en gammel vulkan en tynn stripe røyk opp mot himmelen."
                ),
                "font_size": 34,
                "color": "#FFFFFF",
                "highlights": [child_name, "farvel", "vulkan", "røyk"],
            }],
        },
        ...
        # Bakside
        {
            "filename": "bakside(dinosauregget).png",
            "type": "cover",
            "side": "left",
            "blocks": [{
                "text": p(
                    "Denne boken handler om å hjelpe. Om å stoppe opp, se ordentlig etter og forstå at ting ikke alltid er slik de ser ut ved første blikk.\n"
                    "Når et dinosauregg forsvinner fra redet, drar (Navn) og vennen Lumi ut i dalen for å finne det. Jakten fører dem til en fremmed dinosaur – og til en sannhet ingen hadde ventet.\n"
                    "En varm og spennende historie om vennskap, samarbeid og om å tørre å stole på noen man ikke kjenner.\n"
                    "En bok som gir mot, glede – og minner barnet på at de kan utgjøre en forskjell."
                ),
                "font_size": 46,
                "color": "#FFFFFF",
                "highlights": [child_name, "dinosauregg", "Lumi", "vennskap", "samarbeid", "mot", "barnet"],
            }],
        },
    ]
...
def render_page(page: Dict[str, Any], base_dir: str, out_dir: str) -> List[str]:
    ...
    if page.get("type") == "blank":
        blank_path = DINOSAUR_DREAMPAGE_FIRST if os.path.exists(DINOSAUR_DREAMPAGE_FIRST) else os.path.join(SCRIPT_DIR, "dreampage-first.png")
        ...
        for block in page.get("blocks", []):
            ...
            box_top = int(block.get("y_offset", INNER_HEIGHT * 0.40) * scale_y)
            box_bottom = int(block.get("box_bottom", INNER_HEIGHT * 0.90) * scale_y)
...
def process_book(base_dir: str, out_dir: str, child_name: str, cover_type: str, gelato_api_key: str):
    ...
    need = ["bakside(dinosauregget).png", "ryggrad.png", "forside(dinosauregget).png"]
    ...
    back_path  = cover_rendered["bakside(dinosauregget).png"]
    spine_path = cover_rendered["ryggrad.png"]
    front_path = cover_rendered["forside(dinosauregget).png"]
...
_DREAMPAGE_TRANSLATIONS = {
  "{name} og\nDet forsvunne dinosauregget": "{name} and\nThe Lost Dinosaur Egg",
  "Takk for at du kjøpte denne personlige historien!\nI denne boken drar {name} tilbake til dinosaurdalen for å lete etter et egg som har forsvunnet. {name} lærer at det å hjelpe andre går aller best når man gjør det sammen.\nVi håper historien bringer glede, spenning og fantasifulle øyeblikk.": "Thank you for buying this personal story!\nIn this book, {name} returns to the dinosaur valley to search for an egg that has gone missing. {name} learns that helping others works best when you do it together.\nWe hope the story brings joy, excitement and imaginative moments.",
  "Det hadde gått en stund siden {name} sist var i dinosaurdalen.\nEn helt vanlig dag på skogsstien skjedde det noe.\nGylne lys begynte å danse mellom trærne.\nPortalen var tilbake. Og den ventet på {name}.": "It had been a while since {name} last visited the dinosaur valley.\nThen, on an ordinary day on the forest path, something happened.\nGolden lights began to dance between the trees.\nThe portal was back. And it was waiting for {name}.",
  "{name} tok et steg gjennom det gylne lyset.\nPå den andre siden sto Lumi og ventet.\nMen denne gangen var Lumi urolig. Han trippet frem og tilbake.\n«Kom fort,» sa han. «Jeg må vise deg noe.»": "{name} stepped through the golden light.\nOn the other side, Lumi stood waiting.\nBut this time Lumi was restless, shifting from foot to foot.\n\"Come quickly,\" he said. \"I have to show you something.\"",
  "Lumi løp foran, og {name} fulgte etter helt til de kom til et stort rede.\nInni lå flere egg trygt sammen. Men det var en tom plass i midten.\nEn stor dinosaurmor gikk urolig rundt redet.\nEtt av eggene hennes var borte.": "Lumi ran ahead, and {name} followed all the way to a huge nest.\nInside, several eggs lay safely together. But there was an empty space in the middle.\nA big mother dinosaur circled the nest, worried.\nOne of her eggs was gone.",
  "{name} satte seg på huk og så nøye på bakken.\nI den myke jorda lå det ferske fotavtrykk.\nVed siden av dem gikk et bredt slepespor.\n«Egget er ikke borte,» sa {name}. «Det har blitt flyttet.»": "{name} crouched down and looked closely at the ground.\nFresh footprints were pressed into the soft earth.\nBeside them ran a wide dragging mark.\n\"The egg isn't lost,\" said {name}. \"It has been moved.\"",
  "Sporene førte inn i en mørkere del av dalen.\nHer var trærne tettere, og lyden av elven var langt unna.\nPlutselig raslet det i buskene foran dem.\n{name} og Lumi stoppet helt stille.": "The tracks led into a darker part of the valley.\nHere the trees grew closer, and the sound of the river was far away.\nSuddenly the bushes ahead of them rustled.\n{name} and Lumi stopped completely still.",
  "En rask dinosaur med fjær hoppet frem mellom bladene.\nDen så på {name} et lite øyeblikk. Så snudde den og løp.\n«Etter den!» ropte Lumi.\nOg så bar det av gårde gjennom jungelen.": "A fast, feathered dinosaur leapt out from between the leaves.\nIt looked at {name} for a moment. Then it turned and ran.\n\"After it!\" shouted Lumi.\nAnd off they went through the jungle.",
  "Jakten gikk over falne trær og langs den brusende elven.\nDen fremmede dinosauren så seg tilbake igjen og igjen.\nNesten som om den ville at de skulle følge etter.\n{name} begynte å lure. Kanskje den ikke rømte i det hele tatt?": "The chase went over fallen trees and along the rushing river.\nThe strange dinosaur kept glancing back, again and again.\nAlmost as if it wanted them to follow.\n{name} began to wonder. Maybe it wasn't running away at all?",
  "Nede ved elvebredden fant de det. Det savnede egget.\nDet hadde ikke blitt stjålet i det hele tatt.\nEgget hadde trillet ned fra redet og satt fast mellom steinene.\nOg den fremmede dinosauren hadde passet på det hele tiden.": "Down by the riverbank they found it. The missing egg.\nIt had never been stolen at all.\nThe egg had rolled down from the nest and was stuck between the stones.\nAnd the strange dinosaur had been guarding it the whole time.",
  "Et dypt drønn rullet ned fra fjellene.\nElven begynte å stige, og vannet ble stridt og kaldt.\nEgget vippet der det sto.\nDe måtte få det opp med en gang.": "A deep rumble rolled down from the mountains.\nThe river began to rise, and the water turned fast and cold.\nThe egg tilted where it stood.\nThey had to get it out right away.",
  "{name} tok av seg ryggsekken og tenkte fort.\nGreiner, mose og et flatt stykke bark ble til en liten slede.\n«Dere drar, så løfter jeg,» sa {name}.\nLumi og den fremmede dinosauren stilte seg klare.": "{name} took off the backpack and thought quickly.\nBranches, moss and a flat piece of bark became a little sled.\n\"You pull, and I'll lift,\" said {name}.\nLumi and the strange dinosaur got ready.",
  "En stor bølge kom brusende nedover elven.\nEgget begynte å rulle mot vannet.\nI siste liten strakte {name} seg frem og fikk tak.\nLumi og den fremmede dro til, og egget var trygt.": "A big wave came rushing down the river.\nThe egg started to roll toward the water.\nAt the last second {name} reached out and caught hold.\nLumi and the stranger pulled hard, and the egg was safe.",
  "Sammen dro de egget forsiktig oppover stien.\nDen fremmede dinosauren gikk foran og viste vei.\nLangt der fremme sto dinosaurmoren og speidet.\nDa hun fikk øye på egget, løftet hun hodet og ropte av glede.": "Together they carefully hauled the egg back up the path.\nThe strange dinosaur walked in front and showed the way.\nFar ahead, the mother dinosaur stood watching.\nWhen she spotted the egg, she lifted her head and called out with joy.",
  "Egget ble lagt forsiktig tilbake i redet.\nDa begynte skallet å sprekke, helt av seg selv.\nEn liten baby-triceratops tittet ut og så rett på {name}.\nAlle sto helt stille. Dette var det fineste {name} hadde sett.": "The egg was placed gently back in the nest.\nThen the shell began to crack, all on its own.\nA tiny baby triceratops peeked out and looked straight at {name}.\nEveryone stood still. This was the most beautiful thing {name} had ever seen.",
  "Solen gikk ned i gult og rosa da Lumi fulgte {name} tilbake til portalen.\n«Takk for at du kom,» sa Lumi. «Du kom akkurat i tide.»\n{name} vinket farvel og tok steget hjem.\nMen langt borte sendte en gammel vulkan en tynn stripe røyk opp mot himmelen.": "The sun set in gold and pink as Lumi walked {name} back to the portal.\n\"Thank you for coming,\" said Lumi. \"You arrived just in time.\"\n{name} waved goodbye and stepped back home.\nBut far away, an old volcano sent a thin ribbon of smoke up into the sky.",
  "Denne boken handler om å hjelpe. Om å stoppe opp, se ordentlig etter og forstå at ting ikke alltid er slik de ser ut ved første blikk.\nNår et dinosauregg forsvinner fra redet, drar {name} og vennen Lumi ut i dalen for å finne det. Jakten fører dem til en fremmed dinosaur – og til en sannhet ingen hadde ventet.\nEn varm og spennende historie om vennskap, samarbeid og om å tørre å stole på noen man ikke kjenner.\nEn bok som gir mot, glede – og minner barnet på at de kan utgjøre en forskjell.": "This book is about helping. About stopping, looking properly, and understanding that things are not always what they seem at first glance.\nWhen a dinosaur egg disappears from the nest, {name} and their friend Lumi set out into the valley to find it. The chase leads them to a strange dinosaur – and to a truth no one expected.\nA warm and exciting story about friendship, teamwork and daring to trust someone you don't know.\nA book that gives courage, joy – and reminds the child that they can make a difference.",
}
