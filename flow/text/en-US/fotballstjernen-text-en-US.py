...
_DREAMPAGE_TRANSLATIONS = {
  ...
  "{name} sto på banen med ballen ved foten og kjente gresset kile under skoene.\nHan hadde drømt om å bli en ekte fotballstjerne så lenge han kunne huske.\n\nI dag virket målet litt nærmere enn før. Han trakk pusten dypt og hvisket: «Jeg skal prøve så godt jeg kan.»": "{name} stood on the field with the ball at his feet and felt the grass tickle under his shoes.\nHe had dreamed of becoming a real soccer star for as long as he could remember.\n\nToday the goal seemed a little closer than before. He took a deep breath and whispered, \"I'll try my best.\"",
  "{name} så opp mot lyset som skinte over banen.\nDet glitret i gresset, og hele stedet føltes som starten på noe viktig.\n\nHan tenkte på alle gangene han hadde sparket ball i hagen, bommet, ledd og prøvd igjen. Kanskje var det nettopp slik store drømmer begynte.": "{name} looked up at the light shining across the field.\nThe grass sparkled, and the whole place felt like the start of something important.\n\nHe thought of all the times he had kicked a ball in the garden, missed, laughed and tried again. Perhaps that was precisely how big dreams began.",
  ...
  "Treneren kom bort og satte seg rolig ved siden av {name}.\n«Vet du hva de beste spillerne gjør når de bommer?» spurte han. «De prøver én gang til.»\n\n{name} så opp. Treneren smilte varmt. «Jeg tror på deg.» Da kjente {name} motet vende tilbake, lite først, men sterkere for hvert sekund.": "The coach came over and calmly sat down next to the {name}.\n\"Do you know what the best players do when they miss?\" he asked. \"They try one more time.\"\n\n{name} looked up. The coach smiled warmly. \"I believe in you.\" Then {name} felt his courage return, little at first, but stronger every second.",
  ...
  "{name} lyttet nøye da treneren begynte å lese opp navnene.\nEtt navn kom, så et til, og så enda et.\n\nHan knyttet hendene rundt kanten av benken. Da treneren tok en liten pause, holdt {name} pusten og ventet på ordene som kunne forandre hele dagen.": "{name} listened carefully as the coach began to read out the names.\nOne name came, then another, and then another.\n\nHe clasped his hands around the edge of the bench. When the coach took a short break, {name} held his breath and waited for the words that could change his entire day.",
  "Plutselig hørte han navnet sitt.\n«{name}, du er med i finalen,» sa treneren tydelig.\n\nFørst satt {name} helt stille. Så kjente han smilet vokse, større og større, helt til han nesten ikke klarte å sitte i ro.": "Suddenly he heard his name.\n\"{name}, you're in the finals,\" the coach said plainly.\n\nAt first {name} sat completely still. Then he felt his smile grow, bigger and bigger, until he could hardly sit still.",
