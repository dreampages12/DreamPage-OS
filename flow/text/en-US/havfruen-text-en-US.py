        ...
        # Side 13 – lyset vender tilbake → tekst VENSTRE
        {
            ...
            "blocks": [{
                "text": p(
                    ...
                    "\n"
                    "The corals got their colors back, the streets lit up, and the fish came out again. Mermaids cheered across the kingdom. (Navn) had saved them all."
                ),
                "font_size": 30,
                "color": "#FFFFFF",
