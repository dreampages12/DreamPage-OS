...
def render_dreampage_first(child_name: str, out_dir: str) -> str:
    ...
    title_line = f"To {child_name}"
    body_lines = [
        "This book was made just for you.",
        f"You are {child_name} - the hero of the story.",
        "",
        "Inside you lives a hidden power,",
        "warm, bright, and braver than you know.",
        "",
        "Trust yourself, even when things feel big,",
        "just like you do in this adventure.",
    ]
...
# --- DreamPage translated text table (en-GB) ---
_DREAMPAGE_TRANSLATIONS = {'{name} og\nDen skjulte styrken': '{name} and\nThe Hidden Power',
 'Det var en helt vanlig morgen, av den typen der sola kiler i øynene og lufta lukter ny dag. {name} gikk den samme veien til skolen som alltid, men i dag føltes alt litt ekstra spennende.\nSekken dunket lett mot ryggen, og inni magen kriblet det av forventning. For i dag skulle hele klassen på tur, og det hadde {name} gledet seg til i ukevis.': 'It '
                                                                                                                                                                                                                                                                                                                                                            'started '
                                                                                                                                                                                                                                                                                                                                                            'like '
                                                                                                                                                                                                                                                                                                                                                            'any '
                                                                                                                                                                                                                                                                                                                                                            'other '
                                                                                                                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                                                                                                                            'secret '
                                                                                                                                                                                                                                                                                                                                                            'warning.',
 'Plutselig stoppet {name} midt i steget. En merkelig lyd kom fra et smalt smug ved siden av gata, som en svak summing blandet med et fjernt klingende ekko.\n{name} klarte ikke å la være. Han gikk forsiktig nærmere, helt til han kikket inn i mørket. Der, midt i lufta, glødet noe varmt og oransje. Hva i all verden kunne det være?': 'A '
                                                                                                                                                                                                                                                                                                                                             'whisper '
                                                                                                                                                                                                                                                                                                                                             'drifted '
                                                                                                                                                                                                                                                                                                                                             'from '
                                                                                                                                                                                                                                                                                                                                             'a '
 ...
 '{name} løp så fort han kunne bort fra smuget, mens hjertet banket hardt i brystet. Han var redd, helt skikkelig redd.\n«Jeg er ikke klar for dette,» hvisket {name} til seg selv. «Jeg er jo bare en helt vanlig gutt.»\nInni seg kjente han både tårer og en liten klump av sinne. Hvorfor måtte det være akkurat han som var den utvalgte?': '{name} '
                                                                                                                                                                                                                                                                                                                                                 ...
                                                                                                                                                                                                                                                                                                                                                 'grew '
                                                                                                                                                                                                                                                                                                                                                 'brighter.',
 '{name} klatret opp til favorittstedet sitt. Derfra kunne han se utover hele byen.\nHan sto stille og tenkte. Langt der nede så han mørke skygger bevege seg sakte mot sentrum.\nVar det dette hologrammet hadde ment? Skulle han virkelig redde byen alene?': '{name} '
                                                                                                                                                                                                                                                                'climbed '
                                                                                                                                                                                                                                                                'to '
                                                                                                                                                                                                                                                                'his '
                                                                                                                                                                                                                                                                'secret '
 ...
 'Nå sto {name} rett foran det sterke lyset, så nær at han kjente varmen mot kinnene. Dette var øyeblikket hologrammet hadde snakket om.\n{name} stilte seg støtt på bakken, knyttet nevene hardt og gjorde seg klar til å kjempe.': 'The '
                                                                                                                                                                                                                                     ...
                                                                                                                                                                                                                                     'he '
                                                                                                                                                                                                                                     'stayed.',
 'Mørket samlet seg foran {name} og vokste til en høy skygge midt i gata. Den vred seg i luften, som om den var laget av røyk og torden.\n{name} kjente redselen prikke i hendene, men han ble stående. Inni brystet våknet en varm styrke, og han visste at han måtte holde ut litt til.': 'A '
                                                                                                                                                                                                                                                                                            'giant '
                                                                                                                                                                                                                                                                                            'shadow '
                                                                                                                                                                                                                                                                                            'rose '
                                                                                                                                                                                                                                                                                            'from '
                                                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                                                            'to '
                                                                                                                                                                                                                                                                                            'glow.',
 '{name} strakte begge armene rett opp mot lyset og knyttet nevene så hardt han kunne.\nPlutselig sprutet et sterkt, blått lys ut av hendene hans og traff den mørke skyggen med et kraftig BANG som fikk hele byen til å riste.': '{name} '
                                                                                                                                                                                                                                   'stretched '
                                                                                                                                                                                                                                   'both '
                                                                                                                                                                                                                                   'hands '
                                                                                                                                                                                                                                   'toward '
                                                                                                                                                                                                                                   ...
                                                                                                                                                                                                                                   'the '
                                                                                                                                                                                                                                   'street.',
 'Takket være {name} var byen trygg igjen. Lyset var borte, skyggene forsvunnet, og menneskene begynte å smile.\n{name} hadde alltid trodd at han bare var en vanlig gutt. Men nå visste han noe viktig: han var en ekte superhelt.': 'The '
                                                                                                                                                                                                                                      'shadow '
                                                                                                                                                                                                                                      'shattered '
                                                                                                                                                                                                                                      'into '
                                                                                                                                                                                                                                      'sparks '
 ...
 'Plutselig dukket hologrammet opp igjen, lysende svakt og vennlig i lufta foran ham.\n«Veldig bra jobbet, {name},» sa hologrammet stolt. «Hvis byen trenger hjelp igjen, finner jeg deg.»\n{name} smilte. «Jeg er alltid klar.»': 'The '
                                                                                                                                                                                                                                   ...
                                                                                                                                                                                                                                   'helped '
                                                                                                                                                                                                                                   'anyway."',
 '{name} tok et siste blikk utover byen. Alt var stille nå, og lysene blinket fredelig i kveldsmørket.\nHan tenkte på alt som hadde skjedd. {name} smilte, for innerst inne visste han noe viktig: Det var han som var den utvalgte.': '{name} '
                                                                                                                                                                                                                                       'looked '
                                                                                                                                                                                                                                       'over '
                                                                                                                                                                                                                                       'the '
                                                                                                                                                                                                                                       'quiet '
                                                                                                                                                                                                                                       ...
                                                                                                                                                                                                                                       'use '
                                                                                                                                                                                                                                       'it.',
 '{name} hadde byttet tilbake til sine vanlige klær og gikk den samme veien til skolen som alltid.\nKlassen var allerede på tur, og han hadde gått glipp av den. «Litt kjipt,» lo {name}. «Men nå har jeg en helt utrolig historie å fortelle vennene mine.»': 'Then '
                                                                                                                                                                                                                                                               '{name} '
                                                                                                                                                                                                                                                               'changed '
                                                                                                                                                                                                                                                               'back '
                                                                                                                                                                                                                                                               'into '
                                                                                                                                                                                                                                                               ...
                                                                                                                                                                                                                                                               'he '
                                                                                                                                                                                                                                                               'said.',
 'Denne boken handler om mot – om å være redd og likevel våge å prøve. Den viser at helter ikke alltid er store og sterke, men ofte vanlige barn som finner styrken i seg selv når det virkelig gjelder.\nDerfor er det {name} som er helten i denne historien. En personlig fortelling som gir barn trygghet, selvtillit og troen på seg selv.': 'A '
                                                                                                                                                                                                                                                                                                                                                  'fast, '
                                                                                                                                                                                                                                                                                                                                                  'magical '
                                                                                                                                                                                                                                                                                                                                                  'story '
                                                                                                                                                                                                                                                                                                                                                  'about '
                                                                                                                                                                                                                                                                                                                                                  ...
                                                                                                                                                                                                                                                                                                                                                  'at '
                                                                                                                                                                                                                                                                                                                                                  'once.'}
_DREAMPAGE_EN_HIGHLIGHTS = {'01(styrken).png': ['morning', 'backpack', 'buzz', 'orange', 'light', 'warning'],
 '02(styrken).png': ['whisper', 'alley', 'shadows', 'glowing', 'spark', 'sun'],
 '03(styrken).png': ['spark', 'hologram', 'superhero', 'suit', 'danger', 'darkness'],
 '04(styrken).png': ['heart', 'thumping', 'powerful', 'ordinary', 'shook', 'brighter'],
 '05(styrken).png': ['secret', 'lookout', 'storm', 'shadows', 'run', 'help'],
 '06(styrken).png': ['suit', 'sky', 'flash', 'blue', 'gold', 'WHOOSH'],
 '07(styrken).png': ['orange', 'beam', 'trembled', 'worried', 'brave', 'help'],
 '08(styrken).png': ['beam', 'fire', 'Heat', 'fists', 'breath', 'stayed'],
 '09(styrken).png': ['giant', 'shadow', 'smoke', 'thunder', 'Fear', 'glow'],
 '10(styrken).png': ['darkness', 'Blue', 'light', 'palms', 'shadow', 'CRACK'],
 '11(styrken).png': ['shattered', 'sparks', 'orange', 'lights', 'cheered', 'rooftops'],
 '12(styrken).png': ['hologram', 'proud', 'brave', 'fear', 'helped', 'anyway'],
 '13(styrken).png': ['quiet', 'truth', 'hidden', 'power', 'inside', 'dared'],
 '14(styrken).png': ['normal', 'school', 'missed', 'trip', 'smiling', 'story'],
 'bakside(styrken).png': ['magical', 'courage', 'fear', 'power', 'bravery', 'heroes', 'strength']}
...
def _dreampage_name_highlights(child_name: str) -> list[str]:
    parts = [child_name]
    parts.extend(part for part in child_name.replace("-", " ").split() if part)
...
def build_pages(child_name: str):
    ...
    name_highlights = _dreampage_name_highlights(child_name)
    for page in pages:
        ...
        for block in page.get("blocks") or []:
            ...
            if filename in _DREAMPAGE_EN_HIGHLIGHTS:
                merged = []
                for word in [*_DREAMPAGE_EN_HIGHLIGHTS[filename], *name_highlights]:
                    if word and word not in merged:
                        merged.append(word)
                block["highlights"] = merged
