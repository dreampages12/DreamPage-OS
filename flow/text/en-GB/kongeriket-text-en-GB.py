    ...
    if page.get("type") == "blank":
        ...
        for block in page.get("blocks", []):
            ...
            draw_text(
                ...
                # draw_text sin standard er 10 PIKSLER, satt da sidene var
                # smaa. Paa en 4096 px side ble linjene klistret sammen under
                # tittelen (19.09.2026). Luften maa foelge skriftstoerrelsen.
                line_spacing=max(10, int(font_size * 0.42)),
                highlights=block.get("highlights", []),
                gradient=None,
                img=img,
                align="center"
