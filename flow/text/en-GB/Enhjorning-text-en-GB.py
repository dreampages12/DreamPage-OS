    ...
    story: List[Dict[str, Any]] = [
        {
            ...
            "side": "left",
            "block": story_block(
                "One ordinary afternoon, (navn) walked through the woods.\n"
                "There, in the soft ground, lay something strange.\n"
                "Small hoofprints, one after the other.\n"
                "And every single print shimmered faintly like silver."
                ,
                child_name,
                ["hoofprints", "shimmered", "silver", "strange"],
                side="left",
            ),
        },
        {
            ...
            "side": "right",
            "block": story_block(
                "(navn) followed the prints deeper into the forest.\n"
                "Tiny lights drifted between the trees, and strange flowers opened.\n"
                "At last the hoofprints stopped before a tall waterfall.\n"
                "Behind the water, something glowed faint and golden."
                ,
                child_name,
                ["prints", "lights", "flowers", "waterfall", "golden"],
                side="right",
            ),
        },
        # Side 3 - venstre kvadrat (statisk handbilde, baerer teksten)
        {
            ...
            "block": story_block(
                "(navn) reached a hand carefully into the waterfall.\n"
                "The water was warm, and it glittered around her fingers.\n"
                "Behind the falls lay a narrow tunnel in the rock.\n"
                "(navn) walked through, and the whole valley opened up."
                ,
                child_name,
                ["hand", "waterfall", "glittered", "tunnel", "valley"],
                side="left",
            ),
        },
        ...
        },
        {
            ...
            "side": "right",
            "block": story_block(
                "A little unicorn came running through the flowers.\n"
                "It stopped right in front of (navn) and looked at her.\n"
                "But its horn was glowing only faintly.\n"
                "Then the ground shook, and a deep rumble rolled off the mountains."
                ,
                child_name,
                ["unicorn", "horn", "faintly", "rumble"],
                side="right",
            ),
        },
        {
            ...
            "side": "left",
            "block": story_block(
                "The unicorn ran towards a wide, clear lake.\n"
                "Three glowing star stones floated above the water.\n"
                "One blue, one green and one purple.\n"
                "But the place where the fourth belonged was dark."
                ,
                child_name,
                ["lake", "star stones", "blue", "green", "purple", "dark"],
                side="left",
            ),
        },
        {
            ...
            "side": "right",
            "block": story_block(
                "The oldest unicorn stepped down to the water's edge.\n"
                "Its horn shone, and a picture appeared in the lake.\n"
                "(navn) saw a dark figure slipping between the trees.\n"
                "The fourth star stone had been stolen."
                ,
                child_name,
                ["oldest", "horn", "picture", "figure", "stolen"],
                side="right",
            ),
        },
        {
            ...
            "side": "left",
            "block": story_block(
                "Without the stone, the magic of the valley would fade.\n"
                "The little unicorn stamped its hoof, firm and certain.\n"
                "Together they followed a trail of black, glittering marks.\n"
                "The trail led them far away from the lake."
                ,
                child_name,
                ["magic", "firm", "trail", "marks"],
                side="left",
            ),
        },
        {
            ...
            "side": "right",
            "block": story_block(
                "The path took them into the Crystal Forest.\n"
                "Huge see-through trees threw rainbows across the ground.\n"
                "Suddenly the branches began to move.\n"
                "The path behind them vanished, and they were trapped."
                ,
                child_name,
                ["Crystal Forest", "rainbows", "branches", "trapped"],
                side="right",
            ),
        },
        {
            ...
            "side": "left",
            "block": story_block(
                "(navn) found the dark marks again on the ground.\n"
                "They followed them all the way out the other side.\n"
                "Before them lay a deep ravine.\n"
                "On its edge stood a little house, glowing in the dusk."
                ,
                child_name,
                ["marks", "ravine", "little house", "glowing"],
                side="left",
            ),
        },
        {
            ...
            "side": "right",
            "block": story_block(
                "An old stone bridge stretched across the ravine.\n"
                "Carefully they stepped out onto the ancient stones.\n"
                "Halfway over came another rumble, and the stones cracked.\n"
                "(navn) only just made it to the other side."
                ,
                child_name,
                ["stone bridge", "ravine", "rumble", "cracked"],
                side="right",
            ),
        },
        {
            ...
            "side": "left",
            "block": story_block(
                "Inside the house the star stone rested on a pillar.\n"
                "(navn) lifted it up, very carefully.\n"
                "All at once the whole room lit up.\n"
                "On the wall appeared a great symbol: a black crescent moon."
                ,
                child_name,
                ["star stone", "pillar", "lit up", "crescent moon"],
                side="left",
            ),
        },
        {
            ...
            "side": "right",
            "block": story_block(
                "They hurried back to the lake.\n"
                "As the stone slid into place, four beams shot into the sky.\n"
                "Magic came flooding back through the whole valley.\n"
                "The flowers woke, and the rivers sparkled again."
                ,
                child_name,
                ["beams", "Magic", "woke", "sparkled"],
                side="right",
            ),
        },
        {
            ...
            "side": "left",
            "block": story_block(
                "The whole herd gathered around (navn).\n"
                "The oldest unicorn bowed its head towards her.\n"
                "A small silver mark began to glow on her hand.\n"
                "(navn) had become a friend of Unicorn Valley."
                ,
                child_name,
                ["herd", "oldest", "silver mark", "friend"],
                side="left",
            ),
        },
        {
            ...
            "side": "right",
            "block": story_block(
                "That evening (navn) was home again.\n"
                "But outside the house lay a black, glittering trail.\n"
                "Beside it lay a stone with a black crescent moon.\n"
                "And far away, something purple glowed between the mountains."
                ,
                child_name,
                ["home", "trail", "crescent moon", "purple"],
                side="right",
            ),
        },
    ]
    pages: List[Dict[str, Any]] = [
        ...
        {"filename": "ryggrad.png", "type": "cover"},
        {
            ...
            "blocks": [
                {
                    "text": pformat(
                        "This book was made especially for you, (Navn).\n"
                        "You are the hero of an adventure full of colour, courage and magic.\n"
                        "May the story remind you that your heart knows the way.",
                        child_name,
                    ),
                    "font_size": 116,
                    "color": "#17121F",
        ...
        [
            ...
            },
            {
                ...
                "blocks": [
                    {
                        "text": pformat(
                            "When (navn) found glittering hoofprints in the woods, they led to a valley no one knew about.\n"
                            "In the Unicorn Valley one of the four star stones has been stolen, and the magic is fading.\n"
                            "Together with a little unicorn, (navn) follows a dark trail through the Crystal Forest, across a cracking stone bridge and into a little house in the mountain.\n"
                            "A personal story about courage, friendship and daring to follow the trail you see.\n"
                            "Some adventures are real after all.",
                            child_name,
                        ),
                        "font_size": 82,
                        "color": "#FFFFFF",
...
_DREAMPAGE_TRANSLATIONS = {
  "{name} og\nEnhjørningsdalen": "{name} and\nUnicorn Valley",
  "Denne boken er laget spesielt for deg, {name}.\nDu er helten i et eventyr fylt med farger, mot og magi.\nMå historien minne deg på at hjertet ditt vet veien.": "This book is made especially for you, {name}.\nYou are the hero of an adventure filled with colour, courage and magic.\nMay history remind you that your heart knows the way.",
  "Det var en gang en jente som het {name}.\nHun elsket farger, fantasi og historier om skjulte verdener.\nOfte føltes det som om noe ventet på henne.\nSom om eventyret bare manglet det riktige øyeblikket.": "Once upon a time there was a girl named {name}.\nShe loved colours, fantasy and stories about hidden worlds.\nOften it felt as if something was waiting for her.\nAs if the adventure just lacked the right moment.",
  "En dag oppdaget {name} noe uvanlig.\nEt svakt spor av regnbuefarger lyste foran henne.\nDet var nesten usynlig, men hun kunne se det.\nOg det føltes som om sporet kalte på henne.": "One day {name} noticed something unusual.\nA faint trail of rainbow colours shone before her.\nIt was almost invisible, but she could see it.\nAnd it felt like the track was calling her.",
  "{name} stoppet opp og tenkte seg om.\nHun kunne snu og gå tilbake, akkurat som før.\nEller hun kunne følge sporet videre.\nHjertet hennes banket litt raskere.": "{name} paused and thought about it.\nShe could turn and go back, just like before.\nOr she could follow the trail further.\nHer heart beat a little faster.",
  "Da {name} tok et steg frem, skjedde det noe.\nLuften rundt henne forandret seg.\nFargene ble sterkere og klarere enn før.\nHun visste at hun hadde funnet noe hemmelig.": "When {name} took a step forward, something happened.\nThe air around her changed.\nThe colours became stronger and clearer than before.\nShe knew she had found something secret.",
  "Foran {name} åpnet det seg en dal.\nEn dal full av lys, liv og farger.\nHun hadde aldri sett noe lignende.\nDet var som om verden smilte til henne.": "In front of the {name}, a valley opened up.\nA valley full of light, life and colour.\nShe had never seen anything like it.\nIt was as if the world was smiling on her.",
  "Plutselig kjente {name} at hun ikke var alene.\nNoe beveget seg stille i det fjerne.\nHun ble ikke redd, bare nysgjerrig.\nDette stedet føltes trygt og riktig.": "Suddenly {name} felt she was not alone.\nSomething moved quietly in the distance.\nShe wasn't scared, just curious.\nThis place felt safe and right.",
  "Da fikk {name} øye på dem.\nEnhjørningene kom rolig frem, én etter én.\nDe så på henne med kloke, vennlige øyne.\nSom om de hadde ventet på akkurat henne.": "Then {name} spotted them.\nThe unicorns came forward calmly, one by one.\nThey looked at her with wise, friendly eyes.\nAs if they had been waiting for her.",
  "Enhjørningene fortalte om dalen.\nDette stedet var hemmelig og sårbart.\nBare noen få fikk lov til å se det.\nOg nå hvilte ansvaret hos {name}.": "The unicorns told about the valley.\nThis place was secret and vulnerable.\nOnly a few were allowed to see it.\nAnd now the responsibility rested with {name}.",
  "{name} kjente en uro i magen.\nHva om hun ikke var god nok?\nHva om hun gjorde noe feil?\nHun så rundt seg og tok et dypt pust.": "{name} felt an uneasiness in his stomach.\nWhat if she wasn't good enough?\nWhat if she did something wrong?\nShe looked around and took a deep breath.",
  "Da lyttet {name} til hjertet sitt.\nHun visste ikke alt, men hun visste én ting.\nHun ville gjøre det rette.\nOg noen ganger er det nok.": "Then {name} listened to his heart.\nShe didn't know everything, but she knew one thing.\nShe wanted to do the right thing.\nAnd sometimes that's enough.",
  "Plutselig glødet dalen sterkere igjen.\nFargene blomstret rundt {name}.\nLyset vendte tilbake, klarere enn før.\nValget hennes hadde betydd noe.": "Suddenly the valley glowed more brightly again.\nThe colours bloomed around the {name}.\nThe light returned, brighter than before.\nHer choice had mattered.",
  "Enhjørningene samlet seg rundt {name}.\nDe stolte på henne nå.\nHun følte seg rolig og stolt.\nIkke fordi hun var perfekt, men fordi hun hadde våget.": "The unicorns gathered around the {name}.\nThey trusted her now.\nShe felt calm and proud.\nNot because she was perfect, but because she had dared.",
  "Det var på tide å dra tilbake.\n{name} visste at hun ikke trengte å være trist.\nNoen farvel betyr ikke slutten.\nDe betyr at noe viktig alltid vil være med deg.": "It was time to go back.\n{name} knew she didn't have to be sad.\nSome goodbyes don't mean the end.\nThey mean that something important will always be with you.",
  "Verden utenfor så nesten lik ut som før.\nMen {name} var ikke den samme.\nHun bar en hemmelighet i hjertet sitt.\nNoen eventyr er ekte, selv når ikke alle kan se dem.": "The world outside looked almost the same as before.\nBut the {name} was not the same.\nShe carried a secret in her heart.\nSome fairy tales are real, even when not everyone can see them.",
  "Denne boken handler om å oppdage noe bare noen få kan se.\nOm å følge et spor når hjertet sier at noe er viktig.\nDen handler om stille mot, om å ta valg og om å ta vare på en hemmelighet.\nI denne historien er det {name} som blir valgt, fordi hun tør å lytte til seg selv.\nEn personlig fortelling som gir barn trygghet, selvtillit og troen på at noen eventyr er ekte.": "This book is about discovering something that only a few can see.\nAbout following a trail when the heart says something is important.\nIt is about quiet courage, about making choices and about keeping a secret.\nIn this story, {name} is chosen because she dares to listen to herself.\nA personal story that gives children security, self-confidence and the belief that some fairy tales are real."
}
