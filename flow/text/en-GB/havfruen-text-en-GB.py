    ...
    pages: List[Dict[str, Any]] = [
        ...
        # Side 1 – det mystiske skjellet → tekst VENSTRE
        {
            ...
            "blocks": [{
                ...
                "font_size": 30,
                "color": "#FFFFFF",
                "highlights": [child_name, "shell", "glittered"],
                "x_offset": 0,
                "y_offset": -10,
            }],
        },
        ...
        # Side 2 – stemmen fra havet → tekst HØYRE
        {
            ...
            "blocks": [{
                ...
                "font_size": 29,
                "color": "#FFFFFF",
                "highlights": [child_name, "voice", "mermaid"],
                "x_offset": 10,
                "y_offset": -10,
                "width_offset": -10,
            }],
        ...
        # Side 3 – den skjulte lagunen → tekst VENSTRE
        {
            ...
            "blocks": [{
                ...
                "font_size": 29,
                "color": "#FFFFFF",
                "highlights": [child_name, "lagoon", "secret"],
                "x_offset": 0,
                "y_offset": -10,
            }],
        },
        ...
        # Side 4 – den magiske perlen → tekst HØYRE
        {
            ...
            "blocks": [{
                "text": p(
                    ...
                    "\n"
                    "(Navn) reached out carefully. The moment her fingertips touched the pearl, the whole lagoon began to sparkle."
                ),
                "font_size": 29,
                "color": "#FFFFFF",
                "highlights": [child_name, "pearl", "magic"],
                "x_offset": 10,
                "y_offset": -10,
                "width_offset": -10,
            }],
        ...
        # Side 5 – (Navn) blir havfrue → tekst VENSTRE
        {
            ...
            "blocks": [{
                ...
                "font_size": 30,
                "color": "#FFFFFF",
                "highlights": [child_name, "tail", "mermaid"],
                "x_offset": 0,
                "y_offset": -10,
            }],
        },
        ...
        # Side 6 – den forste svommeturen → tekst VENSTRE
        {
            ...
            "blocks": [{
                "text": p(
                    ...
                    "\n"
                    "She swam past colourful fish, tall corals and bubbles that danced around her.\n"
                    "\n"
                    "(Navn) had never felt so light and free."
                ),
                "font_size": 29,
                "color": "#FFFFFF",
                "highlights": [child_name, "corals", "free"],
                "x_offset": 0,
                "y_offset": -10,
            }],
        },
        ...
        # Side 7 – havfruenes rike → tekst VENSTRE
        {
            ...
            "blocks": [{
                ...
                "font_size": 29,
                "color": "#FFFFFF",
                "highlights": [child_name, "kingdom", "beautiful"],
                "x_offset": 0,
                "y_offset": -10,
            }],
        },
        ...
        # Side 8 – noe er galt → tekst HØYRE
        {
            ...
            "blocks": [{
                "text": p(
                    ...
                    "\n"
                    "The corals had lost their colours, and the fish were hiding among the stones.\n"
                    "\n"
                    "«The magic of the sea is fading,» said the mermaid. «If we don't find the cause, the whole kingdom will go dark.»"
                ),
                "font_size": 29,
                "color": "#FFFFFF",
                "highlights": [child_name, "magic", "dark"],
                "x_offset": 10,
                "y_offset": -10,
                "width_offset": -10,
            }],
        ...
        # Side 9 – den morke passasjen → tekst VENSTRE
        {
            ...
            "blocks": [{
                ...
                "font_size": 29,
                "color": "#FFFFFF",
                "highlights": [child_name, "tunnel", "help"],
                "x_offset": 0,
                "y_offset": -10,
            }],
        },
        ...
        # Side 10 – havskilpadden → tekst VENSTRE
        {
            ...
            "blocks": [{
                "text": p(
                    ...
                    "\n"
                    "Together they pushed the rocks aside. The turtle swam a grateful circle around (Navn) and nodded her head. She wanted them to follow."
                ),
                "font_size": 29,
                "color": "#FFFFFF",
                "highlights": [child_name, "turtle", "help"],
                "x_offset": 0,
                "y_offset": -10,
            }],
        },
        ...
        # Side 11 – den hemmelige hulen → tekst VENSTRE
        {
            ...
            "blocks": [{
                "text": p(
                    ...
                    "\n"
                    "When the turtle swam towards it, the symbols began to glow.\n"
                    "\n"
                    "A hidden opening appeared — into a cave no one had visited for a very long time."
                ),
                "font_size": 29,
                "color": "#FFFFFF",
                "highlights": [child_name, "symbols", "cave"],
                "x_offset": 0,
                "y_offset": -10,
            }],
        },
        ...
        # Side 12 – havets hjerte → tekst VENSTRE
        {
            ...
            "blocks": [{
                "text": p(
                    ...
                    "\n"
                    "Then the shell in (Navn)'s hand began to glow. She held it closer, and the two lights answered each other."
                ),
                "font_size": 30,
                "color": "#FFFFFF",
                "highlights": [child_name, "crystal", "Heart"],
                "x_offset": 0,
                "y_offset": 200,
            }],
        },
        ...
        # Side 13 – lyset vender tilbake → tekst VENSTRE
        {
            ...
            "blocks": [{
                "text": p(
                    ...
                    "\n"
                    "The corals got their colours back, the streets lit up, and the fish came out again. Mermaids cheered across the kingdom. (Navn) had saved them all."
                ),
                "font_size": 30,
                "color": "#FFFFFF",
                "highlights": [child_name, "light", "saved"],
                "x_offset": 0,
                "y_offset": -10,
            }],
        },
        ...
        # Side 14 – en ny hemmelighet → tekst HØYRE
        {
            ...
            "blocks": [{
                "text": p(
                    ...
                    "\n"
                    "Just then the Heart of the Sea flashed again. A beam of light shot out into the dark water, and far away lights came on in an ancient palace.\n"
                    "\n"
                ...
                "font_size": 28,
                "color": "#FFFFFF",
                "highlights": [child_name, "palace", "adventure"],
                "x_offset": 10,
                "y_offset": -10,
                "width_offset": -10,
            }],
        ...
        # Bakside
        {
            ...
            "blocks": [{
                "text": p(
                    ...
                    "\n"
                    "When (Navn) finds a shell that glows in blue and purple, it opens the door to the secret world of the mermaids. But the magic of the kingdom is fading, and only someone with a true heart for the ocean can wake it again.\n"
                    "\n"
                    "Together with a mermaid and a sea turtle, (Navn) searches for the Heart of the Sea — deep inside a cave no one has visited for a very long time.\n"
                    "\n"
                    "A personal story about courage, friendship and the magic of helping others."
                ),
                "font_size": 38,
                "color": "#FFFFFF",
                "highlights": [child_name, "mermaids", "Heart", "courage", "friendship", "magic"],
            }],
        },
...
def render_dreampage_first(child_name: str, out_dir: str) -> str:
    ...
    body_lines = [
        ...
        "and your imagination that fill these pages.",
        "",
...
_DREAMPAGE_TRANSLATIONS = {
  ...
  "{name} sto barbeint på stranden en varm sommerdag og så utover de blanke bølgene.\nHavet glitret som tusen små stjerner, og langt der ute sang måkene over vannet.\n\nHun hadde alltid lurt på hva som fantes under bølgene. Den dagen lengtet hjertet hennes ekstra sterkt etter et eventyr.": "{name} stood barefoot on the beach on a hot summer day and looked out at the shiny waves.\nThe sea sparkled like a thousand little stars, and far out there the seagulls sang over the water.\n\nShe had always wondered what lay beneath the waves. That day, her heart yearned extra strongly for an adventure.",
  "I sanden glitret noe vakkert.\n{name} bøyde seg ned og fant et skjell som lyste i regnbuens farger.\n\nDa hun løftet det opp mot øret, hørte hun en mild sang.\n\nDet var som om havet selv hvisket til henne.": "Something beautiful glittered in the sand.\n{name} bent down and found a shell that glowed in the colours of the rainbow.\n\nWhen she raised it to her ear, she heard a gentle song.\n\nIt was as if the sea itself was whispering to her.",
  "Plutselig dukket en vennlig havfrue opp i vannkanten.\nHun smilte varmt og rakte hendene mot {name}, som om de allerede kjente hverandre.\n\n«Skjellet du holder er magisk,» sa havfruen mykt. «Det kan gjøre deg til havfrue for én eneste dag, hvis du virkelig ønsker det.»": "Suddenly a friendly mermaid appeared at the water's edge.\nShe smiled warmly and held out her hands to the {name}, as if they already knew each other.\n\n\"The shell you hold is magical,\" the mermaid said softly. \"It can turn you into a mermaid for a single day, if you really want to.\"",
  "{name} holdt skjellet tett inntil hjertet sitt og lukket øynene.\nEt varmt lys begynte å svøpe seg rundt henne, først som sol på huden og så som glitrende bobler.\n\nDa hun åpnet øynene igjen, hadde bena hennes blitt til en skinnende havfruehale i akkurat hennes favorittfarge.": "{name} held the shell close to his heart and closed his eyes.\nA warm light began to wrap around her, first like sun on her skin and then like sparkling bubbles.\n\nWhen she opened her eyes again, her legs had turned into a shiny mermaid tail in exactly her favourite colour.",
  "{name} dykket ned i havet for aller første gang, og alt ble stille og mykt rundt henne.\nForan henne åpnet et stort korallrev seg som en hemmelig by av farger.\n\nFisk i rødt, gull og blått danset mellom korallene. Det var den vakreste verdenen hun noen gang hadde sett.": "{name} dived into the sea for the very first time, and everything became still and soft around her.\nIn front of her, a vast coral reef opened up like a secret city of colours.\n\nFish in red, gold and blue danced between the corals. It was the most beautiful world she had ever seen.",
  "Brått svømte en lekende delfin bort til {name}.\nDen blunket vennlig, laget en liten spiral i vannet og lo med en lys klikkelyd.\n\n«Bli min nye venn,» sa delfinen, «så viser jeg deg hele havets rike.» {name} nikket glad og fulgte etter.": "Suddenly a playful dolphin swam over to the {name}.\nIt winked kindly, made a small spiral in the water and laughed with a bright clicking sound.\n\n\"Become my new friend,\" said the dolphin, \"and I will show you the whole kingdom of the sea.\" {name} nodded happily and followed.",
  "Sammen svømte de inn i en hemmelig hage under havet.\nBlomstene lyste i blått, rosa og fiolett, og små bobler steg opp som perler fra sanden.\n\nPlantene danset stille i strømmen, som om de hilste henne velkommen. {name} lo høyt av bare glede.": "Together they swam into a secret garden under the sea.\nThe flowers shone in blue, pink and violet, and small bubbles rose like pearls from the sand.\n\nThe plants danced quietly in the current, as if welcoming her. {name} laughed out loud with sheer joy.",
  "Litt lenger borte glitret et stort slott av perlemor.\nTårnene var bygget av skjell, koraller og små steiner som lyste i vannet.\n\nAndre havfruer kom svømmende mot {name} og smilte varmt. «Velkommen til havfrueslottet!» ropte de i kor.": "A little further away, a great castle of mother-of-pearl glittered.\nThe towers were built of shells, corals and small stones that shone in the water.\n\nOther mermaids came swimming towards the {name} and smiled warmly. \"Welcome to the mermaid castle!\" they shouted in unison.",
  "Plutselig oppdaget havfruene en bekymret liten babyskilpadde.\nDen hadde gått seg vill og fant ikke mammaen sin.\n\n{name} bøyde seg ned og strøk den forsiktig over skallet.\n\n«Vi skal hjelpe deg hjem,» sa hun bestemt.": "Suddenly, the mermaids spotted a worried little baby turtle.\nIt had gotten lost and couldn't find its mom.\n\nThe {name} bent down and gently stroked it over the shell.\n\n\"We'll help you home,\" she said firmly.",
  "{name} og delfinen svømte gjennom mørke huler der lyset fra perlen blinket på steinveggene.\nStore, rolige hvaler sang dype toner i bakgrunnen, som om de viste vei.\n\nVannet var kjølig, men hjertet hennes var modig. Et sted der ute ventet en mamma på babyen sin.": "{name} and the dolphin swam through dark caves where the light from the pearl flashed on the stone walls.\nLarge, calm whales sang deep notes in the background, as if showing the way.\n\nThe water was chilly, but her heart was brave. Somewhere out there, a mom was waiting for her baby.",
  "Endelig fant de mammaskilpadden, som lette fortvilet mellom tang og steiner.\nDen lille babyen svømte glad rett til henne, og de to skilpaddene la hodene mykt mot hverandre.\n\nFisk, seler og koraller jublet for {name}. Hele havet feiret henne som en ekte helt.": "Finally they found the mother turtle, who was looking despondent among seaweed and rocks.\nThe little baby happily swam straight to her, and the two turtles laid their heads softly against each other.\n\nFish, seals and coral cheered for the {name}. The whole sea celebrated her as a true hero.",
  "Som takk førte havfruene {name} til en gammel skattekiste skjult mellom korallene.\nDa lokket åpnet seg sakte, lyste en glitrende, perfekt rund perle mildt opp i vannet.\n\n«Denne har havet gjemt til deg, lille modige venn,» hvisket de. «Den vil alltid minne deg på havets eventyr og på hjertet ditt.»": "As thanks, the mermaids took the {name} to an ancient treasure chest hidden among the coral.\nAs the lid slowly opened, a sparkling, perfectly round pearl gently shone in the water.\n\n\"This one the sea has hidden for you, little brave friend,\" they whispered. \"It will always remind you of the adventures of the sea and of your heart.\"",
  "Solen begynte å gå ned over havet, og vannet ble gyllent rundt slottet.\n{name} vinket farvel til delfinen, havfruene og alle vennene sine.\n\n«Jeg kommer til å savne dere,» hvisket hun. «Men jeg lover å aldri glemme dere.»": "The sun began to set over the sea, and the water turned golden around the castle.\n{name} waved goodbye to the dolphin, mermaids and all his friends.\n\n\"I'm going to miss you guys,\" she whispered. \"But I promise never to forget you.\"",
  "Tilbake på stranden hadde {name} bena sine igjen, men eventyret kjentes fortsatt ekte.\nI hånden holdt hun den vakre perlen, varm og blank som et lite lys fra dypet.\n\nHun smilte mot bølgene som sakte rullet inn. Havet skulle alltid være hennes hemmelige eventyr.": "Back on the beach, {name} had his legs back, but the adventure still felt real.\nIn her hand she held the beautiful pearl, warm and shiny like a small light from the depths.\n\nShe smiled at the waves that slowly rolled in. The sea was always to be her secret adventure.",
  "En liten drømmer. Et magisk skjell. Et helt nytt rike under bølgene.\n\nNår {name} finner et glitrende skjell på stranden, åpner det døren til et eventyr ingen kan glemme. Sammen med en lekende delfin og en flokk vennlige havfruer reiser hun gjennom korallrev, hemmelige hager og perlemor-slott.\n\nUnderveis lærer {name} hvor sterk hun er — og at ekte vennskap kan oppstå selv i dypeste hav.\n\nEn personlig fortelling om mot, fantasi og havets uendelige eventyr.": "A little dreamer. A magical shell. A whole new kingdom under the waves.\n\nWhen {name} finds a sparkling seashell on the beach, it opens the door to an adventure no one will forget. Together with a playful dolphin and a flock of friendly mermaids, she travels through coral reefs, secret gardens and mother-of-pearl castles.\n\nAlong the way, {name} learns how strong she is — and that true friendship can arise even in the deepest ocean.\n\nA personal tale of courage, imagination and the endless adventure of the sea."
}
