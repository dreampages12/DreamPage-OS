...
def draw_centered_title_cover(img, text):
    ...
    font_small = ImageFont.truetype(COVER_FONT, int(min(img.size) * 0.072))
    font_large = ImageFont.truetype(COVER_FONT, int(min(img.size) * 0.084))


    gold   = ((193, 150, 70), (255, 246, 220))
    shadow = (36, 28, 20)
...
_DREAMPAGE_TRANSLATIONS = {
  ...
  "{name} hadde nesten gjort seg klar for kvelden da han oppdaget noe merkelig.\nMellom bøkene på rommet lå et kart han aldri hadde sett før.\nDet så gammelt og støvete ut, men da han løftet det opp, begynte kantene å gløde svakt i gull.": "{name} had almost gotten ready for the evening when he noticed something strange.\nBetween the books in the room was a map he had never seen before.\nIt looked old and dusty, but when he lifted it up, the edges began to glow faintly gold.",
  "Kartet ble varmt i hendene hans.\nSmå tegn av gyllent lys steg opp fra papiret og danset rundt i rommet som hemmelige stjerner.\n{name} holdt pusten.\nDette var ikke et vanlig kart.": "The map grew warm in his hands.\nLittle signs of golden light rose from the paper and danced around the room like secret stars.\n{name} held his breath.\nThis was no ordinary map.",
  ...
  "På en av de flyvende øyene hørte {name} en svak lyd.\nBak glødende slyngplanter satt en liten drageunge fast med vingen sin.\nDen så redd ut, men ikke farlig.\n{name} løsnet plantene én etter én, og dragen dyttet snuten takknemlig mot hånden hans.": "On one of the flying islands, {name} heard a faint sound.\nBehind glowing creepers, a small baby dragon was stuck with its wing.\nIt looked scared, but not dangerous.\n{name} dislodged the plants one by one, and the dragon nudged his snout gratefully against his hand.",
  ...
  "Da {name} gikk gjennom portalen, lukket en glødende luftboble seg rundt ham.\nUtenfor danset vannet stille, og hele undervannsbyen lyste.\nMidt i byen blinket et nytt stjernemerke på kartet.\nDa han rørte ved merket, fløy lyset rett inn i papiret.": "As the {name} walked through the portal, a glowing bubble of air closed around him.\nOutside, the water danced quietly, and the entire underwater city glowed.\nIn the middle of the city, a new star mark flashed on the map.\nWhen he touched the mark, the light flew straight into the paper.",
  "Det nye stjernemerket fikk kartet til å lyse kaldt og klart.\nEn portal åpnet seg, og {name} steg ut i en verden av is og nordlys.\nFjellene ruvet rundt ham som blå krystaller.\nDrageungen sto ved siden av ham, klar til å følge ham videre.": "The new star mark made the map shine cold and clear.\nA portal opened, and the {name} stepped out into a world of ice and northern lights.\nThe mountains towered around him like blue crystals.\nThe baby dragon stood beside him, ready to follow him on.",
