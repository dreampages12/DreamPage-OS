    ...
    if page.get("type") == "blank":
        ...
        for block in page.get("blocks", []):
            ...
            box = (
                ...
                int(img_w * 0.20),
                # 0.37 i stedet for 0.40: strammer inn lufta mellom tittelen
                # og introteksten uten aa presse teksten opp i tittelen.
                int(img_h * 0.37),
                int(img_w * 0.80),
                # Boksen maa slutte over taglinen paa 0.785, ellers renner
                # teksten inn i "Trykket med omtanke for kvalitet".
                int(img_h * 0.72),
            )

            # Linjeavstanden maa skaleres som fonten, ellers klistrer linjene
            # seg sammen paa 4096 px-sidene. Samme formel som innmatssidene.
