...
_DREAMPAGE_TRANSLATIONS = {
  "{name} og\nDet forsvunne dinosauregget": "{name} og\nDet forsvunne dinosauregget",
  "Takk for at du kjøpte denne personlige historien!\nI denne boken drar {name} tilbake til dinosaurdalen for å lete etter et egg som har forsvunnet. {name} lærer at det å hjelpe andre går aller best når man gjør det sammen.\nVi håper historien bringer glede, spenning og fantasifulle øyeblikk.": "Takk for at du kjøpte denne personlege historia!\nI denne boka reiser {name} tilbake til dinosaurdalen for å leite etter eit egg som har forsvunne. {name} lærer at det å hjelpe andre går aller best når ein gjer det saman.\nVi håper historia gjev glede, spaning og fantasifulle augneblinkar.",
  "Det hadde gått en stund siden {name} sist var i dinosaurdalen.\nEn helt vanlig dag på skogsstien skjedde det noe.\nGylne lys begynte å danse mellom trærne.\nPortalen var tilbake. Og den ventet på {name}.": "Det hadde gått ei stund sidan {name} sist var i dinosaurdalen.\nEin heilt vanleg dag på skogsstien skjedde det noko.\nGylne lys byrja å danse mellom trea.\nPortalen var tilbake. Og han venta på {name}.",
  "{name} tok et steg gjennom det gylne lyset.\nPå den andre siden sto Lumi og ventet.\nMen denne gangen var Lumi urolig. Han trippet frem og tilbake.\n«Kom fort,» sa han. «Jeg må vise deg noe.»": "{name} tok eit steg gjennom det gylne lyset.\nPå den andre sida stod Lumi og venta.\nMen denne gongen var Lumi uroleg. Han trippa fram og tilbake.\n«Kom fort,» sa han. «Eg må vise deg noko.»",
  "Lumi løp foran, og {name} fulgte etter helt til de kom til et stort rede.\nInni lå flere egg trygt sammen. Men det var en tom plass i midten.\nEn stor dinosaurmor gikk urolig rundt redet.\nEtt av eggene hennes var borte.": "Lumi sprang føre, og {name} følgde etter heilt til dei kom til eit stort reir.\nInni låg fleire egg trygt saman. Men det var ein tom plass i midten.\nEi stor dinosaurmor gjekk uroleg rundt reiret.\nEitt av egga hennar var borte.",
  "{name} satte seg på huk og så nøye på bakken.\nI den myke jorda lå det ferske fotavtrykk.\nVed siden av dem gikk et bredt slepespor.\n«Egget er ikke borte,» sa {name}. «Det har blitt flyttet.»": "{name} sette seg på huk og såg nøye på bakken.\nI den mjuke jorda låg det ferske fotavtrykk.\nVed sida av dei gjekk eit breitt slepespor.\n«Egget er ikkje borte,» sa {name}. «Det har blitt flytta.»",
  "Sporene førte inn i en mørkere del av dalen.\nHer var trærne tettere, og lyden av elven var langt unna.\nPlutselig raslet det i buskene foran dem.\n{name} og Lumi stoppet helt stille.": "Spora førte inn i ein mørkare del av dalen.\nHer var trea tettare, og lyden av elva var langt unna.\nBrått rasla det i buskene framfor dei.\n{name} og Lumi stoppa heilt stille.",
  "En rask dinosaur med fjær hoppet frem mellom bladene.\nDen så på {name} et lite øyeblikk. Så snudde den og løp.\n«Etter den!» ropte Lumi.\nOg så bar det av gårde gjennom jungelen.": "Ein rask dinosaur med fjør hoppa fram mellom blada.\nHan såg på {name} eit lite augneblink. Så snudde han og sprang.\n«Etter han!» ropte Lumi.\nOg så bar det av garde gjennom jungelen.",
  "Jakten gikk over falne trær og langs den brusende elven.\nDen fremmede dinosauren så seg tilbake igjen og igjen.\nNesten som om den ville at de skulle følge etter.\n{name} begynte å lure. Kanskje den ikke rømte i det hele tatt?": "Jakta gjekk over falne tre og langs den brusande elva.\nDen framande dinosauren såg seg tilbake att og att.\nNesten som om han ville at dei skulle følgje etter.\n{name} byrja å lure. Kanskje han ikkje rømde i det heile?",
  "Nede ved elvebredden fant de det. Det savnede egget.\nDet hadde ikke blitt stjålet i det hele tatt.\nEgget hadde trillet ned fra redet og satt fast mellom steinene.\nOg den fremmede dinosauren hadde passet på det hele tiden.": "Nede ved elvebreidda fann dei det. Det sakna egget.\nDet hadde ikkje blitt stole i det heile.\nEgget hadde trilla ned frå reiret og sat fast mellom steinane.\nOg den framande dinosauren hadde passa på det heile tida.",
  "Et dypt drønn rullet ned fra fjellene.\nElven begynte å stige, og vannet ble stridt og kaldt.\nEgget vippet der det sto.\nDe måtte få det opp med en gang.": "Eit djupt drønn rulla ned frå fjella.\nElva byrja å stige, og vatnet blei stridt og kaldt.\nEgget vippa der det stod.\nDei måtte få det opp med ein gong.",
  "{name} tok av seg ryggsekken og tenkte fort.\nGreiner, mose og et flatt stykke bark ble til en liten slede.\n«Dere drar, så løfter jeg,» sa {name}.\nLumi og den fremmede dinosauren stilte seg klare.": "{name} tok av seg ryggsekken og tenkte fort.\nGreiner, mose og eit flatt stykke bork blei til ein liten slede.\n«De dreg, så løftar eg,» sa {name}.\nLumi og den framande dinosauren stilte seg klare.",
  "En stor bølge kom brusende nedover elven.\nEgget begynte å rulle mot vannet.\nI siste liten strakte {name} seg frem og fikk tak.\nLumi og den fremmede dro til, og egget var trygt.": "Ei stor bølgje kom brusande nedover elva.\nEgget byrja å rulle mot vatnet.\nI siste liten strekte {name} seg fram og fekk tak.\nLumi og den framande drog til, og egget var trygt.",
  "Sammen dro de egget forsiktig oppover stien.\nDen fremmede dinosauren gikk foran og viste vei.\nLangt der fremme sto dinosaurmoren og speidet.\nDa hun fikk øye på egget, løftet hun hodet og ropte av glede.": "Saman drog dei egget forsiktig oppover stien.\nDen framande dinosauren gjekk føre og viste veg.\nLangt der framme stod dinosaurmora og speida.\nDå ho fekk auge på egget, lyfte ho hovudet og ropte av glede.",
  "Egget ble lagt forsiktig tilbake i redet.\nDa begynte skallet å sprekke, helt av seg selv.\nEn liten baby-triceratops tittet ut og så rett på {name}.\nAlle sto helt stille. Dette var det fineste {name} hadde sett.": "Egget blei lagt forsiktig tilbake i reiret.\nDå byrja skalet å sprekke, heilt av seg sjølv.\nEin liten baby-triceratops kika ut og såg rett på {name}.\nAlle stod heilt stille. Dette var det finaste {name} hadde sett.",
  "Solen gikk ned i gult og rosa da Lumi fulgte {name} tilbake til portalen.\n«Takk for at du kom,» sa Lumi. «Du kom akkurat i tide.»\n{name} vinket farvel og tok steget hjem.\nMen langt borte sendte en gammel vulkan en tynn stripe røyk opp mot himmelen.": "Sola gjekk ned i gult og rosa då Lumi følgde {name} tilbake til portalen.\n«Takk for at du kom,» sa Lumi. «Du kom akkurat i tide.»\n{name} vinka farvel og tok steget heim.\nMen langt borte sende ein gammal vulkan ei tynn stripe røyk opp mot himmelen.",
  "Denne boken handler om å hjelpe. Om å stoppe opp, se ordentlig etter og forstå at ting ikke alltid er slik de ser ut ved første blikk.\nNår et dinosauregg forsvinner fra redet, drar {name} og vennen Lumi ut i dalen for å finne det. Jakten fører dem til en fremmed dinosaur – og til en sannhet ingen hadde ventet.\nEn varm og spennende historie om vennskap, samarbeid og om å tørre å stole på noen man ikke kjenner.\nEn bok som gir mot, glede – og minner barnet på at de kan utgjøre en forskjell.": "Denne boka handlar om å hjelpe. Om å stoppe opp, sjå ordentleg etter og forstå at ting ikkje alltid er slik dei ser ut ved første blikk.\nNår eit dinosauregg forsvinn frå reiret, dreg {name} og venen Lumi ut i dalen for å finne det. Jakta fører dei til ein framand dinosaur – og til ei sanning ingen hadde venta.\nEi varm og spennande historie om vennskap, samarbeid og om å tore å stole på nokon ein ikkje kjenner.\nEi bok som gjev mot, glede – og minner barnet på at dei kan utgjere ein skilnad.",
}
