...
_DREAMPAGE_TRANSLATIONS = {
  "{name} sin\nDen Magiske Bursdagen": "{name} sin\nDen Magiske Bursdagen",
  "Det var bursdagen til {name}, og noe glitret under puten hennes.\nDet var en gyllen sløyfe – og den beveget seg helt av seg selv.\n{name} trakk forsiktig i den, og den rosa festkjolen svevde ut av skapet.\nSløyfen ville tydeligvis vise henne noe.": "Det var bursdagen til {name}, og noko glitra under puta hennar.\nDet var ei gyllen sløyfe – og ho rørte seg heilt av seg sjølv.\n{name} drog forsiktig i henne, og den rosa festkjolen sveva ut av skåpet.\nSløyfa ville tydelegvis vise henne noko.",
  "{name} tok på seg kjolen, og sløyfen snodde seg bort til døren.\nHun trakk i den én gang til, og døren gled sakte opp.\nUtenfor lå en hage full av blomster, lys og sommerfugler.\nSløyfen fortsatte ut i hagen, som om den ville at hun skulle følge etter.": "{name} tok på seg kjolen, og sløyfa snodde seg bort til døra.\nHo drog i henne ein gong til, og døra gleid sakte opp.\nUtanfor låg ein hage full av blomar, lys og sommarfuglar.\nSløyfa heldt fram ut i hagen, som om ho ville at {name} skulle følgje etter.",
  "Sløyfen la seg som en lysende sti gjennom hagen.\nLangt borte skimtet {name} en paviljong som glitret i solnedgangen.\nDa skjønte hun hvor sløyfen ville: den skulle føre henne dit.\nSå løp {name} av sted, midt i det gylne lyset.": "Sløyfa la seg som ein lysande sti gjennom hagen.\nLangt borte skimta {name} ein paviljong som glitra i solnedgangen.\nDå skjøna ho kvar sløyfa ville: ho skulle føre henne dit.\nSå sprang {name} av stad, midt i det gyldne lyset.",
  "Ved en stor blomsterport stoppet stien opp.\n{name} tok tak i sløyfen og trakk så hardt hun kunne.\nPorten svingte opp, ballonger steg mot himmelen og små lys ble tent.\nPå den andre siden lå gaver på rekke og rad, hele veien mot paviljongen.": "Ved ein stor blomeport stoppa stien opp.\n{name} tok tak i sløyfa og drog så hardt ho kunne.\nPorten svinga opp, ballongar steig mot himmelen og små lys vart tende.\nPå den andre sida låg gåver på rekkje og rad, heile vegen mot paviljongen.",
  "Plutselig kom det noen løpende bak henne.\nTo kaniner og et lite rådyr fulgte den samme gylne sløyfen.\nDe sprang forbi {name} og snudde seg, som om de ville si: bli med!\nSammen skyndte de seg videre mot bursdagsfesten.": "Plutseleg kom det nokon springande bak henne.\nTo kaninar og eit lite rådyr følgde den same gyldne sløyfa.\nDei sprang forbi {name} og snudde seg, som om dei ville seie: bli med!\nSaman skunda dei seg vidare mot bursdagsfesten.",
  "Men da {name} kom frem, var ikke festen ferdig ennå.\nBordet stod tomt, og gavene lå strødd utover.\n{name} tok tak i sløyfen, og kaninene tok tak bak henne.\nSammen dro de – og blomster, ballonger og gaver begynte å finne plassen sin.": "Men då {name} kom fram, var ikkje festen ferdig enno.\nBordet stod tomt, og gåvene låg strødde utover.\n{name} tok tak i sløyfa, og kaninane tok tak bak henne.\nSaman drog dei – og blomar, ballongar og gåver byrja å finne plassen sin.",
  "{name} tok i så hardt hun kunne, én siste gang.\nForhengene gled til side, og hele festen kom til syne.\nDer stod en stor kake, tusen små lys og ballonger helt opp til himmelen.\nDette var hennes helt egen magiske bursdagsfest.": "{name} tok i så hardt ho kunne, ein siste gong.\nForhenga gleid til side, og heile festen kom til syne.\nDer stod ei stor kake, tusen små lys og ballongar heilt opp til himmelen.\nDette var hennar heilt eigen magiske bursdagsfest.",
  "Det var fortsatt litt igjen å gjøre.\n{name} dyttet den siste store gaven på plass ved bordet.\nKaninene ordnet sløyfene, og rådyret holdt den gylne tråden.\nNå var alt klart til å feire.": "Det var framleis litt att å gjere.\n{name} dytta den siste store gåva på plass ved bordet.\nKaninane ordna sløyfene, og rådyret heldt den gyldne tråden.\nNo var alt klart til å feire.",
  "{name} lukket øynene og ønsket seg noe.\nSå blåste hun ut alle lysene på kaken.\nGnistene virvlet opp og ble til en ny, glødende del av sløyfen.\nBursdagsønsket hennes fløy av sted, videre ut i hagen.": "{name} lukka auga og ønskte seg noko.\nSå bles ho ut alle lysa på kaka.\nGneistane virvla opp og vart til ein ny, glødande del av sløyfa.\nBursdagsønsket hennar flaug av stad, vidare ut i hagen.",
  "Overalt der ønsket fløy, våknet hagen til liv.\nBlomster åpnet seg, og girlandere hengte seg selv opp mellom trærne.\nKaninene kom med tallerkener, og rådyret bar en kurv full av roser.\n{name} satte den siste lysende blomsterstjernen øverst på kaken.": "Overalt der ønsket flaug, vakna hagen til liv.\nBlomar opna seg, og girlandrar hengde seg sjølve opp mellom trea.\nKaninane kom med tallerkar, og rådyret bar ei korg full av roser.\n{name} sette den siste lysande blomsterstjerna øvst på kaka.",
  "Men ønskelyset stoppet ikke ved kaken.\nEn av kaninene oppdaget at det fortsatte bortover stien.\nKaninen satte av sted, og {name} løp tett bak.\nUnder en benk full av roser lå det en gave som ingen hadde sett før.": "Men ønskelyset stoppa ikkje ved kaka.\nEin av kaninane oppdaga at det heldt fram bortover stien.\nKaninen sette av stad, og {name} sprang tett bak.\nUnder ein benk full av roser låg det ei gåve som ingen hadde sett før.",
  "{name} satte seg ned foran den skjulte gaven.\nHun tok tak i den lange sløyfen og trakk sakte.\nLokket spratt opp, og varmt, gyllent lys strømmet ut.\nKaninene og rådyret kom nærmere for å se hva som var inni.": "{name} sette seg ned framfor den gøymde gåva.\nHo tok tak i den lange sløyfa og drog sakte.\nLoket spratt opp, og varmt, gyllent lys strøymde ut.\nKaninane og rådyret kom nærare for å sjå kva som var inni.",
  "Inni gaven lå et lite lys formet som en blomst.\n{name} løftet det forsiktig opp, og det festet seg til den gylne sløyfen.\nMed ett samlet ballonger, blomster og lys seg rundt paviljongen.\nNå var bursdagsfesten endelig helt ferdig.": "Inni gåva låg eit lite lys forma som ein blome.\n{name} lyfte det forsiktig opp, og det feste seg til den gyldne sløyfa.\nMed eitt samla ballongar, blomar og lys seg rundt paviljongen.\nNo var bursdagsfesten endeleg heilt ferdig.",
  "Da solen gikk ned, satte {name} seg til bords med vennene sine.\nHun skar det første stykket kake og delte det ut til kaninene og rådyret.\nDen gylne sløyfen la seg som en varm ring rundt hele selskapet.\n{name} hadde ikke bare funnet bursdagsfesten sin – hun hadde vært med på å lage den.": "Då sola gjekk ned, sette {name} seg til bords med venene sine.\nHo skar det første stykket kake og delte det ut til kaninane og rådyret.\nDen gyldne sløyfa la seg som ein varm ring rundt heile selskapet.\n{name} hadde ikkje berre funne bursdagsfesten sin – ho hadde vore med på å lage han.",
  "Denne boken handler om glede.\nOm å våkne opp til noe magisk, og selv være med på å skape det.\nDen viser at den fineste festen ikke er den man bare blir invitert til, men den man hjelper til med å gjøre ferdig.\nDerfor er det {name} som får hele feiringen til å våkne. En bursdagsgjest som blir vertinne i sitt eget eventyr.\nEn personlig fortelling som gir barn glede, mestringsfølelse og troen på at den aller fineste bursdagsmagien er den vi lager sammen.": "Denne boka handlar om glede.\nOm å vakne opp til noko magisk, og sjølv vere med på å skape det.\nHo viser at den finaste festen ikkje er den ein berre blir invitert til, men den ein hjelper til med å gjere ferdig.\nDifor er det {name} som får heile feiringa til å vakne. Ein bursdagsgjest som blir vertinne i sitt eige eventyr.\nEi personleg forteljing som gir barn glede, meistringskjensle og trua på at den aller finaste bursdagsmagien er den vi lagar saman."
}
