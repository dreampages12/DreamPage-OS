...
def render_page(page: Dict[str, Any], base_dir: str, out_dir: str) -> List[str]:
    ...
    if page.get("blank_only"):
        ...
        if os.path.basename(source_name).lower().startswith("lastpage"):
...
_DREAMPAGE_TRANSLATIONS = {
  "{name} i\nDyreparken": "{name} i\nDyreparken",
  "Takk for at du kjøpte denne personlige historien!\nI denne boken følger vi {name} på et spennende eventyr i dyreparken.\nHer møter {name} dyr som trenger litt hjelp - og oppdager hvor langt vennlighet kan rekke.\nVi håper historien skaper varme, undring og fine lesestunder.": "Takk for at du kjøpte denne personlege historia!\nI denne boka følgjer vi {name} på eit spennande eventyr i dyreparken.\nHer møter {name} dyr som treng litt hjelp - og oppdagar kor langt vennlegheit kan rekke.\nVi håpar historia skaper varme, undring og fine lesestunder.",
  "\"Endelig er dagen her,\" sa {name} og smilte ved porten.\nBak inngangen ventet svingete stier, rare dyrelyder og lukten av varmt gress.\nAlt kjentes nesten magisk, som om parken hadde våknet akkurat for ham.\nSå hvisket vinden mellom trærne: Velkommen til dyreparken. Et eventyr venter.": "\"Endeleg er dagen her,\" sa {name} og smilte ved porten.\nBak inngangen venta svingete stiar, rare dyrelydar og lukta av varmt gras.\nAlt kjendest nesten magisk, som om parken hadde vakna akkurat for han.\nSå kviskra vinden mellom trea: Velkommen til dyreparken. Eit eventyr ventar.",
  "{name} gikk videre og fikk øye på en høy giraff.\nDen bøyde den lange halsen ned og smilte vennlig.\n\"Hallo der nede,\" sa giraffen. \"Kan du hjelpe oss i dag?\"\n\"Ja!\" svarte {name} uten å nøle.": "{name} gjekk vidare og fekk auge på ein høg sjiraff.\nDen bøygde den lange halsen ned og smilte vennleg.\n\"Hallo der nede,\" sa sjiraffen. \"Kan du hjelpe oss i dag?\"\n\"Ja!\" svarte {name} utan å nøle.",
  "Giraffen kom helt nær og senket stemmen, som om den delte en viktig hemmelighet.\n\"Elefanten trenger hjelp først,\" sa den. \"Han prøver å nå de beste bladene, men de sitter for høyt.\"\n{name} kjente hjertet hoppe av spenning. \"Da går jeg med en gang,\" sa han, og satte fart langs stien.": "Sjiraffen kom heilt nær og senka stemma, som om den delte ein viktig løyndom.\n\"Elefanten treng hjelp først,\" sa han. \"Han prøver å nå dei beste blada, men dei sit for høgt.\"\n{name} kjende hjartet hoppe av spenning. \"Då går eg med ein gong,\" sa han, og sette fart langs stien.",
  "{name} skyndte seg langs stien mot elefantens område.\nSolen glitret i vannet, og bladene raslet over ham som små grønne flagg.\nHan fulgte de tunge fotsporene i sanden og ropte: \"Jeg kommer, elefant!\"\nNå var eventyret virkelig i gang.": "{name} skunda seg langs stien mot området til elefanten.\nSola glitra i vatnet, og blada rasla over han som små grøne flagg.\nHan følgde dei tunge fotspora i sanden og ropte: \"Eg kjem, elefant!\"\nNo var eventyret verkeleg i gang.",
  "Ved gjerdet sto elefanten og løftet snabelen håpefullt mot de grønne greinene.\n{name} samlet friske blader, strakte seg så langt han kunne og rakte dem forsiktig frem.\nElefanten tok imot med snabelen og blunket takknemlig. \"Tusen takk,\" sa den. \"Du reddet dagen min.\"": "Ved gjerdet stod elefanten og løfta snabelen håpefullt mot dei grøne greinene.\n{name} samla friske blad, strekte seg så langt han kunne og raka dei varsamt fram.\nElefanten tok imot med snabelen og blunka takksamt. \"Tusen takk,\" sa han. \"Du redda dagen min.\"",
  "Da elefanten var glad igjen, gikk {name} videre med lette steg.\nVed vannet ventet en zebra som stampet urolig med hoven og så nedover stien.\n\"Jeg finner ikke veien tilbake til flokken min,\" sa zebraen. \"Kan du hjelpe meg også?\"\n\"Selvfølgelig,\" sa {name}. \"Vi finner dem sammen.\"": "Då elefanten var glad igjen, gjekk {name} vidare med lette steig.\nVed vatnet venta ein zebra som stampa uroleg med hoven og såg nedover stien.\n\"Eg finn ikkje vegen tilbake til flokken min,\" sa zebraen. \"Kan du hjelpe meg også?\"\n\"Sjølvsagt,\" sa {name}. \"Vi finn dei saman.\"",
  "Zebraen satte fart, og {name} sprang ved siden av så godt han kunne.\nDe fulgte små spor i sanden, forbi busker og rundt en dam som glitret i solen.\nTil slutt fant zebraen flokken sin igjen. \"Nå går alt bra,\" sa den lykkelig. {name} lo. \"Vi er et godt team.\"": "Zebraen sette fart, og {name} sprang ved sida av så godt han kunne.\nDei følgde små spora i sanden, forbi buskar og rundt ein dam som glitra i sola.\nTil slutt fann zebraen flokken sin igjen. \"No går alt bra,\" sa den lykkeleg. {name} lo. \"Vi er eit godt team.\"",
  "Til slutt kom {name} til løven, som satt fast bak en tung gren.\n{name} tok tak og skjøv så godt han kunne.\n\"Du er modigere enn mange voksne,\" sa løven da veien ble fri.\n\"Jeg ville bare hjelpe,\" sa {name}.": "Til slutt kom {name} til løva, som sat fast bak ei tung grein.\n{name} tok tak og skauv så godt han kunne.\n\"Du er modigare enn mange vaksne,\" sa løva då vegen vart fri.\n\"Eg ville berre hjelpe,\" sa {name}.",
  "Da oppdragene var ferdige, kom alle dyrene bort til {name}.\n\"Du hjalp oss alle,\" sa giraffen.\n\"Du er vår venn nå,\" sa elefanten, mens zebraen nikket og løven brummet mykt.\n{name} kjente seg varm av glede.": "Då oppdraga var ferdige, kom alle dyra bort til {name}.\n\"Du hjelpte oss alle,\" sa sjiraffen.\n\"Du er vennen vår no,\" sa elefanten, medan zebraen nikka og løva brumma mykt.\n{name} kjende seg varm av glede.",
  "{name} løftet hånden og vinket til alle de nye vennene sine.\n\"Ha det!\" ropte han, selv om stemmen ble litt myk av savn.\n\"Kom tilbake en dag,\" ropte dyrene tilbake, én etter én.\nDet var trist å gå, men hjertet hans var fullt av lys og varme minner.": "{name} løfta handa og vinket til alle dei nye vennene sine.\n\"Ha det!\" ropte han, sjølv om stemma vart litt mjuk av sakn.\n\"Kom tilbake ein dag,\" ropte dyra tilbake, éin etter éin.\nDet var trist å gå, men hjartet hans var fullt av lys og varme minne.",
  "Et stykke borte snudde {name} seg en siste gang.\nI sollyset så det nesten ut som om dyrene smilte til ham fra det fjerne.\nHan la hånden mot brystet og kjente hvor glad han var blitt i dem.\nDette var et farvel som ikke føltes helt som et farvel.": "Eit stykke borte snudde {name} seg ein siste gong.\nI sollyset såg det nesten ut som om dyra smilte til han frå det fjerne.\nHan la handa mot brystet og kjende kvar glad han hadde vorte i dei.\nDette var eit farvel som ikkje kjendest heilt som eit farvel.",
  "Ved stien glitret noe lite i kveldssolen.\n{name} bøyde seg ned og fant en liten elefantfigur i grusen.\n\"Et minne fra oss,\" var det nesten som vinden hvisket.\n\"Da glemmer jeg dere aldri,\" sa {name} stille.": "Ved stien glitra noko lite i kveldssola.\n{name} bøygde seg ned og fann ein liten elefantfigur i grusen.\n\"Eit minne frå oss,\" var det nesten som vinden kviskra.\n\"Då gløymer eg dykk aldri,\" sa {name} stille.",
  "Solen sank lavt mens {name} gikk hjemover.\nBak porten lå dyreparken stille, og foran ham ventet huset med varme lys.\nHan holdt elefantfiguren tett og visste det i hele hjertet sitt:\nEventyret var ikke helt over.": "Sola sokk lågt medan {name} gjekk heimover.\nBak porten låg dyreparken stille, og framfor han venta huset med varme lys.\nHan heldt elefantfiguren tett og visste det i heile hjartet sitt:\nEventyret var ikkje heilt over.",
  "Før {name} sovnet, så han bort på den lille elefanten ved lampen.\nRommet var stille, men han syntes nesten han kunne høre et mykt brøl og et vennlig tramp.\nKanskje, tenkte han, venter dyrevennene på meg igjen i morgen.\nOg med det sovnet han med et smil.": "Før {name} sovna, så han bort på den vesle elefanten ved lampa.\nRommet var stille, men han syntest nesten han kunne høyre eit mykt brøl og eit vennleg tramp.\nKanskje, tenkte han, ventar dyrevennene på meg igjen i morgon.\nOg med det sovna han med eit smil.",
  "Denne boken handler om små handlinger som betyr mye.\nNår {name} går inn i dyreparken, venter et varmt og spennende eventyr bak hver sving. En giraff ber om hjelp, en elefant blir lettet, en zebra finner smilet igjen, og en løve oppdager hva ekte vennskap er.\nGjennom møtene lærer {name} at omtanke, mot og vennlighet kan gjøre en stor forskjell.\nEn personlig historie fylt med dyreglede, nærhet og minner som varer lenge etter siste side.": "Denne boka handlar om små handlingar som betyr mykje.\nNår {name} går inn i dyreparken, ventar eit varmt og spennande eventyr bak kvar sving. Ein sjiraff ber om hjelp, ein elefant blir letta, ein zebra finn smilet igjen, og ei løve oppdagar kva ekte vennskap er.\nGjennom møta lærer {name} at omtanke, mot og vennlegheit kan gjere ein stor forskjell.\nEi personleg historie fylt med dyreglede, nærleik og minne som varer lenge etter siste side."
}
