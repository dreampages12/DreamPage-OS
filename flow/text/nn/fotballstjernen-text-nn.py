...
def build_pages(child_name: str) -> List[Dict[str, Any]]:
    ...
    pages: List[Dict[str, Any]] = [
...

        {
            ...
            "square": True,
            "endtext": True,
            "text": p("Dette eventyret er over\nmen magien lever vidare"),
        },
...
def render_dreampage_first(child_name: str, out_dir: str) -> str:
    ...
    body_lines = [
        ...
        "",
        "Det er dine draumar, ditt mot",
        "og dine mål som fyller desse sidene.",
        "",
...
_DREAMPAGE_TRANSLATIONS = {
  "{name} blir": "{name} blir\nfotballstjerne",
  "{name} sto på banen med ballen ved foten og kjente gresset kile under skoene.\nHan hadde drømt om å bli en ekte fotballstjerne så lenge han kunne huske.\n\nI dag virket målet litt nærmere enn før. Han trakk pusten dypt og hvisket: «Jeg skal prøve så godt jeg kan.»": "{name} stod på banen med ballen ved foten og kjende graset kile under skoa.\nHan hadde drøymt om å bli ei ekte fotballstjerne så lenge han kunne hugse.\n\nI dag verka målet litt nærare enn før. Han trekte pusten djupt og kviskra: «Eg skal prøve så godt eg kan.»",
  "{name} så opp mot lyset som skinte over banen.\nDet glitret i gresset, og hele stedet føltes som starten på noe viktig.\n\nHan tenkte på alle gangene han hadde sparket ball i hagen, bommet, ledd og prøvd igjen. Kanskje var det nettopp slik store drømmer begynte.": "{name} såg opp mot lyset som skein over banen.\nDet glitra i graset, og heile staden kjendest som starten på noko viktig.\n\nHan tenkte på alle gongene han hadde sparka ball i hagen, bomma, ledd og prøvd igjen. Kanskje var det nettopp slik store draumar byrja.",
  "{name} begynte å øve med ballen, først sakte og så litt raskere.\nHan prøvde å drible slik de store spillerne gjorde på TV, men ballen trillet ikke alltid dit han ville.\n\nHan bet tennene forsiktig sammen. «Jeg må bare lære litt mer,» tenkte han. «Ingen blir god uten å øve.»": "{name} byrja å øve med ballen, først sakte og så litt raskare.\nHan prøvde å drible slik dei store spelarane gjorde på TV, men ballen trilla ikkje alltid dit han ville.\n\nHan beit tennene varsamt saman. «Eg må berre lære litt meir,» tenkte han. «Ingen blir gode utan å øve.»",
  "Så kom et skudd som gikk helt feil vei.\n{name} satte seg ned i gresset og kjente skuffelsen prikke bak øynene.\n\nBallen lå stille ved siden av ham, som om den også ventet. «Kanskje jeg ikke er god nok,» tenkte han, selv om han ønsket å være modig.": "Så kom eit skot som gjekk heilt feil veg.\n{name} sette seg ned i graset og kjende skuffelsen prikke bak auga.\n\nBallen låg stille ved sida av han, som om den også venta. «Kanskje eg ikkje er god nok,» tenkte han, sjølv om han ønskte å vere modig.",
  "Treneren kom bort og satte seg rolig ved siden av {name}.\n«Vet du hva de beste spillerne gjør når de bommer?» spurte han. «De prøver én gang til.»\n\n{name} så opp. Treneren smilte varmt. «Jeg tror på deg.» Da kjente {name} motet vende tilbake, lite først, men sterkere for hvert sekund.": "Trenaren kom bort og sette seg roleg ved sida av {name}.\n«Veit du kva dei beste spelarane gjer når dei bommar?» spurde han. «Dei prøver éin gong til.»\n\n{name} så opp. Trenaren smilte varmt. «Eg trur på deg.» Då kjende {name} motet vende tilbake, lite først, men sterkare for kvart sekund.",
  "{name} reiste seg, tørket gresset av hendene og prøvde igjen.\nDenne gangen holdt han ballen nær foten og lyttet til rytmen i stegene sine.\n\nHan bommet fortsatt litt, men han stoppet ikke. For hver berøring ble han roligere, og inni seg tenkte han: «Jeg gir meg ikke.»": "{name} reiste seg, tørka grasa av hendene og prøvde igjen.\nDenne gongen heldt han ballen nær foten og lytta til rytmen i stega sine.\n\nHan bomma framleis litt, men han stoppa ikkje. For kvar berøring vart han rolegare, og inni seg tenkte han: «Eg gir meg ikkje.»",
  "Etter hvert begynte føttene å forstå det hjertet allerede ville.\n{name} vendte, driblet og fant små åpninger mellom kjeglene på banen.\n\nMålet virket ikke så langt unna lenger. Han smilte for seg selv, for nå merket han det tydelig: øving gjorde ham bedre.": "Etter kvart byrja føtene å forstå det hjartet allereie ville.\n{name} vende, dribla og fann små opningar mellom kjeglene på banen.\n\nMålet verka ikkje så langt unna lengre. Han smilte for seg sjølv, for no merka han det tydeleg: øving gjorde han betre.",
  "Senere satt {name} stille i garderoben mens de andre snakket lavt rundt ham.\nDen store kampen nærmet seg, og treneren skulle velge laget.\n\nHjertet hans dunket så fort at han nesten kunne høre det i rommet. Han håpet, men turte nesten ikke håpe for mye.": "Seinare sat {name} stille i garderoben medan dei andre snakka lågt rundt han.\nDen store kampen nærma seg, og trenaren skulle velje laget.\n\nHjartet hans dunket så fort at han nesten kunne høyre det i rommet. Han håpa, men torde nesten ikkje håpe for mykje.",
  "{name} lyttet nøye da treneren begynte å lese opp navnene.\nEtt navn kom, så et til, og så enda et.\n\nHan knyttet hendene rundt kanten av benken. Da treneren tok en liten pause, holdt {name} pusten og ventet på ordene som kunne forandre hele dagen.": "{name} lytta nøye då trenaren byrja å lese opp namna.\nEitt namn kom, så eit til, og så endå eit.\n\nHan knytte hendene rundt kanten av benken. Då trenaren tok ein liten pause, heldt {name} pusten og venta på orda som kunne forandre heile dagen.",
  "Plutselig hørte han navnet sitt.\n«{name}, du er med i finalen,» sa treneren tydelig.\n\nFørst satt {name} helt stille. Så kjente han smilet vokse, større og større, helt til han nesten ikke klarte å sitte i ro.": "Plutseleg høyrde han namnet sitt.\n«{name}, du er med i finalen,» sa trenaren tydeleg.\n\nFørst sat {name} heilt stille. Så kjende han smilet vekse, større og større, heilt til han nesten ikkje klarte å sitje i ro.",
  "{name} sto i tunnelen med laget rundt seg og kjente hjertet banke hardt.\nForan ham lyste stadion som en egen liten sol i natten.\n\nHan tenkte på alle skuddene, alle bommene og alle gangene han hadde reist seg igjen. Så tok han et skritt frem. Det var hans tur nå.": "{name} stod i tunnelen med laget rundt seg og kjende hjartet banke hardt.\nFramfor han lyste stadion som ei eiga lita sol i natta.\n\nHan tenkte på alle skota, alle bommane og alle gongene han hadde reist seg igjen. Så tok han eit steg fram. Det var hans tur no.",
  "{name} gikk ut på den store stadion, og lyden fra tribunen skylte mot ham som bølger.\nLysene skinte så sterkt at gresset glitret under skoene hans.\n\nHan tok et dypt pust og kjente nervene bli til energi. Dette var øyeblikket han hadde drømt om.": "{name} gjekk ut på det store stadionet, og lyden frå tribunen skylde mot han som bølgjar.\nLysa skein så sterkt at graset glitra under skoa hans.\n\nHan tok eit djupt pust og kjende nervane bli til energi. Dette var augneblinken han hadde drøymt om.",
  "Kampen startet, og plutselig kom ballen rullende mot {name}.\nHan tok imot den, løftet blikket og så en liten åpning foran seg.\n\nPublikum jublet, men han hørte mest sin egen pust. Beina husket treningen, og {name} driblet framover mot målet.": "Kampen starta, og plutseleg kom ballen rullande mot {name}.\nHan tok imot den, løfta blikket og såg ei lita opning framfor seg.\n\nPublikum jubla, men han høyrde mest sin eigen pust. Beina hugsa treninga, og {name} dribla framover mot målet.",
  "{name} trakk foten tilbake og skjøt med alt motet han hadde samlet.\nBallen suste gjennom luften, traff nettet og ble liggende der som et lite mirakel.\n\nHele stadion jublet. {name} løftet armene og lo, for nå visste han det: en ekte stjerne gir aldri opp.": "{name} trekte foten tilbake og skaut med alt motet han hadde samla.\nBallen suste gjennom lufta, trefte nettet og vart liggjande der som eit lite mirakel.\n\nHeile stadion jubla. {name} løfta armane og lo, for no visste han det: ei ekte stjerne gir aldri opp.",
  "En liten spiller. En stor drøm.\n\nNår {name} får sjansen til å spille sin største kamp noensinne, begynner et spennende eventyr fylt med mot, håp og fotballglede.\n\nFra trening og nervøse øyeblikk i garderoben til den store finalen, får barnet oppleve hvordan det føles å tro på seg selv — og skinne på banen.\n\nEn personlig historie om drømmer, mestring og et mål barnet aldri vil glemme.": "Ein liten spelar. Ein stor draum.\n\nNår {name} får sjansen til å spele sin største kamp nokosinne, byrjar eit spennande eventyr fylt med mot, håp og fotballglede.\n\nFrå trening og nervøse stunder i garderoben til den store finalen, får barnet oppleve korleis det kjennest å tru på seg sjølv — og skjene på banen.\n\nEi personleg historie om draumar, meistring og eit mål barnet aldri vil gløyme."
}
