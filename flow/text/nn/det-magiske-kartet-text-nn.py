...
_DREAMPAGE_TRANSLATIONS = {
  ...
  "{name} hadde nesten gjort seg klar for kvelden da han oppdaget noe merkelig.\nMellom bøkene på rommet lå et kart han aldri hadde sett før.\nDet så gammelt og støvete ut, men da han løftet det opp, begynte kantene å gløde svakt i gull.": "{name} hadde nesten gjort seg klar for kvelden då han oppdaga noko merkeleg.\nMellom bøkene på rommet låg eit kart han aldri hadde sett før.\nDet såg gammalt og støvete ut, men då han løfta det opp, byrja kantane å glø svakt i gull.",
  "Kartet ble varmt i hendene hans.\nSmå tegn av gyllent lys steg opp fra papiret og danset rundt i rommet som hemmelige stjerner.\n{name} holdt pusten.\nDette var ikke et vanlig kart.": "Kartet vart varmt i hendene hans.\nSmå teikn av gyllent lys steg opp frå papiret og dansa rundt i rommet som hemmelege stjerner.\n{name} heldt pusten.\nDette var ikkje eit vanleg kart.",
  ...
  "På en av de flyvende øyene hørte {name} en svak lyd.\nBak glødende slyngplanter satt en liten drageunge fast med vingen sin.\nDen så redd ut, men ikke farlig.\n{name} løsnet plantene én etter én, og dragen dyttet snuten takknemlig mot hånden hans.": "På ei av dei flygande øyane høyrde {name} ein svak lyd.\nBak glødande slyngplantar sat ein liten drakeunge fast med vingen sin.\nDen såg redd ut, men ikkje farleg.\n{name} løyste plantane éin etter éin, og draken dytta snuten takksamt mot handa hans.",
  ...
  "Da {name} gikk gjennom portalen, lukket en glødende luftboble seg rundt ham.\nUtenfor danset vannet stille, og hele undervannsbyen lyste.\nMidt i byen blinket et nytt stjernemerke på kartet.\nDa han rørte ved merket, fløy lyset rett inn i papiret.": "Då {name} gjekk gjennom portalen, lukka ei glødande luftboble seg rundt han.\nUtanfor dansa vatnet stille, og heile undervassbyen lyste.\nMidt i byen blinka eit nytt stjernemerke på kartet.\nDå han rørte ved merket, flaug lyset rett inn i papiret.",
  "Det nye stjernemerket fikk kartet til å lyse kaldt og klart.\nEn portal åpnet seg, og {name} steg ut i en verden av is og nordlys.\nFjellene ruvet rundt ham som blå krystaller.\nDrageungen sto ved siden av ham, klar til å følge ham videre.": "Det nye stjernemerket fekk karta til å lyse kaldt og klart.\nEin portal opna seg, og {name} steig ut i ei verd av is og nordlys.\nFjella ruva rundt han som blå krystallar.\nDrakeungen stod ved sida av han, klar til å følgje han vidare.",
