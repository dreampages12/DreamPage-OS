...
FRONT_COVER_LINE1_SIZE = 90 / 1024
...
_DREAMPAGE_TRANSLATIONS = {
  "{name} og\nDinosaurenes dal": "{name} og\nDinosaurdalen",
  "Takk for at du kjøpte denne personlige historien!\nI denne boken følger vi {name} på et eventyr i en magisk dal. {name} lærer seg og si ifra når noe ikke er greit.\nVi håper historien bringer glede, trygghet og fantasifulle øyeblikk.": "Takk for at du kjøpte denne personlege historia!\nI denne boka følgjer vi {name} på eit eventyr i ein magisk dal. {name} lærer seg og si frå når noko ikkje er greitt.\nVi håpar historia bringar glede, tryggleik og fantasifulle stunder.",
  "Det var en stille og fin dag. {name} sto ute og så seg rundt.\nLuften var frisk, og naturen lå åpen foran ham.\nAlt føltes rolig og trygt.\n{name} visste det ikke ennå, men denne dagen skulle bli helt annerledes enn alle andre.": "Det var ei stille og fin dag. {name} stod ute og såg seg rundt.\nLufta var frisk, og naturen låg open framfor han.\nAlt kjendest roleg og trygt.\n{name} visste det ikkje enno, men denne dagen skulle bli heilt annleis enn alle andre.",
  "{name} gikk videre innover stien. Da fikk han øye på noe uvanlig.\nMidt blant steiner og blader lå et egg som glødet svakt.\nLyset blinket i grønne og gylne farger.\n{name} satte seg forsiktig ned. Hva kunne dette være?": "{name} gjekk vidare innover stien. Då fekk han auge på noko uvanleg.\nMidt blant steinar og blad låg eit egg som glødde svakt.\nLyset blinka i grøne og gylne fargar.\n{name} sette seg varsamt ned. Kva kunne dette vere?",
  "{name} så nærmere på egget.\nLyset ble sterkere, og bakken rundt begynte å gløde svakt.\nSteinene foran ham lyste opp i en rund form.\n{name} trakk pusten dypt.\nDet var ikke bare et egg.\nDet var noe mer.": "{name} såg nærare på egget.\nLyset vart sterkare, og bakken rundt byrja å glø svakt.\nSteinane framfor han lyste opp i ei rund form.\n{name} trekte pusten djupt.\nDet var ikkje berre eit egg.\nDet var litt meir.",
  "{name} reiste seg sakte.\nHan tok noen forsiktige steg frem.\nDen lysende sirkelen var stille, men levende.\nLuften rundt kjentes varm og myk.\n{name} løftet hånden.\nHva ville skje hvis han rørte den?": "{name} reiste seg sakte.\nHan tok nokre forsiktige steg fram.\nDen lysande sirkelen var stille, men levande.\nLufta rundt kjendest varm og mjuk.\n{name} løfta handa.\nKva ville skje om han rørte han?",
  "Da {name} rørte den lysende sirkelen, skjedde det noe.\nLyset begynte å bevege seg sakte.\nSmå gnister danset rundt hånden hans.\nLuften summet lavt, som om portalen våknet.\n{name} trakk pusten dypt. Dette var begynnelsen på noe nytt.": "Då {name} rørte den lysande sirkelen, skjedde det noko.\nLyset byrja å bevege seg sakte.\nSmå gneistar dansa rundt handa hans.\nLufta summa lågt, som om portalen vakna.\n{name} trekte pusten djupt. Dette var byrjinga på noko nytt.",
  "{name} tok et forsiktig steg frem. Foran ham lå Dinosaurdalen.\nHøye fjell og fosser strakte seg rundt ham. Store skygger beveget seg i det fjerne.\nDette var et helt nytt sted. Og eventyret hadde så vidt begynt.": "{name} tok eit forsiktig steg fram. Framfor han låg *Dinosaurdalen.\nHøge fjell og fossar strekte seg rundt han. Store skuggar bevega seg i det fjerne.\nDette var ein heilt ny stad. Og eventyret hadde så vidt byrja.",
  "Dinosauren kom rolig nærmere. Den var stor, men så snill ut.\n«Jeg heter Lumi,» sa den lavt. «Jeg trenger hjelp.»\n{name} nølte litt – så tok han et steg frem.": "Dinosauren kom roleg nærare. Den var stor, men så snill ut.\n«Eg heiter Lumi,» sa den lågt. «Eg treng hjelp.»\n{name} nølte litt – så tok han eit steg fram.",
  "Plutselig begynte Lumi å løpe. Han snudde seg og så på {name}.\n«Kom!» sa han vennlig. «Jeg trenger hjelpen din.»\n{name} nølte litt. Så begynte han å løpe etter.": "Plutseleg byrja Lumi å springe. Han snudde seg og såg på {name}.\n«Kom!» sa han vennleg. «Eg treng hjelpa di.»\n{name} nølte litt. Så byrja han å springe etter.",
  "{name} gikk ved siden av Lumi. Stien var smal og stille.\n«Hva trenger du hjelp med?» spurte {name}. Lumi ristet på hodet.\n«Jeg kan ikke si det,» sa han lavt. «Jeg må vise deg.»\nDe gikk videre sammen.": "{name} gjekk ved sida av Lumi. Stien var smal og stille.\n«Kva treng du hjelp med?» spurde {name}. Lumi rista på hovudet.\n«Eg kan ikkje seie det,» sa han lågt. «Eg må vise deg.»\nDei gjekk vidare saman.",
  "Plutselig stoppet Lumi. Øynene ble store.\n«Å nei… der er han,» hvisket han. «Det er den jeg snakket om.»\nLumi pekte mot den store dinosauren. «Han har vært slem mot de andre.»\nSå så han på {name}. «Det er han jeg trenger hjelp med.»": "Plutseleg stoppa Lumi. Auga vart store.\n«Å nei… der er han,» kviskra han. «Det er den eg snakka om.»\nLumi peika mot den store dinosauren. «Han har vore slem mot dei andre.»\nSå såg han på {name}. «Det er han eg treng hjelp med.»",
  "{name} tok et steg frem. Hjertet banket fort, men han sto støtt.\n«Du må slutte,» sa han rolig. «Det er ikke greit å være slem.»\nT-rexen stoppet opp. Ingen hadde sagt det til ham før.": "{name} tok eit steg fram. Hjartet banka fort, men han stod støtt.\n«Du må slutte,» sa han roleg. «Det er ikkje greitt å vere slem.»\n*T-rexen stoppa opp. Ingen hadde sagt det til han før.",
  "T-rexen senket hodet. «Jeg forsto ikke at jeg gjorde vondt,» sa han lavt.\nHan snudde seg sakte. Denne gangen uten brøl.\nOg med tunge steg gikk han rolig sin vei.": "*T-rexen senka hovudet. «Eg forstod ikkje at eg gjorde vondt,» sa han lågt.\nHan snudde seg sakte. Denne gongen utan brøl.\nOg med tunge steg gjekk han roleg sin veg.",
  "{name} og Lumi sto stille sammen. De så utover dalen der de andre dinosaurene levde i fred.\nLumi smilte forsiktig. Og {name} kjente seg varm og stolt inni seg.\nDe hadde gjort noe viktig – sammen.": "{name} og Lumi stod stille saman. Dei såg utover dalen der dei andre dinosaurane levde i fred.\nLumi smilte varsamt. Og {name} kjende seg varm og stolt inni seg.\nDei hadde gjort noko viktig – saman.",
  "Solen var i ferd med å gå ned. {name} visste at det var på tide å dra hjem.\nLumi så på ham og nikket stille. «Du vil alltid være en venn,» sa han.\n{name} vinket farvel. Og med et smil tok han steget tilbake til sin egen verden.": "Sola var i ferd med å gå ned. {name} visste at det var på tide å dra heim.\nLumi såg på han og nikka stille. «Du vil alltid vere ein venn,» sa han.\n{name} vinka farvel. Og med eit smil tok han steget tilbake til si eiga verd.",
  "Denne boken handler om mot. Om å tørre å si ifra når noe er urettferdig – selv når det føles litt skummelt.\nGjennom et magisk møte i Dinosaurdalen lærer {name} at ekte styrke ikke handler om å være størst eller sterkest, men om å være snill, modig og å bry seg om andre.\nEn varm og personlig historie som viser barn at én stemme kan gjøre en stor forskjell. Og at vennskap kan oppstå på de mest uventede steder.\nEn bok som gir trygghet, selvtillit – og minner barnet på at også de kan være en helt.": "Denne boka handlar om mot. Om å tore å seie frå når noko er urettferdig – sjølv når det kjennest litt skummelt.\nGjennom eit magisk møte i *Dinosaurdalen lærer {name} at ekte styrke ikkje handlar om å vere størst eller sterkast, men om å vere snill, modig og å bry seg om andre.\nEi varm og personleg historie som viser barn at éi stemme kan gjere ein stor forskjell. Og at vennskap kan oppstå på dei mest uventa stadene.\nEi bok som gir tryggleik, sjølvtillit – og minner barnet på at også dei kan vere ein helt."
}
