    ...
    pages: List[Dict[str, Any]] = [
        ...
        # Side 1 – det mystiske skjellet → tekst VENSTRE
        {
            ...
            "blocks": [{
                ...
                "font_size": 30,
                "color": "#FFFFFF",
                "highlights": [child_name, "skjel", "glitra"],
                "x_offset": 0,
                "y_offset": -10,
            }],
        },
        ...
        # Side 3 – den skjulte lagunen → tekst VENSTRE
        {
            ...
            "blocks": [{
                ...
                "font_size": 29,
                "color": "#FFFFFF",
                "highlights": [child_name, "lagune", "hemmeleg"],
                "x_offset": 0,
                "y_offset": -10,
            }],
        },
        ...
        # Side 6 – den forste svommeturen → tekst VENSTRE
        {
            ...
            "blocks": [{
                ...
                "font_size": 29,
                "color": "#FFFFFF",
                "highlights": [child_name, "korallar", "fri"],
                "x_offset": 0,
                "y_offset": -10,
            }],
        },
        ...
        # Side 7 – havfruenes rike → tekst VENSTRE
        {
            ...
            "blocks": [{
                ...
                "font_size": 29,
                "color": "#FFFFFF",
                "highlights": [child_name, "havfruerike", "vakraste"],
                "x_offset": 0,
                "y_offset": -10,
            }],
        },
        ...
        # Side 8 – noe er galt → tekst HØYRE
        {
            ...
            "blocks": [{
                ...
                "font_size": 29,
                "color": "#FFFFFF",
                "highlights": [child_name, "Magien", "mørkt"],
                "x_offset": 10,
                "y_offset": -10,
                "width_offset": -10,
            }],
        ...
        # Side 10 – havskilpadden → tekst VENSTRE
        {
            ...
            "blocks": [{
                "text": p(
                    ...
                    "\n"
                    "Saman dytta dei steinane unna. Skjelpadda symde ein takksam sirkel rundt (Navn) og vinka med hovudet. Ho ville at dei skulle følgje etter."
                ),
                "font_size": 29,
                "color": "#FFFFFF",
                "highlights": [child_name, "havskjelpadde", "hjelpe"],
                "x_offset": 0,
                "y_offset": -10,
            }],
        },
        ...
        # Side 11 – den hemmelige hulen → tekst VENSTRE
        {
            ...
            "blocks": [{
                ...
                "font_size": 29,
                "color": "#FFFFFF",
                "highlights": [child_name, "symbola", "hole"],
                "x_offset": 0,
                "y_offset": -10,
            }],
        },
        ...
        # Side 12 – havets hjerte → tekst VENSTRE
        {
            ...
            "blocks": [{
                "text": p(
                    ...
                    "\n"
                    "Då byrja skjelet i handa til (Navn) å gløde. Ho heldt det nærare, og dei to lysa svara kvarandre."
                ),
                "font_size": 30,
                "color": "#FFFFFF",
                "highlights": [child_name, "krystall", "Hjartet"],
                "x_offset": 0,
                "y_offset": 200,
            }],
        },
        ...
        # Side 13 – lyset vender tilbake → tekst VENSTRE
        {
            ...
            "blocks": [{
                "text": p(
                    ...
                    "\n"
                    "Korallane fekk fargane tilbake, gatene byrja å lyse, og fiskane kom fram igjen. Havfruer jubla over heile riket. (Navn) hadde redda dei alle."
                ),
                "font_size": 30,
                "color": "#FFFFFF",
                "highlights": [child_name, "lys", "redda"],
                "x_offset": 0,
                "y_offset": -10,
            }],
        },
        ...
        # Side 14 – en ny hemmelighet → tekst HØYRE
        {
            ...
            "blocks": [{
                "text": p(
                    ...
                    "\n"
                    "Då blinka Hjartet i havet igjen. Ein lysstråle skaut ut i det mørke havet, og langt borte tende lys seg i eit gammalt palass.\n"
                    "\n"
        ...
        # Bakside
        {
            ...
            "blocks": [{
                "text": p(
                    ...
                    "\n"
                    "Når (Navn) finn eit skjel som lyser i blått og lilla, opnar det døra til den hemmelege verda til havfruene. Men magien i riket held på å slokne, og berre nokon med eit ekte hjarte for havet kan vekkje han igjen.\n"
                    "\n"
                    "Saman med ei havfrue og ei havskjelpadde leitar (Navn) etter Hjartet i havet — djupt inne i ei hole ingen har vitja på svært lenge.\n"
                    "\n"
                    "Ei personleg forteljing om mot, vennskap og magien i å hjelpe andre."
                ),
                "font_size": 38,
                "color": "#FFFFFF",
                "highlights": [child_name, "havfruene", "Hjartet", "mot", "vennskap", "magien"],
            }],
        },
...
def render_dreampage_first(child_name: str, out_dir: str) -> str:
    ...
    body_lines = [
        ...
        "og fantasien din som fyller desse sidene.",
        "",
...
_DREAMPAGE_TRANSLATIONS = {
  "{name} blir": "{name} blir\nhavfrue",
  "{name} sto barbeint på stranden en varm sommerdag og så utover de blanke bølgene.\nHavet glitret som tusen små stjerner, og langt der ute sang måkene over vannet.\n\nHun hadde alltid lurt på hva som fantes under bølgene. Den dagen lengtet hjertet hennes ekstra sterkt etter et eventyr.": "{name} stod berrføtt på stranda ein varm sommardag og såg utover dei blanke bølgjene.\nHavet glitra som tusen små stjerner, og langt der ute song måsane over vatnet.\n\nHo hadde alltid lurt på kva som fanst under bølgjene. Den dagen lengta hjartet hennar ekstra sterkt etter eit eventyr.",
  "I sanden glitret noe vakkert.\n{name} bøyde seg ned og fant et skjell som lyste i regnbuens farger.\n\nDa hun løftet det opp mot øret, hørte hun en mild sang.\n\nDet var som om havet selv hvisket til henne.": "I sanden glitra noko vakkert.\n{name} bøygde seg ned og fann eit skjel som lyste i fargane i regnbogen.\n\nDå ho løfta det opp mot øyret, høyrde ho ein mild song.\n\nDet var som om havet sjølv kviskra til henne.",
  "Plutselig dukket en vennlig havfrue opp i vannkanten.\nHun smilte varmt og rakte hendene mot {name}, som om de allerede kjente hverandre.\n\n«Skjellet du holder er magisk,» sa havfruen mykt. «Det kan gjøre deg til havfrue for én eneste dag, hvis du virkelig ønsker det.»": "Plutseleg dukka ei vennleg havfrue opp i vasskanten.\nHo smilte varmt og rekte hendene mot {name}, som om dei allereie kjende kvarandre.\n\n«Skjelet du held er magisk,» sa havfrua mykt. «Det kan gjere deg til havfrue for éin einaste dag, om du verkeleg ønskjer det.»",
  "{name} holdt skjellet tett inntil hjertet sitt og lukket øynene.\nEt varmt lys begynte å svøpe seg rundt henne, først som sol på huden og så som glitrende bobler.\n\nDa hun åpnet øynene igjen, hadde bena hennes blitt til en skinnende havfruehale i akkurat hennes favorittfarge.": "{name} heldt skjelet tett inntil hjartet sitt og lukka auga.\nEit varmt lys byrja å sveipe seg rundt henne, først som sol på huda og så som glitrande bobler.\n\nDå ho opna auga igjen, hadde beina hennar vorte til ein skinnande havfruehale i akkurat favorittfargen hennar.",
  "{name} dykket ned i havet for aller første gang, og alt ble stille og mykt rundt henne.\nForan henne åpnet et stort korallrev seg som en hemmelig by av farger.\n\nFisk i rødt, gull og blått danset mellom korallene. Det var den vakreste verdenen hun noen gang hadde sett.": "{name} dykka ned i havet for aller første gong, og alt vart stille og mjukt rundt henne.\nFramfor henne opna eit stort korallrev seg som ein hemmeleg by av fargar.\n\nFisk i raudt, gull og blått dansa mellom korallane. Det var den vakraste verda ho nokon gong hadde sett.",
  "Brått svømte en lekende delfin bort til {name}.\nDen blunket vennlig, laget en liten spiral i vannet og lo med en lys klikkelyd.\n\n«Bli min nye venn,» sa delfinen, «så viser jeg deg hele havets rike.» {name} nikket glad og fulgte etter.": "Brått sumde ein leikande delfin bort til {name}.\nDen blunka vennleg, laga ein liten spiral i vatnet og lo med ein lys klikkelyd.\n\n«Bli den nye vennen min,» sa delfinen, «så viser eg deg heile riket i havet.» {name} nikka glad og følgde etter.",
  "Sammen svømte de inn i en hemmelig hage under havet.\nBlomstene lyste i blått, rosa og fiolett, og små bobler steg opp som perler fra sanden.\n\nPlantene danset stille i strømmen, som om de hilste henne velkommen. {name} lo høyt av bare glede.": "Saman sumde dei inn i ein hemmeleg hage under havet.\nBlomstrane lyste i blått, rosa og fiolett, og små bobler steig opp som perler frå sanden.\n\nPlantane dansa stille i straumen, som om dei helsa henne velkommen. {name} lo høgt av berre glede.",
  "Litt lenger borte glitret et stort slott av perlemor.\nTårnene var bygget av skjell, koraller og små steiner som lyste i vannet.\n\nAndre havfruer kom svømmende mot {name} og smilte varmt. «Velkommen til havfrueslottet!» ropte de i kor.": "Litt lenger borte glitra eit stort slott av perlemor.\nTårna var bygde av skil, korallar og små steinar som lyste i vatnet.\n\nAndre havfruer kom symjande mot {name} og smilte varmt. «Velkommen til havfrueslottet!» ropte dei i kor.",
  "Plutselig oppdaget havfruene en bekymret liten babyskilpadde.\nDen hadde gått seg vill og fant ikke mammaen sin.\n\n{name} bøyde seg ned og strøk den forsiktig over skallet.\n\n«Vi skal hjelpe deg hjem,» sa hun bestemt.": "Plutseleg oppdaga havfruene ei bekymra lita babyskjelpadde.\nDen hadde gått seg vill og fann ikkje mammaen sin.\n\n{name} bøygde seg ned og strøk den forsiktig over skalla.\n\n«Vi skal hjelpe deg heim,» sa ho bestemd.",
  "{name} og delfinen svømte gjennom mørke huler der lyset fra perlen blinket på steinveggene.\nStore, rolige hvaler sang dype toner i bakgrunnen, som om de viste vei.\n\nVannet var kjølig, men hjertet hennes var modig. Et sted der ute ventet en mamma på babyen sin.": "{name} og delfinen sumde gjennom mørke hòler der lyset frå perla blinka på steinveggene.\nStore, rolege kvalar song djupe tonar i bakgrunnen, som om dei viste veg.\n\nVatnet var kjølig, men hjartet hennar var modig. Ein stad der ute venta ein mamma på babyen sin.",
  "Endelig fant de mammaskilpadden, som lette fortvilet mellom tang og steiner.\nDen lille babyen svømte glad rett til henne, og de to skilpaddene la hodene mykt mot hverandre.\n\nFisk, seler og koraller jublet for {name}. Hele havet feiret henne som en ekte helt.": "Endeleg fann dei mammaskjelpadda, som lette fortvilt mellom tong og steinar.\nDen vesle babyen sumde glad rett til henne, og dei to skjelpaddene la hovuda mykte mot kvarandre.\n\nFisk, selar og korallar jubla for {name}. Heile havet feira henne som ein ekte heilt.",
  "Som takk førte havfruene {name} til en gammel skattekiste skjult mellom korallene.\nDa lokket åpnet seg sakte, lyste en glitrende, perfekt rund perle mildt opp i vannet.\n\n«Denne har havet gjemt til deg, lille modige venn,» hvisket de. «Den vil alltid minne deg på havets eventyr og på hjertet ditt.»": "Som takk førte havfruene {name} til ei gammal skattekiste skjult mellom korallane.\nDå lokket opna seg sakte, lyste ein glitrande, perfekt rund perle mildt opp i vatnet.\n\n«Denne har havet gøymt til deg, vesle modige venn,» kviskra dei. «Den vil alltid minne deg på eventyret i havet og på hjartet ditt.»",
  "Solen begynte å gå ned over havet, og vannet ble gyllent rundt slottet.\n{name} vinket farvel til delfinen, havfruene og alle vennene sine.\n\n«Jeg kommer til å savne dere,» hvisket hun. «Men jeg lover å aldri glemme dere.»": "Sola byrja å gå ned over havet, og vatnet vart gyllent rundt slottet.\n{name} vinka farvel til delfinen, havfruene og alle vennene sine.\n\n«Eg kjem til å sakne dykk,» kviskra ho. «Men eg lovar å aldri gløyme dykk.»",
  "Tilbake på stranden hadde {name} bena sine igjen, men eventyret kjentes fortsatt ekte.\nI hånden holdt hun den vakre perlen, varm og blank som et lite lys fra dypet.\n\nHun smilte mot bølgene som sakte rullet inn. Havet skulle alltid være hennes hemmelige eventyr.": "Tilbake på stranda hadde {name} beina sine igjen, men eventyret kjendest framleis ekte.\nI handa heldt ho den vakre perla, varm og blank som eit lite lys frå djupet.\n\nHo smilte mot bølgjene som sakte rulla inn. Havet skulle alltid vere dei hemmelege eventyra hennar.",
  "En liten drømmer. Et magisk skjell. Et helt nytt rike under bølgene.\n\nNår {name} finner et glitrende skjell på stranden, åpner det døren til et eventyr ingen kan glemme. Sammen med en lekende delfin og en flokk vennlige havfruer reiser hun gjennom korallrev, hemmelige hager og perlemor-slott.\n\nUnderveis lærer {name} hvor sterk hun er — og at ekte vennskap kan oppstå selv i dypeste hav.\n\nEn personlig fortelling om mot, fantasi og havets uendelige eventyr.": "Ein liten drøymer. Eit magisk skjel. Eit heilt nytt rike under bølgjene.\n\nNår {name} finn eit glitrande skjel på stranda, opnar det døra til eit eventyr ingen kan gløyme. Saman med ein leikande delfin og ein flokk vennlege havfruer reiser ho gjennom korallrev, hemmelege hagar og perlemor-slott.\n\nUndervegs lærer {name} kor sterk ho er — og at ekte vennskap kan oppstå sjølv i djupaste hav.\n\nEi personleg forteljing om mot, fantasi og det uendelege eventyret i havet."
}
