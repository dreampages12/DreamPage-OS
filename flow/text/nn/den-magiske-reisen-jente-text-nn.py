...
_DREAMPAGE_TRANSLATIONS = {
  "{name} sin": "{name} si",
  "{name} og\nDet Magiske Kartet": "{name} og\nDet magiske kartet",
  "Denne boken er laget spesielt for deg, {name}.\nNoen kart viser veien til steder.\nDette kartet viser veien til motet, godheten og magien inni deg.": "Denne boka er laga spesielt for deg, {name}.\nNokon kart viser vegen til stader.\nDette kartet viser vegen til motet, godheita og magien inni deg.",
  "{name} hadde nesten gjort seg klar for kvelden da hun oppdaget noe merkelig.\nMellom bøkene på rommet lå et kart hun aldri hadde sett før.\nDet så gammelt og støvete ut, men da hun løftet det opp, begynte kantene å gløde svakt i gull.": "{name} hadde nesten gjort seg klar for kvelden då ho oppdaga noko merkeleg.\nMellom bøkene på rommet låg eit kart ho aldri hadde sett før.\nDet såg gammalt og støvete ut, men då ho løfta det opp, byrja kantane å glø svakt i gull.",
  "Kartet ble varmt i hendene hennes.\nSmå tegn av gyllent lys steg opp fra papiret og danset rundt i rommet som hemmelige stjerner.\n{name} holdt pusten.\nDette var ikke et vanlig kart.": "Kartet vart varmt i hendene hennar.\nSmå teikn av gyllent lys steg opp frå papiret og dansa rundt i rommet som hemmelege stjerner.\n{name} heldt pusten.\nDette var ikkje eit vanleg kart.",
  "Lyset fra kartet samlet seg ved vinduet.\nFørst var det lite som en gnist, men så vokste det til en rund, gyllen portal.\nInne i lyset skimtet {name} en skog med glødende planter og blinkende blågrønne lys.": "Lyset frå kartet samla seg ved vindauget.\nFørst var det lite som ein gneiste, men så voks det til ein rund, gyllen portal.\nInne i lyset skimta {name} ein skog med glødande plantar og blinkande blågrøne lys.",
  "{name} tok et forsiktig skritt nærmere.\nPortalen summet mykt, som om den ventet på henne.\nHun var spent, men kartet lyste varmt i hånden hennes.\nSå rettet hun ryggen og hvisket: Jeg tør.": "{name} tok eit forsiktig steg nærare.\nPortalen summa mjukt, som om den venta på henne.\nHo var spent, men kartet lyste varmt i handa hennar.\nSå retta ho ryggen og kviskra: Eg tør.",
  "I neste øyeblikk sto {name} midt i den fortryllede skogen.\nTrærne var høyere enn hus, og blomstene glødet svakt langs stien.\nBak henne blinket portalen stille mellom greinene.\nReisen hadde virkelig begynt.": "I neste augneblink stod {name} midt i den fortrylla skogen.\nTrea var høgare enn hus, og blomstrane glødde svakt langs stien.\nBak henne blinka portalen stille mellom greinene.\nReisa hadde verkeleg byrja.",
  "På stien foran henne dukket en liten gyllen rev opp.\nDen hadde kloke øyne og en hale som glitret som sollys.\n\"Kartet viser veien,\" sa reven mykt.\n\"Men du må selv tørre å følge den.\"": "På stien framfor henne dukka ein liten gyllen rev opp.\nDen hadde kloke auge og ein hale som glitra som sollys.\n\"Kartet viser vegen,\" sa reven mykt.\n\"Men du må sjølv tore å følgje han.\"",
  "Reven ledet {name} til et gammelt tre med et stjerneformet merke i barken.\nDa hun holdt kartet nærmere, begynte både treet og papiret å skinne.\nStjernemerket løsnet forsiktig og svevde inn i kartet.\n\"Én del av veien er funnet,\" sa reven.": "Reven leidde {name} til eit gammalt tre med eit stjerneforma merke i borken.\nDå ho heldt kartet nærare, byrja både treet og papiret å skine.\nStjernemerket losna forsiktig og sveva inn i kartet.\n\"Éin del av vegen er funnen,\" sa reven.",
  "Da stjernemerket landet på kartet, begynte linjene å flytte på seg.\nLyset samlet seg mellom trærne, og en ny portal åpnet seg.\nPå den andre siden svevde øyer høyt over skyene, med fossefall som falt rett ned i luften.\n\"Kartet tror du er klar,\" sa reven.": "Då stjernemerket landa på kartet, byrja linjene å flytte på seg.\nLyset samla seg mellom trea, og ein ny portal opna seg.\nPå den andre sida sveva øyar høgt over skyene, med fossefall som fall rett ned i lufta.\n\"Kartet trur du er klar,\" sa reven.",
  "På en av de flyvende øyene hørte {name} en svak lyd.\nBak glødende slyngplanter satt en liten drageunge fast med vingen sin.\nDen så redd ut, men ikke farlig.\n{name} løsnet plantene én etter én, og dragen dyttet snuten takknemlig mot hånden hennes.": "På ei av dei flygande øyane høyrde {name} ein svak lyd.\nBak glødande slyngplantar sat ein liten drakeunge fast med vingen sin.\nDen såg redd ut, men ikkje farleg.\n{name} løyste plantane éin etter éin, og draken dytta snuten takksamt mot handa hennar.",
  "Drageungen ristet på vingene og pekte med snuten mot kartet.\nEt nytt stjernemerke våknet på papiret.\nBlått og gull blandet seg i luften foran dem, og en portal åpnet seg.\nInne i lyset lå en by under havet, full av koraller og små svevende måner.": "Drakeungen rista på vengene og peika med snuten mot kartet.\nEit nytt stjernemerke vakna på papiret.\nBlått og gull blanda seg i lufta framfor dei, og ein portal opna seg.\nInne i lyset låg ein by under havet, full av korallar og små svevande månar.",
  "Da {name} gikk gjennom portalen, lukket en glødende luftboble seg rundt henne.\nUtenfor danset vannet stille, og hele undervannsbyen lyste.\nMidt i byen blinket et nytt stjernemerke på kartet.\nDa hun rørte ved merket, fløy lyset rett inn i papiret.": "Då {name} gjekk gjennom portalen, lukka ei glødande luftboble seg rundt henne.\nUtanfor dansa vatnet stille, og heile undervassbyen lyste.\nMidt i byen blinka eit nytt stjernemerke på kartet.\nDå ho rørte ved merket, flaug lyset rett inn i papiret.",
  "Det nye stjernemerket fikk kartet til å lyse kaldt og klart.\nEn portal åpnet seg, og {name} steg ut i en verden av is og nordlys.\nFjellene ruvet rundt henne som blå krystaller.\nDrageungen sto ved siden av henne, klar til å følge henne videre.": "Det nye stjernemerket fekk karta til å lyse kaldt og klart.\nEin portal opna seg, og {name} steig ut i ei verd av is og nordlys.\nFjella ruva rundt henne som blå krystallar.\nDrakeungen stod ved sida av henne, klar til å følgje henne vidare.",
  "Da det siste lyset fra nordlyset traff kartet, åpnet det seg en dør av stjerner.\nBak den lå Stjernebiblioteket, større og vakrere enn noe {name} hadde sett før.\nBøker svevde mellom hyllene, og i midten sto en himmelglobus full av gyllent lys.\nAlle stjernemerkene samlet seg til én strålende vei.": "Då det siste lyset frå nordlyset trefte kartet, opna det seg ei dør av stjerner.\nBak han låg Stjernebiblioteket, større og vakrare enn noko {name} hadde sett før.\nBøker sveva mellom hyllene, og i midten stod ein himmelglobus full av gyllent lys.\nAlle stjernemerka samla seg til éin strålande veg.",
  "Et øyeblikk senere sto {name} tilbake på rommet sitt.\nAlt så nesten vanlig ut igjen: sengen, bøkene og teleskopet ved vinduet.\nMen kartet glødet fortsatt mykt, fullt av stjernemerker fra reisen.\nDa forsto hun det viktigste: Kartet hadde vist veien, men magien hadde vært i henne.": "Ein augneblink seinare stod {name} tilbake på rommet sitt.\nAlt såg nesten vanleg ut igjen: senga, bøkene og teleskopet ved vindauget.\nMen kartet glødde framleis mjukt, fullt av stjernemerke frå reisa.\nDå forstod ho det viktigaste: Kartet hadde vist vegen, men magien hadde vore i henne.",
  "En kveld finner {name} et gammelt kart som begynner å gløde i hendene hennes.\nKartet åpner portaler til fortryllede skoger, flyvende øyer, en undervannsby, en isverden og et bibliotek av stjerner.\nPå reisen hjelper {name} nye venner, samler stjernemerker og oppdager at ekte magi ikke bare finnes på kartet.\nDen finnes i motet hennes, i godheten hennes og i troen på at hun kan gå videre.": "Ein kveld finn {name} eit gammalt kart som byrjar å glø i hendene hennar.\nKartet opnar portalar til fortrylla skogar, flygande øyar, ein undervassby, ei isverd og eit bibliotek av stjerner.\nPå reisa hjelper {name} nye venner, samlar stjernemerke og oppdagar at ekte magi ikkje berre finst på kartet.\nDen finst i motet hennar, i godheita hennar og i trua på at ho kan gå vidare."
}
