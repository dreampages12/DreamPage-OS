...
BOOK_ROOT = Path(r"C:\DreamPage-OS\books\motet-i-hjertet")
BASE_DIR = BOOK_ROOT / "base"
ORDERS_DIR = BOOK_ROOT / "orders"
COMFY_OUTPUT_ROOT = Path(r"C:\DreamPage-OS\output") / "motet-i-hjertet" / "orders"
...
PAGE_TO_BASE_STEM = {
    "page00": "forside(prinsessen)",
    "page01": "01(Prinsessen)",
    "page02": "02(Prinsessen)",
    "page03": "03(Prinsessen)",
    "page04": "04(Prinsessen)",
    "page05": "05(Prinsessen)",
    "page06": "06(Prinsessen)",
    "page07": "07(Prinsessen)",
    "page08": "08(Prinsessen)",
    "page09": "09(Prinsessen)",
    "page10": "10(Prinsessen)",
    "page11": "11(Prinsessen)",
    "page12": "12(Prinsessen)",
    "page13": "13(Prinsessen)",
    "page14": "14(Prinsessen)",
}
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Bruk: python prepare_order_motet_i_hjertet.py <order_id>")
        raise SystemExit(1)
