...
BOOK_ROOT = Path(r"C:\DreamPage-OS\books\hestestjernen")
BASE_DIR = BOOK_ROOT / "base"
ORDERS_DIR = BOOK_ROOT / "orders"
COMFY_OUTPUT_ROOT = Path(r"C:\DreamPage-OS\output") / "hestestjernen" / "orders"
...
PAGE_TO_BASE_STEM = {
    "page00": "forside(hestestjernen)",
    "page01": "01(hestestjernen)",
    "page02": "02(hestestjernen)",
    "page03": "03(hestestjernen)",
    "page04": "04(hestestjernen)",
    "page05": "05(hestestjernen)",
    "page06": "06(hestestjernen)",
    "page07": "07(hestestjernen)",
    "page08": "08(hestestjernen)",
    "page09": "09(hestestjernen)",
    "page10": "10(hestestjernen)",
    "page11": "11(hestestjernen)",
    "page12": "12(hestestjernen)",
    "page13": "13(hestestjernen)",
    "page14": "14(hestestjernen)",
}
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Bruk: python prepare_order_hestestjernen.py <order_id>")
        raise SystemExit(1)
