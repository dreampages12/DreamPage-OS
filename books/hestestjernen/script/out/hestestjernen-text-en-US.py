...
BOOK_DREAMPAGE_FIRST = os.path.join(
    os.path.dirname(SCRIPT_ROOT_DIR), "books", "hestestjernen", "dreampage-first-hestestjernen.png"
)
...
FRONT_COVER_LINE1_SIZE = 78 / 1024          # andel av kortsiden (malen er 1024 px)
...
def build_pages(child_name: str) -> List[Dict[str, Any]]:
    ...
    pages: List[Dict[str, Any]] = [
        {
            "filename": "forside(hestestjernen).png",
            "type": "cover",
            "text": p("(Navn) blir\nHestestjerne"),
        },
        {
        ...
        # Side 1
        {
            "filename": "01(hestestjernen).png",
            "type": "inner",
            "side": "left",
            "blocks": [{
                "text": p(
                    "Det luktet høy og sol inne i stallen.\n"
                    "Helt bakerst, i den siste boksen, stod en stor brun hest og så rett på (Navn).\n"
                    "Hun hadde en hvit stjerne midt i pannen.\n"
                    "«Hei,» sa (Navn) stille, og rakte hånden forsiktig fram."
                ),
                "font_size": 30,
                "color": "#FFFFFF",
                "highlights": [child_name, "høy", "stjerne", "hånden"],
            }],
        },

        # Side 2
        {
            "filename": "02(hestestjernen).png",
            "type": "inner",
            "side": "right",
            "blocks": [{
                "text": p(
                ...
                "font_size": 30,
                "color": "#FFFFFF",
                "highlights": [child_name, "børste", "stille", "stole"],
            }],
        },

        # Side 3
        {
            "filename": "03(hestestjernen).png",
            "type": "inner",
            "side": "left",
            "blocks": [{
                "text": p(
                ...
                "font_size": 30,
                "color": "#FFFFFF",
                "highlights": [child_name, "treneren", "stigbøylen", "rolig"],
            }],
        },

        # Side 4
        {
            "filename": "04(hestestjernen).png",
            "type": "inner",
            "side": "right",
            "blocks": [{
                "text": p(
                ...
                "font_size": 30,
                "color": "#FFFFFF",
                "highlights": [child_name, "bom", "manen", "sprang"],
            }],
        },

        # Side 5
        {
            "filename": "05(hestestjernen).png",
            "type": "inner",
            "side": "left",
            "blocks": [{
                "text": p(
                ...
                "font_size": 30,
                "color": "#FFFFFF",
                "highlights": [child_name, "hagen", "puste", "favorittstedet"],
            }],
        },

        # Side 6
        {
            "filename": "06(hestestjernen).png",
            "type": "inner",
            "side": "left",
            "blocks": [{
                "text": p(
                ...
                "font_size": 30,
                "color": "#FFFFFF",
                "highlights": [child_name, "stevne", "prøve", "nikket"],
            }],
        },

        # Side 7
        {
            "filename": "07(hestestjernen).png",
            "type": "inner",
            "side": "left",
            "blocks": [{
                "text": p(
                ...
                "font_size": 30,
                "color": "#FFFFFF",
                "highlights": [child_name, "salen", "gjorden", "skinte"],
            }],
        },

        # Side 8
        {
            "filename": "08(hestestjernen).png",
            "type": "inner",
            "side": "right",
            "blocks": [{
                "text": p(
                ...
                "font_size": 30,
                "color": "#FFFFFF",
                "highlights": [child_name, "Solen", "sommerfuglene", "nervøs"],
            }],
        },

        # Side 9
        {
            "filename": "09(hestestjernen).png",
            "type": "inner",
            "side": "right",
            "blocks": [{
                "text": p(
                ...
                "font_size": 30,
                "color": "#FFFFFF",
                "highlights": [child_name, "Stevnemorgenen", "stien", "ørene"],
            }],
        },

        # Side 10
        {
            "filename": "10(hestestjernen).png",
            "type": "inner",
            "side": "right",
            "blocks": [{
                "text": p(
                ...
                "font_size": 30,
                "color": "#FFFFFF",
                "highlights": [child_name, "hallen", "dommerne", "Hindrene"],
            }],
        },

        # Side 11
        {
            "filename": "11(hestestjernen).png",
            "type": "inner",
            "side": "left",
            "blocks": [{
                "text": p(
                    ...
                    "Så løftet de seg, og et øyeblikk var de ikke borti bakken i det hele tatt."
                ),
                "font_size": 30,
                "color": "#FFFFFF",
                "highlights": [child_name, "hinder", "hovene", "løftet"],
            }],
        },

        # Side 12
        {
            "filename": "12(hestestjernen).png",
            "type": "inner",
            "side": "left",
            "blocks": [{
                "text": p(
                ...
                "font_size": 30,
                "color": "#FFFFFF",
                "highlights": [child_name, "bommer", "Publikum", "hvisket"],
            }],
        },

        # Side 13
        {
            "filename": "13(hestestjernen).png",
            "type": "inner",
            "side": "left",
            "blocks": [{
                "text": p(
                    "Utenfor banen hoppet (Navn) av og la begge armene rundt halsen på Stjerne.\n"
                    "Hesten stod stille og lot henne holde på, akkurat som den første dagen i stallen.\n"
                    "«Vi klarte det sammen,» sa hun inn i den varme pelsen.\n"
                    "Det var det beste øyeblikket i hele boken, og det stod ingen dommere og så på."
                ),
                "font_size": 30,
                "color": "#FFFFFF",
                "highlights": [child_name, "armene", "sammen", "øyeblikket"],
            }],
        },

        # Side 14
        {
            "filename": "14(hestestjernen).png",
            "type": "inner",
            "side": "left",
            "blocks": [{
                "text": p(
                    "Da navnet hennes ble ropt opp, gikk de inn i ringen igjen.\n"
                    "Noen hengte en blå sløyfe på hodelaget til Stjerne, og ga (Navn) en pokal som skinte i solen.\n"
                    "Alle klappet, og blomsterblader fauk gjennom luften.\n"
                    "Men (Navn) så ikke på pokalen. Hun så på hesten sin."
                ),
                "font_size": 30,
                "color": "#FFFFFF",
                "highlights": [child_name, "sløyfe", "pokal", "klappet"],
            }],
        },

        # Bakside
        {
            "filename": "bakside(hestestjernen).png",
            "type": "cover",
            "side": "left",
            "blocks": [{
                "text": p(
                    "Denne boken handler om det som skjer når et barn og en hest finner hverandre.\n"
                    "(Navn) har aldri sittet på en hest før. Hun vet ikke om hun tør. Men Stjerne ser på henne med de rolige, mørke øynene sine — og så begynner alt.\n"
                    "En varm fortelling om tålmodighet, om å falle og reise seg igjen, og om et vennskap som bærer helt fram til stevnedagen.\n"
                    "En bok som minner barnet på at de aller største drømmene begynner med ett rolig skritt."
                ),
                "font_size": 46,
                "color": "#FFFFFF",
                "highlights": [child_name, "hest", "Stjerne", "tålmodighet", "vennskap", "drømmene"],
            }],
        },
    ]
...
RYGGRAD_BOOK_SLUG = "hestestjernen"
...
def render_dreampage_first(child_name: str, out_dir: str) -> str:
    ...
    """
    src = BOOK_DREAMPAGE_FIRST if os.path.exists(BOOK_DREAMPAGE_FIRST) else os.path.join(SCRIPT_DIR, "dreampage-first.png")
...
def process_book(base_dir: str, out_dir: str, child_name: str, cover_type: str, gelato_api_key: str):
    ...
    # Legg til dreampage-first.png f?rst, blank-back.png deretter, og og per-bok Lastpage aller sist (finnes ikke for denne boka).
    # Disse er enkelt-sider (4096x4096) som ikke skal splittes - bare inkluderes direkte.
    dreampage_first = BOOK_DREAMPAGE_FIRST if os.path.exists(BOOK_DREAMPAGE_FIRST) else os.path.join(SCRIPT_DIR, "dreampage-first.png")
    ...
    last_page = resolve_lastpage_path("Lastpage(hestestjernen).png")
    ...
    if last_page:
        ...
        print(f"ADVARSEL: Fant ikke Lastpage(hestestjernen).png i {LASTPAGE_DIR} - hopper over")
    ...
    need = ["bakside(hestestjernen).png", "ryggrad.png", "forside(hestestjernen).png"]
    ...
    back_path  = cover_rendered["bakside(hestestjernen).png"]
    spine_path = cover_rendered["ryggrad.png"]
    front_path = cover_rendered["forside(hestestjernen).png"]
...
_DREAMPAGE_TRANSLATIONS = {
  '{name} blir\nHestestjerne': '{name} Becomes a\nRiding Star',
  'Det luktet høy og sol inne i stallen.\nHelt bakerst, i den siste boksen, stod en stor brun hest og så rett på {name}.\nHun hadde en hvit stjerne midt i pannen.\n«Hei,» sa {name} stille, og rakte hånden forsiktig fram.': 'The stable smelled of hay and sunshine.\nAll the way at the back, in the last stall, a big brown horse stood looking straight at {name}.\nShe had a white star in the middle of her forehead.\n“Hello,” {name} said quietly, and held out her hand.',
  'Hver dag etter skolen kom {name} tilbake til stallen.\nHun lærte hvordan man holder en børste, og hvor hardt man tør å ta.\nStjerne stod helt stille og lot henne holde på.\nDet var da {name} skjønte at hesten hadde begynt å stole på henne.': 'Every day after school {name} came back to the stable.\nShe learned how to hold a brush, and how firmly she could press.\nStar stood perfectly still and let her carry on.\nThat was when {name} understood that the horse had begun to trust her.',
  'En kveld sa treneren: «I dag tror jeg du er klar.»\n{name} satte foten i stigbøylen, og så satt hun der oppe.\nBakken var lenger unna enn hun hadde trodd, og hjertet slo hardt.\nMen Stjerne gikk rolig av seg selv, skritt for skritt langs gjerdet.': "One evening the trainer said, “Today I think you're ready.”\n{name} put her foot in the stirrup, and then she was up there.\nThe ground was further away than she had expected, and her heart pounded.\nBut Star walked calmly on her own, step by step along the fence.",
  'Etter noen uker lå det en liten bom på banen.\n«Hun hopper hvis du tør å la henne,» sa treneren.\n{name} tok et tak i manen, lente seg framover og lukket øynene.\nEtt sprang, og så var de på andre siden. Hun hadde ikke engang skreket.': "After a few weeks there was a low pole set out in the arena.\n“She'll jump it if you dare let her,” said the trainer.\n{name} took hold of the mane, leaned forward and closed her eyes.\nOne leap, and they were on the other side. She hadn't even shrieked.",
  'Noen dager ble de bare stående sammen i hagen bak stallen.\n{name} la kinnet mot den varme halsen og kjente hesten puste.\nHun sa ingenting, for det var ingenting som måtte sies.\nDette var favorittstedet hennes i hele verden.': 'Some days they simply stood together in the garden behind the stable.\n{name} laid her cheek against the warm neck and felt the horse breathing.\nShe said nothing, because nothing needed saying.\nThis was her favourite place in the whole world.',
  '«Det er et stevne om tre uker,» sa treneren en morgen.\n«Vil du prøve?»\n{name} kjente det kribble helt ut i fingrene.\nSå nikket hun.': "“There's a show in three weeks,” the trainer said one morning.\n“Do you want to try?”\n{name} felt it tingle all the way out to her fingertips.\nThen she nodded.",
  'De trente hver eneste dag som var igjen.\n{name} lærte å legge på salen selv, og å stramme gjorden akkurat nok.\nHun pusset Stjerne til pelsen skinte som våt stein.\nDagen før stevnet stod de to lenge i stalldøra og så ut på banen.': 'They trained every single day that was left.\n{name} learned to saddle up herself, and to tighten the girth just enough.\nShe groomed Star until her coat shone like wet stone.\nThe day before the show the two of them stood a long while in the stable doorway, looking out at the arena.',
  'Den siste kvelden red de en runde helt alene.\nSolen lå lavt over gjerdene, og sommerfuglene fulgte dem langs rosene.\n{name} kjente at hun ikke var nervøs lenger.\nHun og Stjerne kunne dette. De hadde gjort det hundre ganger.': "On that last evening they rode a round entirely alone.\nThe sun lay low over the fences, and butterflies followed them along the roses.\n{name} realised she wasn't nervous any more.\nShe and Star could do this. They had done it a hundred times.",
  'Stevnemorgenen var lys og helt stille.\nDe gikk sakte nedover stien mellom blomsterkassene.\nLangt framme hørte {name} stemmer og en høyttaler.\nStjerne løftet hodet og spisset ørene, som om hun visste hva som ventet.': 'The morning of the show was bright and completely still.\nThey walked slowly down the path between the flower boxes.\nFar ahead {name} could hear voices and a loudspeaker.\nStar lifted her head and pricked her ears, as if she knew what was coming.',
  'Så åpnet portene seg til den store hallen.\nDet satt folk på alle tribunene, og dommerne satt ved et langt bord.\nHindrene virket høyere her inne enn hjemme på banen.\n{name} tok et dypt pust og klappet Stjerne to ganger på halsen.': 'Then the gates opened into the great hall.\nPeople filled every stand, and the judges sat at a long table.\nThe jumps looked higher in here than they did at home.\n{name} took a deep breath and patted Star twice on the neck.',
  'Klokken ringte, og de satte av.\nEtt hinder. To. Tre. {name} hørte bare hovene og sin egen pust.\nForan det siste hoppet kjente hun Stjerne samle seg under henne.\nSå løftet de seg, og et øyeblikk var de ikke borti bakken i det hele tatt.': "The bell rang, and they set off.\nOne jump. Two. Three. {name} heard only the hooves and her own breathing.\nBefore the last fence she felt Star gather herself beneath her.\nThen they lifted, and for a moment they weren't touching the ground at all.",
  'De landet mykt og galopperte videre mot utgangen.\nIngen bommer var nede. Ikke en eneste.\nPublikum reiste seg, men {name} hørte det nesten ikke.\nHun bare bøyde seg fram og hvisket: «Du gjorde det. Du gjorde det.»': 'They landed softly and cantered on towards the exit.\nNot a single pole was down. Not one.\nThe crowd rose to its feet, but {name} barely heard them.\nShe just leaned forward and whispered, “You did it. You did it.”',
  'Utenfor banen hoppet {name} av og la begge armene rundt halsen på Stjerne.\nHesten stod stille og lot henne holde på, akkurat som den første dagen i stallen.\n«Vi klarte det sammen,» sa hun inn i den varme pelsen.\nDet var det beste øyeblikket i hele boken, og det stod ingen dommere og så på.': "Outside the arena {name} jumped down and put both arms around Star's neck.\nThe horse stood still and let her hold on, just as she had on that first day in the stable.\n“We did it together,” she said into the warm coat.\nIt was the best moment in the whole book, and there were no judges watching.",
  'Da navnet hennes ble ropt opp, gikk de inn i ringen igjen.\nNoen hengte en blå sløyfe på hodelaget til Stjerne, og ga {name} en pokal som skinte i solen.\nAlle klappet, og blomsterblader fauk gjennom luften.\nMen {name} så ikke på pokalen. Hun så på hesten sin.': "When her name was called, they walked back into the ring.\nSomeone hung a blue rosette on Star's bridle and handed {name} a trophy that shone in the sun.\nEveryone applauded, and flower petals drifted through the air.\nBut {name} wasn't looking at the trophy. She was looking at her horse.",
  'Denne boken handler om det som skjer når et barn og en hest finner hverandre.\n{name} har aldri sittet på en hest før. Hun vet ikke om hun tør. Men Stjerne ser på henne med de rolige, mørke øynene sine — og så begynner alt.\nEn varm fortelling om tålmodighet, om å falle og reise seg igjen, og om et vennskap som bærer helt fram til stevnedagen.\nEn bok som minner barnet på at de aller største drømmene begynner med ett rolig skritt.': "This book is about what happens when a child and a horse find each other.\n{name} has never sat on a horse before. She isn't sure she dares. But Star looks at her with those calm, dark eyes — and then everything begins.\nA warm story about patience, about falling and getting back up, and about a friendship that carries all the way to competition day.\nA book to remind a child that the very biggest dreams begin with one quiet step.",
}
