...
BOOK_ROOT = Path(under("books/kongerikets-hemmelighet"))
BASE_DIR = BOOK_ROOT / "base"
ORDERS_DIR = BOOK_ROOT / "orders"
COMFY_OUTPUT_ROOT = Path(under("output")) / "kongerikets-hemmelighet" / "orders"
...
PAGE_TO_BASE_STEM = {
    "page00": "forside(kongeriket)",
    "page01": "01(kongeriket)",
    "page02": "02(kongeriket)",
    "page03": "03(kongeriket)",
    "page04": "04(kongeriket)",
    "page05": "05(kongeriket)",
    "page06": "06(kongeriket)",
    "page07": "07(kongeriket)",
    "page08": "08(kongeriket)",
    "page09": "09(kongeriket)",
    "page10": "10(kongeriket)",
    "page11": "11(kongeriket)",
    "page12": "12(kongeriket)",
    "page13": "13(kongeriket)",
    "page14": "14(kongeriket)",
}
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Bruk: python prepare_order_kongeriket.py <order_id>")
        raise SystemExit(1)
