...
# === KONFIGURASJON ==========================
BOOK_ROOT = Path(under("books/dragejakten"))
BASE_DIR = BOOK_ROOT / "base"
ORDERS_DIR = BOOK_ROOT / "orders"
COMFY_OUTPUT_ROOT = Path(under("output")) / "dragejakten" / "orders"
...
PAGE_TO_BASE_STEM = {
    "page00": "forside(dragejakten)",
    "page01": "01(dragejakten)",
    "page02": "02(dragejakten)",
    "page03": "03(dragejakten)",
    "page04": "04(dragejakten)",
    "page05": "05(dragejakten)",
    "page06": "06(dragejakten)",
    "page07": "07(dragejakten)",
    "page08": "08(dragejakten)",
    "page09": "09(dragejakten)",
    "page10": "10(dragejakten)",
    "page11": "11(dragejakten)",
    "page12": "12(dragejakten)",
    "page13": "13(dragejakten)",
    "page14": "14(dragejakten)",
}
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Bruk: python prepare_order_dragejakten.py <order_id>")
        raise SystemExit(1)
