...
BOOK_ROOT = Path(r"C:\DreamPage-OS\books\juleprinsessen")
BASE_DIR = BOOK_ROOT / "base"
ORDERS_DIR = BOOK_ROOT / "orders"
COMFY_OUTPUT_ROOT = Path(r"C:\DreamPage-OS\output") / "juleprinsessen" / "orders"
...
PAGE_TO_BASE_STEM = {
    "page00": "forside(juleprinsessen)",
    "page01": "01(juleprinsessen)",
    "page02": "02(juleprinsessen)",
    "page03": "03(juleprinsessen)",
    "page04": "04(juleprinsessen)",
    "page05": "05(juleprinsessen)",
    "page06": "06(juleprinsessen)",
    "page07": "07(juleprinsessen)",
    "page08": "08(juleprinsessen)",
    "page09": "09(juleprinsessen)",
    "page10": "10(juleprinsessen)",
    "page11": "11(juleprinsessen)",
    "page12": "12(juleprinsessen)",
    "page13": "13(juleprinsessen)",
    "page14": "14(juleprinsessen)",
}
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Bruk: python prepare_order_den_skjulte_juleprinsessen.py <order_id>")
        raise SystemExit(1)
