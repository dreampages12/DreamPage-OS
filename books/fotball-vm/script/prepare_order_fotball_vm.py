...
BOOK_ROOT = Path(r"C:\ComfyUI\books\fotball-vm")
BASE_DIR = BOOK_ROOT / "base"
ORDERS_DIR = BOOK_ROOT / "orders"
COMFY_OUTPUT_ROOT = Path(r"C:\ComfyUI\output") / "fotball-vm" / "orders"
...
PAGE_TO_BASE_STEM = {
    "page00": "forside(fotball-vm)",
    "page01": "01(fotball-vm)",
    "page02": "02(fotball-vm)",
    "page03": "03(fotball-vm)",
    "page04": "04(fotball-vm)",
    "page05": "05(fotball-vm)",
    "page06": "06(fotball-vm)",
