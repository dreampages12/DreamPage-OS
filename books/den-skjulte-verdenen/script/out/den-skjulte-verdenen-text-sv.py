...
BOOK_DREAMPAGE_FIRST = os.path.join(
    os.path.dirname(SCRIPT_ROOT_DIR), "books", "den-skjulte-verdenen", "dreampage-first-verdenen.png"
)
    ...
    pages: List[Dict[str, Any]] = [
        ...
        # Side 1
        {
            ...
            "blocks": [{
                ...
                "font_size": 30,
                "color": "#FFFFFF",
                "highlights": [child_name, "skogen", "lys", "annerledes"],
            }],
        },

        # Side 2
        {
            "filename": "02(verdenen).png",
            "type": "inner",
            "side": "right",
            "blocks": [{
                "text": p(
                ...
                "font_size": 30,
                "color": "#FFFFFF",
                "highlights": [child_name, "danset", "følge", "skogen"],
            }],
        },

        # Side 3
        {
            "filename": "03(verdenen).png",
            "type": "inner",
            "side": "right",
            "blocks": [{
                "text": p(
                ...
                "font_size": 30,
                "color": "#FFFFFF",
                "highlights": [child_name, "foss", "gyllent", "gnisten"],
            }],
        },

        # Side 4 - venstre kvadrat (statisk handbilde, baerer teksten)
        {
            "filename": "04(verdenen-left).png",
            "type": "inner",
            "square": True,
            "side": "left",
            "no_split": True,
            "box_frac": [0.07, 0.08, 0.88, 0.6],
            "blocks": [{
                "text": p(
                ...
                "font_size": 30,
                "color": "#FFFFFF",
                "highlights": [child_name, "hånden", "gløde", "gull"],
            }],
        },

        # Side 4 - hoyre kvadrat (comfy-headswap, ingen tekst)
        {
            "filename": "04(verdenen-right).png",
            "type": "inner",
            "square": True,
            "blocks": [],
        },
        ...
        # Side 5
        {
            ...
            "blocks": [{
                ...
                "font_size": 30,
                "color": "#FFFFFF",
                "highlights": [child_name, "skimtet", "Fjell", "motet"],
            }],
        },

        # Side 6
        {
            "filename": "06(verdenen).png",
            "type": "inner",
            "side": "left",
            "blocks": [{
                "text": p(
                ...
                "font_size": 30,
                "color": "#FFFFFF",
                "highlights": [child_name, "verden", "skyene", "skjulte"],
            }],
        },

        # Side 7
        {
            "filename": "07(verdenen).png",
            "type": "inner",
            "side": "right",
            "blocks": [{
                "text": p(
                ...
                "font_size": 30,
                "color": "#FFFFFF",
                "highlights": [child_name, "raslet", "drage", "stille"],
            }],
        },

        # Side 8
        {
            "filename": "08(verdenen).png",
            "type": "inner",
            "side": "left",
            "blocks": [{
                "text": p(
                ...
                "font_size": 30,
                "color": "#FFFFFF",
                "highlights": [child_name, "Dragen", "kloke", "følge"],
            }],
        },

        # Side 9
        {
            "filename": "09(verdenen).png",
            "type": "inner",
            "side": "right",
            "blocks": [{
                "text": p(
                ...
                "font_size": 30,
                "color": "#FFFFFF",
                "highlights": [child_name, "klippe", "forlatt", "Tårn"],
            }],
        },

        # Side 10
        {
            "filename": "10(verdenen).png",
            "type": "inner",
            "side": "left",
            "blocks": [{
                "text": p(
                ...
                "font_size": 30,
                "color": "#FFFFFF",
                "highlights": [child_name, "dragen", "symboler", "våknet"],
            }],
        },

        # Side 11
        {
            "filename": "11(verdenen).png",
            "type": "inner",
            "side": "right",
            "blocks": [{
                "text": p(
                ...
                "font_size": 30,
                "color": "#FFFFFF",
                "highlights": [child_name, "tempel", "krystall", "symbolene"],
            }],
        },

        # Side 12
        {
            "filename": "12(verdenen).png",
            "type": "inner",
            "side": "left",
            "blocks": [{
                "text": p(
                ...
                "font_size": 30,
                "color": "#FFFFFF",
                "highlights": [child_name, "krystallen", "gyllent", "glemte"],
            }],
        },

        # Side 13
        {
            "filename": "13(verdenen).png",
            "type": "inner",
            "side": "right",
            "blocks": [{
                "text": p(
                ...
                "font_size": 30,
                "color": "#FFFFFF",
                "highlights": [child_name, "stivnet", "mørkt", "vekket"],
            }],
        },

        # Side 14
        {
            "filename": "14(verdenen).png",
            "type": "inner",
            "side": "left",
            "blocks": [{
                "text": p(
                ...
                "font_size": 30,
                "color": "#FFFFFF",
                "highlights": [child_name, "krystallen", "hjerte", "Eventyret"],
            }],
        },

        # Bakside
        {
            "filename": "bakside(verdenen).png",
            "type": "cover",
            "side": "left",
            "blocks": [{
                "text": p(
                    "Denne boken handler om nysgjerrighet. Om å følge et lite lys inn i det ukjente, selv når man ikke vet hva som venter på den andre siden.\n"
                    "Når (Navn) går gjennom fossen, åpner det seg en verden med svevende øyer, en glemt by og en drage som blir hans venn.\n"
                ...
                "font_size": 46,
                "color": "#FFFFFF",
                "highlights": [child_name, "nysgjerrighet", "fossen", "drage", "mot", "vennskap", "barnet"],
            }],
        },
    ]
...
def process_book(base_dir: str, out_dir: str, child_name: str, cover_type: str, gelato_api_key: str):
    ...
    last_page = resolve_lastpage_path("Lastpage(verdenen).png")
    ...
    if last_page:
        ...
        print(f"ADVARSEL: Fant ikke Lastpage(verdenen).png i {LASTPAGE_DIR} - hopper over")
    ...
    need = ["bakside(verdenen).png", "ryggrad.png", "forside(verdenen).png"]
    ...
    back_path  = cover_rendered["bakside(verdenen).png"]
    spine_path = cover_rendered["ryggrad.png"]
    front_path = cover_rendered["forside(verdenen).png"]
...
_DREAMPAGE_TRANSLATIONS = {
  '{name} og\nDen Skjulte Verdenen': '{name} och\nDen Dolda Världen',
  'En dag var {name} ute på tur i skogen.\nHan hadde gått denne veien mange ganger før.\nMen akkurat i dag føltes noe annerledes.\nPlutselig glitret et lite lys mellom trærne.': 'En dag var {name} ute på tur i skogen.\nHan hade gått den här vägen många gånger förut.\nMen just idag kändes något annorlunda.\nPlötsligt glittrade ett litet ljus mellan träden.',
  'Det lille lyset danset videre mellom trærne.\nDet var nesten som om det ville at {name} skulle følge etter.\nHan gikk forsiktig etter, lenger og lenger inn i skogen.\nHver gang han kom nær, fløy lyset videre.': 'Det lilla ljuset dansade vidare mellan träden.\nDet var nästan som om det ville att {name} skulle följa efter.\nHan gick försiktigt efter, längre och längre in i skogen.\nVarje gång han kom nära flög ljuset vidare.',
  'Til slutt førte lyset {name} frem til en stor foss.\nHan stoppet og så opp.\nMidt i alt det kalde vannet skinte et svakt, gyllent lys.\nOg den lille gnisten fløy rett mot fossen.': 'Till slut ledde ljuset {name} fram till ett stort vattenfall.\nHan stannade och såg upp.\nMitt i allt det kalla vattnet lyste ett svagt, gyllene sken.\nOch den lilla gnistan flög rakt mot vattenfallet.',
  '{name} gikk helt bort til fossen og strakte hånden forsiktig frem.\nDa vannet traff fingrene hans, skjedde noe utrolig.\nVannet rundt hånden begynte å gløde som flytende gull.\nDette var ingen vanlig foss.': '{name} gick ända fram till vattenfallet och sträckte försiktigt fram handen.\nNär vattnet träffade hans fingrar hände något otroligt.\nVattnet runt handen började glöda som flytande guld.\nDet här var inget vanligt vattenfall.',
  'Han tok et lite skritt nærmere.\nBak det glitrende vannet skimtet {name} noe på den andre siden.\nFarger. Lys. Fjell.\nHan samlet motet sitt og gikk rett gjennom fossen.': 'Han tog ett litet steg närmare.\nBakom det glittrande vattnet skymtade {name} något på andra sidan.\nFärger. Ljus. Berg.\nHan samlade sitt mod och gick rakt genom vattenfallet.',
  'På den andre siden mistet {name} nesten pusten.\nForan ham lå en verden han aldri hadde sett maken til.\nFjell strakte seg mot skyene, og øyer svevde i luften.\nHan hadde funnet den skjulte verden.': 'På andra sidan tappade {name} nästan andan.\nFramför honom låg en värld han aldrig sett maken till.\nBerg sträckte sig mot molnen, och öar svävade i luften.\nHan hade hittat den dolda världen.',
  'Plutselig raslet det mellom plantene bak ham.\n{name} snudde seg raskt.\nUt mellom de gamle steinene kom en ung, blågrønn drage.\n{name} sto helt stille. Dragen gjorde det samme.': 'Plötsligt prasslade det bland växterna bakom honom.\n{name} vände sig snabbt om.\nUt mellan de gamla stenarna kom en ung, blågrön drake.\n{name} stod alldeles stilla. Draken gjorde likadant.',
  'Dragen virket ikke sint.\nDen så på {name} med store, kloke øyne og begynte å gå.\nEtter noen skritt stoppet den og så tilbake på ham.\n«Vil du at jeg skal følge etter deg?» spurte {name}.': 'Draken verkade inte arg.\nDen tittade på {name} med stora, kloka ögon och började gå.\nEfter några steg stannade den och såg tillbaka på honom.\n»Vill du att jag ska följa efter dig?» frågade {name}.',
  'Sammen fulgte de en gammel sti gjennom den skjulte verden.\nTil slutt kom de opp på en høy klippe.\nLangt nedenfor lå en enorm, forlatt by.\nTårn og broer var dekket av planter, som om ingen hadde vært der på hundre år.': 'Tillsammans följde de en gammal stig genom den dolda världen.\nTill slut kom de upp på en hög klippa.\nLångt nedanför låg en enorm, övergiven stad.\nTorn och broar var täckta av växter, som om ingen varit där på hundra år.',
  '{name} og dragen gikk inn mellom de gamle bygningene.\nAlt var stille.\nSå begynte små symboler i steinveggene å lyse idet han gikk forbi.\nEtt etter ett våknet de til liv.': '{name} och draken gick in bland de gamla byggnaderna.\nAllt var tyst.\nSedan började små symboler i stenväggarna lysa när han gick förbi.\nEn efter en vaknade de till liv.',
  'Innerst i byen fant de et enormt gammelt tempel.\nMidt i mørket stod en stor krystall på en steinsokkel.\nDa {name} kom nærmere, glødet ett av symbolene sterkere enn alle de andre.\nDet var det samme lyset som hadde ledet ham gjennom skogen.': 'Längst inne i staden hittade de ett enormt gammalt tempel.\nMitt i mörkret stod en stor kristall på en stensockel.\nNär {name} kom närmare glödde en av symbolerna starkare än alla de andra.\nDet var samma ljus som hade lett honom genom skogen.',
  'Forsiktig la {name} hånden mot krystallen.\nI samme øyeblikk fyltes hele rommet av gyllent lys.\nLyset skjøt gjennom gulvet og ut i hele byen.\nUtenfor begynte tårnene å gløde. Den glemte byen våknet.': 'Försiktigt lade {name} handen mot kristallen.\nI samma ögonblick fylldes hela rummet av gyllene ljus.\nLjuset sköt genom golvet och ut i hela staden.\nUtanför började tornen glöda. Den glömda staden vaknade.',
  '{name} løp ut sammen med dragen.\nOveralt rundt dem kom den skjulte verden til liv.\nMen så stivnet dragen og stirret mot et mørkt fjell langt borte.\nHøyt oppe tente et rødt lys seg. De hadde vekket noe annet også.': '{name} sprang ut tillsammans med draken.\nÖverallt runt dem vaknade den dolda världen till liv.\nMen så stelnade draken och stirrade mot ett mörkt berg långt borta.\nHögt uppe tändes ett rött ljus. De hade väckt något annat också.',
  'Ved fossen stoppet {name} og så tilbake på dragen.\nI hånden lå en liten bit av den lysende krystallen.\nDen pulserte svakt, nesten som et hjerte.\nEventyret i den skjulte verden hadde bare så vidt begynt.': 'Vid vattenfallet stannade {name} och såg tillbaka på draken.\nI handen låg en liten bit av den lysande kristallen.\nDen pulserade svagt, nästan som ett hjärta.\nÄventyret i den dolda världen hade bara just börjat.',
  'Denne boken handler om nysgjerrighet. Om å følge et lite lys inn i det ukjente, selv når man ikke vet hva som venter på den andre siden.\nNår {name} går gjennom fossen, åpner det seg en verden med svevende øyer, en glemt by og en drage som blir hans venn.\nEn varm og spennende fortelling om mot, vennskap og om å våge å ta det første skrittet.\nEn bok som minner barnet på at de aller største eventyrene begynner med ett eneste skritt.': 'Den här boken handlar om nyfikenhet. Om att följa ett litet ljus in i det okända, även när man inte vet vad som väntar på andra sidan.\nNär {name} går genom vattenfallet öppnar sig en värld med svävande öar, en glömd stad och en drake som blir hans vän.\nEn varm och spännande berättelse om mod, vänskap och om att våga ta det första steget.\nEn bok som påminner barnet om att de allra största äventyren börjar med ett enda steg.',
}
